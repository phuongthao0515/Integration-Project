import {
  ...
  s,
  webNamespaces
} from "./chunk-L6BECG27.js";
import {
  find,
  html,
  svg
} from "./chunk-O7KQDUSQ.js";
import {
  __commonJS,
  __toESM
  ...
  "node_modules/parse5/lib/parser/open-element-stack.js"(exports, module) {
    ...
    var OpenElementStack = class {
      ...
      tryPeekProperlyNestedBodyElement() {
        ...
        return element2 && this.treeAdapter.getTagName(element2) === $.BODY ? element2 : null;
      }
      contains(element2) {
  ...
  "node_modules/parse5/lib/parser/formatting-element-list.js"(exports, module) {
    ...
    var FormattingElementList = class _FormattingElementList {
      ...
      getElementEntry(element2) {
        for (let i = this.length - 1; i >= 0; i--) {
          const entry = this.entries[i];
          if (entry.type === _FormattingElementList.ELEMENT_ENTRY && entry.element === element2) {
            return entry;
          }
        }
        return null;
...
var require_default = __commonJS({
  "node_modules/parse5/lib/tree-adapters/default.js"(exports) {
    ...
    exports.getAttrList = function(element2) {
      return element2.attrs;
    };
    exports.getTagName = function(element2) {
      return element2.tagName;
    };
    exports.getNamespaceURI = function(element2) {
...
var require_parser = __commonJS({
  "node_modules/parse5/lib/parser/index.js"(exports, module) {
    ...
    function listItemStartTagInBody(p, token) {
      ...
      for (let i = p.openElements.stackTop; i >= 0; i--) {
        const element2 = p.openElements.items[i];
        const elementTn = p.treeAdapter.getTagName(element2);
        let closeTn = null;
        ...
        if (elementTn !== $.ADDRESS && elementTn !== $.DIV && elementTn !== $.P && p._isSpecialElement(element2)) {
          break;
        }
      }
      if (p.openElements.hasInButtonScope($.P)) {
...
//# sourceMappingURL=rehype-parse-5PP5NT3M.js.map
