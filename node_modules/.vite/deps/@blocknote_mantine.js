...
import {
  ...
  useInteractions,
  useRole
} from "./chunk-SG5QUCT4.js";
import "./chunk-CPDUEO7C.js";
import "./chunk-N6JGD5NS.js";
import "./chunk-FVNALRYS.js";
import "./chunk-WLB7R6ZN.js";
import "./chunk-O7KQDUSQ.js";
import "./chunk-HCEDYNCN.js";
import "./chunk-ZZDOSU35.js";
import {
  require_react_dom
...
function useMediaQuery(query, initialValue, { getInitialValueInEffect } = {
  ...
  const queryRef = (0, import_react12.useRef)(null);
...
function useFocusWithin({
  ...
  const [focused, setFocused] = (0, import_react54.useState)(false);
  const focusedRef = (0, import_react54.useRef)(false);
...
function getAngle(coordinates, element) {
  ...
  const y2 = coordinates[1] - center[1];
  const deg = radiansToDegrees(Math.atan2(x, y2)) + 180;
  return 360 - deg;
}
...
function useRadialMove(onChange, { step = 0.01, onChangeEnd, onScrubStart, onScrubEnd } = {}) {
  ...
  (0, import_react74.useEffect)(() => {
    ...
    (_a = ref.current) == null ? void 0 : _a.addEventListener("mousedown", onMouseDown);
    (_b = ref.current) == null ? void 0 : _b.addEventListener("touchstart", handleTouchStart, { passive: false });
    return () => {
      if (ref.current) {
        ref.current.removeEventListener("mousedown", onMouseDown);
...
function getRefProp(element) {
  var _a;
  const version = import_react75.default.version;
  if (typeof import_react75.default.version !== "string") {
...
var MantineContext = (0, import_react76.createContext)(null);
function useMantineContext() {
  const ctx = (0, import_react76.useContext)(MantineContext);
  if (!ctx) {
...
function rgbStringToRgba(color) {
  const [r, g2, b, a] = color.replace(/[^0-9,./]/g, "").split(/[/,]/).map(Number);
  return { r, g: g2, b, a: a || 1 };
}
...
function darken(color, alpha2) {
  ...
  const { r, g: g2, b, a } = toRgba(color);
  const f = 1 - alpha2;
  const dark = (input) => Math.round(input * f);
  return `rgba(${dark(r)}, ${dark(g2)}, ${dark(b)}, ${a})`;
}
...
// node_modules/@mantine/core/esm/core/MantineProvider/MantineThemeProvider/MantineThemeProvider.mjs
var MantineThemeContext = (0, import_react80.createContext)(null);
var useSafeMantineTheme = () => (0, import_react80.useContext)(MantineThemeContext) || DEFAULT_THEME;
function useMantineTheme() {
  const ctx = (0, import_react80.useContext)(MantineThemeContext);
  if (!ctx) {
    throw new Error(
...
function MantineThemeProvider({
  ...
  const mergedTheme = (0, import_react80.useMemo)(
...
function useProviderColorScheme({
  ...
  const media = (0, import_react87.useRef)(null);
  const [value, setValue] = (0, import_react87.useState)(() => manager.get(defaultColorScheme));
  const colorSchemeValue = forceColorScheme || value;
  const setColorScheme = (0, import_react87.useCallback)(
    (colorScheme) => {
      if (!forceColorScheme) {
  ...
  const clearColorScheme = (0, import_react87.useCallback)(() => {
...
function getVariantClassName({
  ...
  return (options == null ? void 0 : options.variant) && !unstyled ? classes87[`${selector}--${options.variant}`] : void 0;
}
...
function resolveVars({
  ...
  var _a;
  return (_a = mergeVars([
    headless ? {} : varsResolver90 == null ? void 0 : varsResolver90(theme, props, stylesCtx),
    ...themeName.map((name) => {
      var _a2, _b, _c;
...
function useRandomClassName() {
  const id = (0, import_react105.useId)().replace(/:/g, "");
  return `__m__-${id}`;
}
...
// node_modules/@mantine/core/esm/core/Box/Box.mjs
var _Box = (0, import_react106.forwardRef)(
  ({
    component,
    style,
    __vars,
...
function getWithProps(Component) {
  ...
  return (fixedProps) => {
    const Extended = (0, import_react107.forwardRef)((props, ref) => (0, import_jsx_runtime33.jsx)(_Component, { ...fixedProps, ...props, ref }));
...
function factory(ui) {
  const Component = (0, import_react107.forwardRef)(ui);
  Component.extend = identity;
  Component.withProps = (fixedProps) => {
    const Extended = (0, import_react107.forwardRef)((props, ref) => (0, import_jsx_runtime33.jsx)(Component, { ...fixedProps, ...props, ref }));
...
function polymorphicFactory(ui) {
  const Component = (0, import_react108.forwardRef)(ui);
  Component.withProps = (fixedProps) => {
    const Extended = (0, import_react108.forwardRef)((props, ref) => (0, import_jsx_runtime34.jsx)(Component, { ...fixedProps, ...props, ref }));
    Extended.extend = Component.extend;
    Extended.displayName = `WithProps(${Component.displayName})`;
    return Extended;
  };
...
var DirectionContext = (0, import_react109.createContext)({
  dir: "ltr",
  toggleDirection: () => {
  },
  setDirection: () => {
...
function useDirection() {
  return (0, import_react109.useContext)(DirectionContext);
}
...
function useCollapse({
  ...
  const el = (0, import_react110.useRef)(null);
  ...
  const [styles, setStylesRaw] = (0, import_react110.useState)(opened ? {} : collapsedStyles);
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaCorner/ScrollAreaCorner.mjs
var Corner = (0, import_react113.forwardRef)((props, ref) => {
  const { style, ...others } = props;
  const ctx = useScrollAreaContext();
  const [width, setWidth] = (0, import_react113.useState)(0);
  const [height, setHeight] = (0, import_react113.useState)(0);
...
var ScrollAreaCorner = (0, import_react113.forwardRef)((props, ref) => {
  const ctx = useScrollAreaContext();
...
var ScrollAreaRoot = (0, import_react114.forwardRef)((_props, ref) => {
  ...
  const [viewport, setViewport] = (0, import_react114.useState)(null);
  const [content, setContent] = (0, import_react114.useState)(null);
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/Scrollbar.mjs
var Scrollbar = (0, import_react116.forwardRef)((props, forwardedRef) => {
  const {
    sizes: sizes2,
    hasThumb,
    onThumbChange,
  ...
  const [scrollbar, setScrollbar] = (0, import_react116.useState)(null);
  const composeRefs = useMergedRef(forwardedRef, (node) => setScrollbar(node));
  const rectRef = (0, import_react116.useRef)(null);
  const prevWebkitUserSelectRef = (0, import_react116.useRef)("");
  ...
  (0, import_react116.useEffect)(handleThumbPositionChange, [sizes2, handleThumbPositionChange]);
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollbarX.mjs
var ScrollAreaScrollbarX = (0, import_react117.forwardRef)(
  (props, forwardedRef) => {
    const { sizes: sizes2, onSizesChange, style, ...others } = props;
    const ctx = useScrollAreaContext();
    const [computedStyle, setComputedStyle] = (0, import_react117.useState)();
...
var ScrollAreaScrollbarY = (0, import_react118.forwardRef)(
  (props, forwardedRef) => {
    const { sizes: sizes2, onSizesChange, style, ...others } = props;
    const context = useScrollAreaContext();
    const [computedStyle, setComputedStyle] = (0, import_react118.useState)();
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbarVisible.mjs
var ScrollAreaScrollbarVisible = (0, import_react119.forwardRef)((props, forwardedRef) => {
  const { orientation = "vertical", ...scrollbarProps } = props;
  const { dir } = useDirection();
  const context = useScrollAreaContext();
  const thumbRef = (0, import_react119.useRef)(null);
  const pointerOffsetRef = (0, import_react119.useRef)(0);
  const [sizes2, setSizes] = (0, import_react119.useState)({
    content: 0,
    viewport: 0,
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbarAuto.mjs
var ScrollAreaScrollbarAuto = (0, import_react120.forwardRef)(
  (props, ref) => {
    const context = useScrollAreaContext();
    const { forceMount, ...scrollbarProps } = props;
    const [visible2, setVisible] = (0, import_react120.useState)(false);
...
var ScrollAreaScrollbarHover = (0, import_react121.forwardRef)(
  (props, ref) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
    const [visible2, setVisible] = (0, import_react121.useState)(false);
...
var ScrollAreaScrollbarScroll = (0, import_react122.forwardRef)(
  (props, red) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
    const isHorizontal = props.orientation === "horizontal";
    const [state, setState] = (0, import_react122.useState)("hidden");
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbar.mjs
var ScrollAreaScrollbar = (0, import_react123.forwardRef)(
  (props, forwardedRef) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaThumb/ScrollAreaThumb.mjs
var Thumb = (0, import_react124.forwardRef)((props, forwardedRef) => {
  const { style, ...others } = props;
  const scrollAreaContext = useScrollAreaContext();
  const scrollbarContext = useScrollbarContext();
  const { onThumbPositionChange } = scrollbarContext;
  const composedRef = useMergedRef(forwardedRef, (node) => scrollbarContext.onThumbChange(node));
  const removeUnlinkedScrollListenerRef = (0, import_react124.useRef)(void 0);
...
var ScrollAreaThumb = (0, import_react124.forwardRef)(
  (props, forwardedRef) => {
...
var ScrollAreaViewport = (0, import_react125.forwardRef)(
...
var ScrollArea = factory((_props, ref) => {
  ...
  const [scrollbarHovered, setScrollbarHovered] = (0, import_react126.useState)(false);
...
// node_modules/@mantine/core/esm/components/Floating/FloatingArrow/FloatingArrow.mjs
var FloatingArrow = (0, import_react130.forwardRef)(
  ({
    position,
    arrowSize,
    arrowOffset,
...
function FocusTrapInitialFocus(props) {
  return (0, import_jsx_runtime57.jsx)(VisuallyHidden, { tabIndex: -1, "data-autofocus": true, ...props });
}
...
var Portal = (0, import_react133.forwardRef)((props, ref) => {
  ...
  return (0, import_react_dom2.createPortal)((0, import_jsx_runtime58.jsx)(import_jsx_runtime58.Fragment, { children }), nodeRef.current);
});
...
function OptionalPortal({ withinPortal = true, children, ...others }) {
  if (withinPortal) {
    return (0, import_jsx_runtime59.jsx)(Portal, { ...others, children });
  }
...
function usePopover(options) {
  ...
  const previouslyOpened = (0, import_react141.useRef)(_opened);
  const onClose = () => {
    if (_opened) {
      setOpened(false);
    }
...
function Popover(_props) {
  ...
  const onEntered = (0, import_react143.useCallback)(() => {
    var _a2;
  ...
  return (0, import_jsx_runtime65.jsx)(
    PopoverContextProvider,
    {
      value: {
        ...
        arrowY: (_f = (_e2 = (_d = popover.floating) == null ? void 0 : _d.middlewareData) == null ? void 0 : _e2.arrow) == null ? void 0 : _f.y,
...
// node_modules/@mantine/core/esm/components/Loader/loaders/Bars.mjs
var Bars = (0, import_react145.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime66.jsxs)(Box, { component: "span", className: clsx_default(classes6.barsLoader, className), ...others, ref, children: [
  (0, import_jsx_runtime66.jsx)("span", { className: classes6.bar }),
  (0, import_jsx_runtime66.jsx)("span", { className: classes6.bar }),
  (0, import_jsx_runtime66.jsx)("span", { className: classes6.bar })
] }));
...
var Dots = (0, import_react146.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime67.jsxs)(Box, { component: "span", className: clsx_default(classes6.dotsLoader, className), ...others, ref, children: [
  (0, import_jsx_runtime67.jsx)("span", { className: classes6.dot }),
  (0, import_jsx_runtime67.jsx)("span", { className: classes6.dot }),
  (0, import_jsx_runtime67.jsx)("span", { className: classes6.dot })
] }));
...
var Oval = (0, import_react147.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime68.jsx)(Box, { component: "span", className: clsx_default(classes6.ovalLoader, className), ...others, ref }));
...
var CloseIcon = (0, import_react152.forwardRef)(
  ({ size: size2 = "var(--cb-icon-size, 70%)", style, ...others }, ref) => (0, import_jsx_runtime73.jsx)(
    "svg",
    {
      viewBox: "0 0 15 15",
      fill: "none",
...
var varsResolver8 = createVarsResolver((_, { size: size2, radius, iconSize }) => ({
  root: {
...
function filterFalsyChildren(children) {
  return import_react154.Children.toArray(children).filter(Boolean);
}
...
var Overlay = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime76.jsx)(Box, { ref, ...getStyles2("root"), mod: [{ center, fixed }, mod], ...others, children });
});
...
function useLockScroll({ opened, transitionDuration }) {
  const [shouldLockScroll, setShouldLockScroll] = (0, import_react158.useState)(opened);
  const timeout = (0, import_react158.useRef)(-1);
...
function useModal({
  ...
  const _id = useId(id);
  const [titleMounted, setTitleMounted] = (0, import_react159.useState)(false);
  const [bodyMounted, setBodyMounted] = (0, import_react159.useState)(false);
...
// node_modules/@mantine/core/esm/components/ModalBase/ModalBase.mjs
var ModalBase = (0, import_react160.forwardRef)(
  ({
    keepMounted,
    opened,
    onClose,
    ...
    return (0, import_jsx_runtime78.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: (0, import_jsx_runtime78.jsx)(
      ModalBaseProvider,
      {
        value: {
          opened,
...
// node_modules/@mantine/core/esm/components/ModalBase/ModalBaseBody.mjs
var ModalBaseBody = (0, import_react162.forwardRef)(
...
var ModalBaseCloseButton = (0, import_react163.forwardRef)(
...
var ModalBaseContent = (0, import_react164.forwardRef)(
  ({ transitionProps, className, innerProps, onKeyDown, style, ...others }, ref) => {
    ...
    return (0, import_jsx_runtime81.jsx)(
      Transition,
      {
        ...
        ...transitionProps,
        children: (transitionStyles) => (0, import_jsx_runtime81.jsx)(
          "div",
          {
            ...innerProps,
            className: clsx_default({ [classes11.inner]: !ctx.unstyled }, innerProps.className),
            children: (0, import_jsx_runtime81.jsx)(FocusTrap, { active: ctx.opened && ctx.trapFocus, innerRef: ref, children: (0, import_jsx_runtime81.jsx)(
              Paper,
              {
                ...others,
                component: "section",
...
var ModalBaseHeader = (0, import_react165.forwardRef)(
  ({ className, ...others }, ref) => {
    const ctx = useModalBaseContext();
...
// node_modules/@mantine/core/esm/components/ModalBase/ModalBaseOverlay.mjs
var ModalBaseOverlay = (0, import_react166.forwardRef)(
...
// node_modules/@mantine/core/esm/components/ModalBase/ModalBaseTitle.mjs
var ModalBaseTitle = (0, import_react168.forwardRef)(
  ({ className, ...others }, ref) => {
...
function NativeScrollArea({ children }) {
  return (0, import_jsx_runtime85.jsx)(import_jsx_runtime85.Fragment, { children });
}
...
var InputLabel = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime89.jsxs)(
    Box,
    {
      ...
      children: [
        children,
        required && (0, import_jsx_runtime89.jsx)("span", { ...getStyles2("required"), "aria-hidden": true, children: " *" })
      ]
    }
  );
});
...
var InputWrapper = factory((_props, ref) => {
  ...
  const _label = label && (0, import_jsx_runtime91.jsx)(
    InputLabel,
    {
      labelElement,
      id: labelId,
  ...
  const _description = hasDescription && (0, import_jsx_runtime91.jsx)(
    InputDescription,
    {
      ...descriptionProps,
      ...sharedProps,
  ...
  const _input = (0, import_jsx_runtime91.jsx)(import_react174.Fragment, { children: inputContainer(children) }, "input");
  const _error = hasError && (0, import_react174.createElement)(
    InputError,
    {
      ...errorProps,
      ...sharedProps,
...
var Input = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime92.jsxs)(
    Box,
    {
      ...
      size: size2,
      children: [
        leftSection && (0, import_jsx_runtime92.jsx)(
          "div",
          {
            ...leftSectionProps,
            "data-position": "left",
        ...
        rightSection && (0, import_jsx_runtime92.jsx)(
          "div",
          {
            ...rightSectionProps,
            "data-position": "right",
...
var InputBase = polymorphicFactory((props, ref) => {
  ...
  return (0, import_jsx_runtime94.jsx)(Input.Wrapper, { ...wrapperProps, children: (0, import_jsx_runtime94.jsx)(Input, { ...inputProps, ...others, ref }) });
});
...
var Flex = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime95.jsxs)(import_jsx_runtime95.Fragment, { children: [
    parsedStyleProps.hasResponsiveStyles && (0, import_jsx_runtime95.jsx)(
      InlineStyles,
      {
        selector: `.${responsiveClassName}`,
        styles: parsedStyleProps.styles,
...
function useFloatingIndicator({
  ...
  const transitionTimeout = (0, import_react179.useRef)(-1);
  const [initialized, setInitialized] = (0, import_react179.useState)(false);
  const [hidden2, setHidden] = (0, import_react179.useState)(
  ...
  const targetResizeObserver = (0, import_react179.useRef)(null);
  const parentResizeObserver = (0, import_react179.useRef)(null);
...
var FloatingIndicator = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime97.jsx)(Box, { ref: mergedRef, mod: [{ initialized, hidden: hidden2 }, mod], ...getStyles2("root"), ...others });
});
...
var AccordionControl = factory((props, ref) => {
  ...
  const content = (0, import_jsx_runtime101.jsxs)(
    UnstyledButton,
    {
      ...others,
      ...
      children: [
        ...
        (0, import_jsx_runtime101.jsx)("span", { ...ctx.getStyles("label", { classNames, styles }), children }),
        icon && (0, import_jsx_runtime101.jsx)(
          Box,
          {
            component: "span",
  ...
  return shouldWrapWithHeading ? (0, import_jsx_runtime101.jsx)(Heading, { ...ctx.getStyles("itemTitle", { classNames, styles }), children: content }) : content;
});
...
var AccordionItem = factory((props, ref) => {
  ...
  const ctx = useAccordionContext();
  return (0, import_jsx_runtime102.jsx)(AccordionItemProvider, { value: { value }, children: (0, import_jsx_runtime102.jsx)(
    Box,
    {
      ref,
...
var AccordionPanel = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime103.jsx)(
    Collapse,
    {
      ...
      children: (0, import_jsx_runtime103.jsx)("div", { ...ctx.getStyles("content", { classNames, styles }), children })
    }
  );
});
...
var defaultProps30 = {
  ...
  variant: "default",
  chevron: (0, import_jsx_runtime104.jsx)(AccordionChevron, {})
};
...
function Accordion(_props) {
  ...
  return (0, import_jsx_runtime104.jsx)(
    AccordionProvider,
    {
      ...
      children: (0, import_jsx_runtime104.jsx)(Box, { ...getStyles2("root"), id: uid, ...others, variant, "data-accordion": true, children })
    }
  );
}
...
var Affix = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime105.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: (0, import_jsx_runtime105.jsx)(Box, { ref, ...getStyles2("root"), ...others }) });
});
...
var Alert = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime106.jsx)(
    Box,
    {
      ...
      children: (0, import_jsx_runtime106.jsxs)("div", { ...getStyles2("wrapper"), children: [
        icon && (0, import_jsx_runtime106.jsx)("div", { ...getStyles2("icon"), children: icon }),
        (0, import_jsx_runtime106.jsxs)("div", { ...getStyles2("body"), children: [
          title && (0, import_jsx_runtime106.jsx)("div", { ...getStyles2("title"), "data-with-close-button": withCloseButton || void 0, children: (0, import_jsx_runtime106.jsx)("span", { id: titleId, ...getStyles2("label"), children: title }) }),
          children && (0, import_jsx_runtime106.jsx)("div", { id: bodyId, ...getStyles2("message"), "data-variant": variant, children })
        ] }),
        withCloseButton && (0, import_jsx_runtime106.jsx)(
          CloseButton,
          {
...
var varsResolver21 = createVarsResolver((_, { size: size2, thumbSize }) => ({
  root: {
    "--slider-size": rem(size2),
...
var AngleSlider = factory((_props, ref) => {
  ...
  const marksItems = marks == null ? void 0 : marks.map((mark, index3) => (0, import_react192.createElement)(
    "div",
    {
  ...
  return (0, import_jsx_runtime109.jsxs)(Box, { ref: useMergedRef(ref, rootRef), ...getStyles2("root", { focusable: true }), ...others, children: [
    marksItems && marksItems.length > 0 && (0, import_jsx_runtime109.jsx)("div", { ...getStyles2("marks"), children: marksItems }),
    withLabel && (0, import_jsx_runtime109.jsx)("div", { ...getStyles2("label"), children: typeof formatLabel === "function" ? formatLabel(_value) : _value }),
    ...
    (0, import_jsx_runtime109.jsx)("input", { type: "hidden", name, value: _value, ...hiddenInputProps })
  ] });
});
...
function AppShellMediaStyles({
  ...
  return (0, import_jsx_runtime122.jsx)(InlineStyles, { media, styles: baseStyles, selector: ctx.cssVariablesSelector });
}
...
function useResizing({ transitionDuration, disabled }) {
  const [resizing, setResizing] = (0, import_react208.useState)(true);
  const resizingTimeout = (0, import_react208.useRef)(-1);
  const disabledTimeout = (0, import_react208.useRef)(-1);
  useWindowEvent("resize", () => {
    setResizing(true);
    clearTimeout(resizingTimeout.current);
    resizingTimeout.current = window.setTimeout(
      () => (0, import_react208.startTransition)(() => {
        setResizing(false);
      }),
      200
    );
...
var AppShell = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime125.jsxs)(AppShellProvider, { value: { getStyles: getStyles2, withBorder, zIndex, disabled, offsetScrollbars }, children: [
...
var AspectRatio = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime126.jsx)(Box, { ref, ...getStyles2("root"), ...others });
});
...
var varsResolver24 = createVarsResolver((_, { size: size2 }) => ({
  chevron: {
...
var ComboboxClearButton = (0, import_react213.forwardRef)(
  ({ size: size2, onMouseDown, onClick, onClear, ...others }, ref) => (0, import_jsx_runtime129.jsx)(
    CloseButton,
    {
      ref,
      size: size2 || "sm",
...
var ComboboxDropdownTarget = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime131.jsx)(Popover.Target, { ref, refProp, children });
});
...
function useComboboxTargetProps({
  ...
  const ctx = useComboboxContext();
  const [selectedOptionId, setSelectedOptionId] = (0, import_react217.useState)(null);
  const handleKeyDown = (event) => {
    onKeyDown == null ? void 0 : onKeyDown(event);
    if (ctx.readOnly) {
      return;
...
var ComboboxEventsTarget = factory((props, ref) => {
  ...
  return (0, import_react218.cloneElement)(children, {
    ...targetProps,
    ...others,
...
var ComboboxGroup = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime135.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        label && (0, import_jsx_runtime135.jsx)("div", { ...ctx.getStyles("groupLabel", { classNames, styles }), children: label }),
        children
      ]
    }
  );
...
var ComboboxOption = factory((_props, ref) => {
  ...
  const ctx = useComboboxContext();
  const uuid = (0, import_react222.useId)();
  const _id = id || uuid;
...
var ComboboxTarget = factory((props, ref) => {
  ...
  const clonedElement = (0, import_react225.cloneElement)(children, {
    ...targetProps,
    ...others
  });
  return (0, import_jsx_runtime141.jsx)(Popover.Target, { ref: useMergedRef(ref, ctx.store.targetRef), children: clonedElement });
});
...
function useCombobox({
  ...
  const listId = (0, import_react226.useRef)(null);
  const selectedOptionIndex = (0, import_react226.useRef)(-1);
  const searchRef = (0, import_react226.useRef)(null);
  const targetRef = (0, import_react226.useRef)(null);
  const focusSearchTimeout = (0, import_react226.useRef)(-1);
  const focusTargetTimeout = (0, import_react226.useRef)(-1);
  const selectedIndexUpdateTimeout = (0, import_react226.useRef)(-1);
  const openDropdown = (0, import_react226.useCallback)(
    (eventSource = "unknown") => {
      if (!dropdownOpened) {
  ...
  const closeDropdown = (0, import_react226.useCallback)(
    (eventSource = "unknown") => {
      if (dropdownOpened) {
  ...
  const toggleDropdown = (0, import_react226.useCallback)(
    (eventSource = "unknown") => {
      if (dropdownOpened) {
  ...
  const clearSelectedItem = (0, import_react226.useCallback)(() => {
  ...
  const selectOption = (0, import_react226.useCallback)(
    (index3) => {
  ...
  const selectActiveOption = (0, import_react226.useCallback)(() => {
  ...
  const selectNextOption = (0, import_react226.useCallback)(
    () => selectOption(
      getNextIndex2(
  ...
  const selectPreviousOption = (0, import_react226.useCallback)(
    () => selectOption(
      getPreviousIndex2(
        selectedOptionIndex.current,
        document.querySelectorAll(`#${listId.current} [data-combobox-option]`),
  ...
  const selectFirstOption = (0, import_react226.useCallback)(
    () => selectOption(
      getFirstIndex(
        document.querySelectorAll(`#${listId.current} [data-combobox-option]`)
      )
  ...
  const updateSelectedOptionIndex = (0, import_react226.useCallback)(
  ...
  const resetSelectedOption = (0, import_react226.useCallback)(() => {
    selectedOptionIndex.current = -1;
    clearSelectedItem();
  }, [clearSelectedItem]);
  const clickSelectedOption = (0, import_react226.useCallback)(() => {
    const items = document.querySelectorAll(
      `#${listId.current} [data-combobox-option]`
    );
  ...
  const setListId = (0, import_react226.useCallback)((id) => {
    listId.current = id;
  }, []);
  const focusSearchInput = (0, import_react226.useCallback)(() => {
    focusSearchTimeout.current = window.setTimeout(() => searchRef.current.focus(), 0);
  }, []);
  const focusTarget = (0, import_react226.useCallback)(() => {
    focusTargetTimeout.current = window.setTimeout(() => targetRef.current.focus(), 0);
  }, []);
  const getSelectedOptionIndex = (0, import_react226.useCallback)(() => selectedOptionIndex.current, []);
...
var varsResolver25 = createVarsResolver((_, { size: size2, dropdownPadding }) => ({
  options: {
...
var InlineInput = (0, import_react228.forwardRef)(
  ({
    __staticSelector,
    __stylesApiProps,
    className,
    ...
    return (0, import_jsx_runtime143.jsx)(
      Box,
      {
        ...
        size: size2,
        ...others,
        children: (0, import_jsx_runtime143.jsxs)(
          Box,
          {
            ...
            children: [
              children,
              (0, import_jsx_runtime143.jsxs)("div", { ...getStyles2("labelWrapper"), "data-disabled": disabled || void 0, children: [
                label && (0, import_jsx_runtime143.jsx)(
                  Box,
                  {
                    component: labelElement,
                ...
                description && (0, import_jsx_runtime143.jsx)(Input.Description, { size: size2, __inheritStyles: false, ...getStyles2("description"), children: description }),
                error && typeof error !== "boolean" && (0, import_jsx_runtime143.jsx)(Input.Error, { size: size2, __inheritStyles: false, ...getStyles2("error"), children: error })
              ] })
            ]
          }
        )
...
var CheckboxGroupContext = (0, import_react229.createContext)(null);
var CheckboxGroupProvider = CheckboxGroupContext.Provider;
var useCheckboxGroupContext = () => (0, import_react229.useContext)(CheckboxGroupContext);
...
var CheckboxCard = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime145.jsx)(CheckboxCardProvider, { value: { checked: _value }, children: (0, import_jsx_runtime145.jsx)(
    UnstyledButton,
    {
      ref,
...
function InputsGroupFieldset({ children, role }) {
  const ctx = useInputWrapperContext();
  if (!ctx) {
    return (0, import_jsx_runtime146.jsx)(import_jsx_runtime146.Fragment, { children });
  }
  return (0, import_jsx_runtime146.jsx)("div", { role, "aria-labelledby": ctx.labelId, "aria-describedby": ctx.describedBy, children });
}

// node_modules/@mantine/core/esm/components/Checkbox/CheckboxGroup/CheckboxGroup.mjs
var defaultProps58 = {};
var CheckboxGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size2, wrapperProps, children, readOnly, ...others } = useProps("CheckboxGroup", defaultProps58, props);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: [],
  ...
  return (0, import_jsx_runtime147.jsx)(CheckboxGroupProvider, { value: { value: _value, onChange: handleChange, size: size2 }, children: (0, import_jsx_runtime147.jsx)(
    Input.Wrapper,
    {
      size: size2,
      ref,
      ...
      children: (0, import_jsx_runtime147.jsx)(InputsGroupFieldset, { role: "group", children })
    }
  ) });
});
  ...
  if (indeterminate) {
    return (0, import_jsx_runtime148.jsx)(
      "svg",
      {
        ...
        "aria-hidden": true,
        ...others,
        children: (0, import_jsx_runtime148.jsx)("rect", { width: "32", height: "6", fill: "currentColor", rx: "3" })
      }
    );
  }
  return (0, import_jsx_runtime148.jsx)(CheckIcon, { ...others });
}
...
var CheckboxIndicator = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime149.jsx)(
    Box,
    {
      ...
      ...others,
      children: (0, import_jsx_runtime149.jsx)(Icon, { indeterminate, ...getStyles2("icon") })
    }
  );
});
...
var Checkbox = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime150.jsx)(
    InlineInput,
    {
      ...
      ...styleProps,
      ...wrapperProps,
      children: (0, import_jsx_runtime150.jsxs)(Box, { ...getStyles2("inner"), mod: { "data-label-position": labelPosition }, children: [
        ...
        (0, import_jsx_runtime150.jsx)(Icon, { indeterminate, ...getStyles2("icon") })
      ] })
    }
  );
});
...
function Option({
  ...
  if (!isOptionsGroup(data)) {
    ...
    const check = withCheckIcon && checked && (0, import_jsx_runtime151.jsx)(CheckIcon, { className: classes23.optionsDropdownCheckIcon });
    const defaultContent = (0, import_jsx_runtime151.jsxs)(import_jsx_runtime151.Fragment, { children: [
      checkIconPosition === "left" && check,
      (0, import_jsx_runtime151.jsx)("span", { children: data.label }),
  ...
  const options = data.items.map((item) => (0, import_jsx_runtime151.jsx)(
    Option,
    {
      data: item,
      value,
  ...
  return (0, import_jsx_runtime151.jsx)(Combobox.Group, { label: data.group, children: options });
}
function OptionsDropdown({
  ...
  const options = filteredData.map((item) => (0, import_jsx_runtime151.jsx)(
    Option,
    {
      data: item,
      withCheckIcon,
  ...
  return (0, import_jsx_runtime151.jsx)(Combobox.Dropdown, { hidden: hidden2 || hiddenWhenEmpty && isEmpty, children: (0, import_jsx_runtime151.jsxs)(Combobox.Options, { labelledBy: labelId, "aria-label": ariaLabel, children: [
    withScrollArea ? (0, import_jsx_runtime151.jsx)(
      ScrollArea.Autosize,
      {
    ...
    isEmpty && nothingFoundMessage && (0, import_jsx_runtime151.jsx)(Combobox.Empty, { children: nothingFoundMessage })
  ] }) });
}
...
var Autocomplete = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime152.jsxs)(
    Combobox,
    {
      ...
      ...comboboxProps,
      children: [
        (0, import_jsx_runtime152.jsx)(Combobox.Target, { autoComplete, children: (0, import_jsx_runtime152.jsx)(
          InputBase,
          {
            ref,
            ...others,
...
var AvatarGroupContext = (0, import_react238.createContext)(null);
var AvatarGroupProvider = AvatarGroupContext.Provider;
function useAvatarGroupContext() {
  const ctx = (0, import_react238.useContext)(AvatarGroupContext);
...
var AvatarGroup = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime153.jsx)(AvatarGroupProvider, { value: true, children: (0, import_jsx_runtime153.jsx)(Box, { ref, ...getStyles2("group"), ...others }) });
});
...
function AvatarPlaceholderIcon(props) {
  return (0, import_jsx_runtime154.jsx)(
    "svg",
    {
      ...
      fill: "none",
      xmlns: "http://www.w3.org/2000/svg",
      children: (0, import_jsx_runtime154.jsx)(
        "path",
        {
...
var Avatar = polymorphicFactory((_props, ref) => {
  ...
  const [error, setError] = (0, import_react240.useState)(!src);
  const getStyles2 = useStyles({
    name: "Avatar",
    props,
    classes: classes28,
  ...
  (0, import_react240.useEffect)(() => setError(!src), [src]);
  return (0, import_jsx_runtime155.jsx)(
    Box,
    {
      ...
      ref,
      ...others,
      children: error ? (0, import_jsx_runtime155.jsx)("span", { ...getStyles2("placeholder"), title: alt, children: children || typeof name === "string" && getInitials(name) || (0, import_jsx_runtime155.jsx)(AvatarPlaceholderIcon, {}) }) : (0, import_jsx_runtime155.jsx)(
        "img",
        {
          ...imageProps,
          ...getStyles2("image"),
...
var Badge = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime157.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        leftSection && (0, import_jsx_runtime157.jsx)("span", { ...getStyles2("section"), "data-position": "left", children: leftSection }),
        (0, import_jsx_runtime157.jsx)("span", { ...getStyles2("label"), children }),
        rightSection && (0, import_jsx_runtime157.jsx)("span", { ...getStyles2("section"), "data-position": "right", children: rightSection })
      ]
    }
  );
});
...
var Blockquote = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime158.jsxs)(Box, { component: "blockquote", ref, ...getStyles2("root"), ...others, children: [
    icon && (0, import_jsx_runtime158.jsx)("span", { ...getStyles2("icon"), children: icon }),
    children,
    cite && (0, import_jsx_runtime158.jsx)("cite", { ...getStyles2("cite"), children: cite })
  ] });
});
...
var Breadcrumbs = factory((_props, ref) => {
  ...
  const items = import_react244.Children.toArray(children).reduce((acc, child, index3, array) => {
    var _a;
    const item = isElement(child) ? (0, import_react244.cloneElement)(child, {
      ...getStyles2("breadcrumb", { className: (_a = child.props) == null ? void 0 : _a.className }),
      key: index3
    }) : (0, import_react244.createElement)("div", { ...getStyles2("breadcrumb"), key: index3 }, child);
    acc.push(item);
    if (index3 !== array.length - 1) {
      acc.push(
        (0, import_react244.createElement)(Box, { ...getStyles2("separator"), key: `separator-${index3}` }, separator)
      );
    }
    return acc;
  }, []);
  return (0, import_jsx_runtime159.jsx)(Box, { ref, ...getStyles2("root"), ...others, children: items });
});
...
var Burger = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime160.jsxs)(UnstyledButton, { ...getStyles2("root"), ref, ...others, children: [
    (0, import_jsx_runtime160.jsx)(Box, { mod: ["reduce-motion", { opened }], ...getStyles2("burger") }),
    children
  ] });
});
...
var ButtonGroupSection = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime162.jsx)(Box, { ...getStyles2("groupSection"), ref, variant, ...others });
});
...
var Button = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime163.jsxs)(
    UnstyledButton,
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime163.jsx)(Transition, { mounted: !!loading, transition: loaderTransition, duration: 150, children: (transitionStyles) => (0, import_jsx_runtime163.jsx)(Box, { component: "span", ...getStyles2("loader", { style: transitionStyles }), "aria-hidden": true, children: (0, import_jsx_runtime163.jsx)(
          Loader,
          {
        ...
        (0, import_jsx_runtime163.jsxs)("span", { ...getStyles2("inner"), children: [
          leftSection && (0, import_jsx_runtime163.jsx)(Box, { component: "span", ...getStyles2("section"), mod: { position: "left" }, children: leftSection }),
          (0, import_jsx_runtime163.jsx)(Box, { component: "span", mod: { loading }, ...getStyles2("label"), children }),
          rightSection && (0, import_jsx_runtime163.jsx)(Box, { component: "span", ...getStyles2("section"), mod: { position: "right" }, children: rightSection })
        ] })
      ]
    }
  );
...
var Card = polymorphicFactory((_props, ref) => {
  ...
  const _children = import_react251.Children.toArray(children);
  const content = _children.map((child, index3) => {
    if (typeof child === "object" && child && "type" in child && child.type === CardSection) {
      return (0, import_react251.cloneElement)(child, {
  ...
  return (0, import_jsx_runtime166.jsx)(CardProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime166.jsx)(Paper, { ref, unstyled, ...getStyles2("root"), ...others, children: content }) });
});
...
var Center = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime167.jsx)(Box, { ref, mod: [{ inline: inline2 }, mod], ...getStyles2("root"), ...others });
});
...
function ChipGroup(props) {
  ...
  return (0, import_jsx_runtime169.jsx)(ChipGroupProvider, { value: { isChipSelected, onChange: handleChange, multiple }, children });
}
      ...
      children: [
        ...
        (0, import_jsx_runtime170.jsxs)(
          "label",
          {
            ...
            children: [
              _checked && (0, import_jsx_runtime170.jsx)("span", { ...getStyles2("iconWrapper"), children: icon || (0, import_jsx_runtime170.jsx)(CheckIcon, { ...getStyles2("checkIcon") }) }),
              (0, import_jsx_runtime170.jsx)("span", { children })
            ]
          }
        )
      ]
...
var varsResolver42 = createVarsResolver((_, { radius, size: size2 }) => ({
  root: {
...
var ColorSwatch = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime172.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime172.jsx)("span", { ...getStyles2("alphaOverlay") }),
        withShadow && (0, import_jsx_runtime172.jsx)("span", { ...getStyles2("shadowOverlay") }),
        (0, import_jsx_runtime172.jsx)("span", { ...getStyles2("colorOverlay", { style: { backgroundColor: color } }) }),
        (0, import_jsx_runtime172.jsx)("span", { ...getStyles2("childrenOverlay"), children })
      ]
    }
  );
});
...
var Thumb2 = (0, import_react259.forwardRef)(({ position, ...others }, ref) => (0, import_jsx_runtime174.jsx)(
  Box,
  {
    ref,
    __vars: {
...
var ColorSlider = factory((_props, ref) => {
  ...
  const theme = useMantineTheme();
  const [position, setPosition] = (0, import_react260.useState)({ y: 0, x: value / maxValue });
  ...
  const layers = overlays.map((overlay, index3) => (0, import_react260.createElement)("div", { ...getStyles2("sliderOverlay"), style: overlay, key: index3 }));
...
function rgbaToHsva({ r, g: g2, b, a }) {
  const max = Math.max(r, g2, b);
  const delta = max - Math.min(r, g2, b);
  const hh = delta ? max === r ? (g2 - b) / delta : max === g2 ? 2 + (b - r) / delta : 4 + (r - g2) / delta : 0;
  return {
...
// node_modules/@mantine/core/esm/components/ColorPicker/AlphaSlider/AlphaSlider.mjs
var defaultProps80 = {};
var AlphaSlider = (0, import_react261.forwardRef)((props, ref) => {
...
function hsvaToRgba(color, includeAlpha) {
  const { r, g: g2, b, a } = hsvaToRgbaObject(color);
  if (!includeAlpha) {
    return `rgb(${r}, ${g2}, ${b})`;
  }
  return `rgba(${r}, ${g2}, ${b}, ${round(a, 2)})`;
}
...
function hsvaToHex(color) {
  const { r, g: g2, b } = hsvaToRgbaObject(color);
  return `#${formatHexPart(r)}${formatHexPart(g2)}${formatHexPart(b)}`;
}
...
var HueSlider = (0, import_react262.forwardRef)((props, ref) => {
...
function Saturation({
  ...
  const [position, setPosition] = (0, import_react263.useState)({ x: value.s / 100, y: 1 - value.v / 100 });
  const positionRef = (0, import_react263.useRef)(position);
  const { ref } = useMove(
    ({ x, y: y2 }) => {
      positionRef.current = { x, y: y2 };
      onChange({ s: Math.round(x * 100), v: Math.round((1 - y2) * 100) });
    },
    {
      onScrubEnd: () => {
        const { x, y: y2 } = positionRef.current;
        onChangeEnd({ s: Math.round(x * 100), v: Math.round((1 - y2) * 100) });
        onScrubEnd == null ? void 0 : onScrubEnd();
      },
      onScrubStart
    }
  ...
  return (0, import_jsx_runtime178.jsxs)(
    Box,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime178.jsx)(Thumb2, { position, ...getStyles2("thumb", { style: { backgroundColor: color } }) })
      ]
    }
  );
}
...
var Swatches = (0, import_react264.forwardRef)(
  ({
    className,
    datatype,
    setValue,
    ...
    const colors = data.map((color, index3) => (0, import_react264.createElement)(
      ColorSwatch,
      {
    ...
    return (0, import_jsx_runtime179.jsx)(Box, { ...ctx.getStyles("swatches"), ref, ...others, children: colors });
  }
);
...
var varsResolver43 = createVarsResolver((_, { size: size2, swatchesPerRow }) => ({
  wrapper: {
...
var ColorPicker = factory((_props, ref) => {
  ...
  const formatRef = (0, import_react265.useRef)(format2);
  const valueRef = (0, import_react265.useRef)("");
  const scrubTimeoutRef = (0, import_react265.useRef)(-1);
  const isScrubbingRef = (0, import_react265.useRef)(false);
  ...
  const [parsed, setParsed] = (0, import_react265.useState)(parseColor(_value));
  const startScrubbing = () => {
  ...
  return (0, import_jsx_runtime180.jsx)(ColorPickerProvider, { value: { getStyles: getStyles2, unstyled }, children: (0, import_jsx_runtime180.jsxs)(
    Box,
    {
      ref,
      ...getStyles2("wrapper"),
      ...
      ...others,
      children: [
        withPicker && (0, import_jsx_runtime180.jsxs)(import_jsx_runtime180.Fragment, { children: [
          ...
          (0, import_jsx_runtime180.jsxs)("div", { ...getStyles2("body"), children: [
            (0, import_jsx_runtime180.jsxs)("div", { ...getStyles2("sliders"), children: [
              (0, import_jsx_runtime180.jsx)(
                HueSlider,
                {
                  value: parsed.h,
              ...
              withAlpha && (0, import_jsx_runtime180.jsx)(
                AlphaSlider,
                {
                  value: parsed.a,
        ...
        Array.isArray(swatches) && (0, import_jsx_runtime180.jsx)(
          Swatches,
          {
            data: swatches,
            swatchesPerRow,
...
function EyeDropperIcon({ style, ...others }) {
  return (0, import_jsx_runtime181.jsxs)(
    "svg",
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime181.jsx)("path", { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
        (0, import_jsx_runtime181.jsx)("path", { d: "M11 7l6 6" }),
        (0, import_jsx_runtime181.jsx)("path", { d: "M4 16l11.7 -11.7a1 1 0 0 1 1.4 0l2.6 2.6a1 1 0 0 1 0 1.4l-11.7 11.7h-4v-4z" })
      ]
    }
  );
}
...
var varsResolver44 = createVarsResolver((_, { size: size2 }) => ({
  eyeDropperIcon: {
...
var ColorInput = factory((_props, ref) => {
  ...
  const [dropdownOpened, setDropdownOpened] = (0, import_react266.useState)(false);
  const [lastValidValue, setLastValidValue] = (0, import_react266.useState)("");
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: "",
  ...
  const eyeDropper = (0, import_jsx_runtime182.jsx)(
    ActionIcon,
    {
      ...eyeDropperButtonProps,
      ...
      children: eyeDropperIcon || (0, import_jsx_runtime182.jsx)(EyeDropperIcon, { ...getStyles2("eyeDropperIcon") })
    }
  );
    ...
    Input.Wrapper,
    {
      ...
      children: (0, import_jsx_runtime182.jsxs)(
        Popover,
        {
          ...
          children: [
            (0, import_jsx_runtime182.jsx)(Popover.Target, { children: (0, import_jsx_runtime182.jsx)(
              Input,
              {
                autoComplete: "off",
                ...others,
                ...
                leftSection: leftSection || (withPreview ? (0, import_jsx_runtime182.jsx)(
                  ColorSwatch,
                  {
...
// node_modules/@mantine/core/esm/components/Container/Container.mjs
var defaultProps83 = {};
var varsResolver45 = createVarsResolver((_, { size: size2, fluid }) => ({
  root: {
...
var Container = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime183.jsx)(Box, { ref, mod: [{ fluid }, mod], ...getStyles2("root"), ...others });
});
...
function CopyButton(props) {
  ...
  return (0, import_jsx_runtime184.jsx)(import_jsx_runtime184.Fragment, { children: children({ copy, copied: clipboard.copied, ...others }) });
}
...
var varsResolver46 = createVarsResolver((_, { size: size2 }) => ({
  root: {
...
var Dialog = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime185.jsx)(
    Affix,
    {
      ...
      portalProps,
      unstyled,
      children: (0, import_jsx_runtime185.jsx)(Transition, { keepMounted, mounted: opened, ...transitionProps, children: (transitionStyles) => (0, import_jsx_runtime185.jsxs)(
        Paper,
        {
          unstyled,
          ...
          ...others,
          children: [
            withCloseButton && (0, import_jsx_runtime185.jsx)(CloseButton, { onClick: onClose, unstyled, ...getStyles2("closeButton") }),
            children
          ]
        }
      ) })
...
var varsResolver47 = createVarsResolver((theme, { color, variant, size: size2 }) => ({
  root: {
...
var Divider = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime186.jsx)(
    Box,
    {
      ...
      ...others,
      role: "separator",
      children: label && (0, import_jsx_runtime186.jsx)(Box, { component: "span", mod: { position: labelPosition }, ...getStyles2("label"), children: label })
    }
  );
});
...
var DrawerContent = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime190.jsx)(
    ModalBaseContent,
    {
      ...
      children: (0, import_jsx_runtime190.jsx)(Scroll, { style: { height: "calc(100vh - var(--drawer-offset) * 2)" }, children })
    }
  );
});
...
var varsResolver48 = createVarsResolver((_, { position, size: size2, offset: offset2 }) => ({
  root: {
...
var DrawerRoot = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime193.jsx)(DrawerProvider, { value: { scrollAreaComponent, getStyles: getStyles2, radius }, children: (0, import_jsx_runtime193.jsx)(
    ModalBase,
    {
      ref,
      ...getStyles2("root"),
...
function DrawerStack({ children }) {
  const [stack, setStack] = (0, import_react279.useState)([]);
  const [maxZIndex, setMaxZIndex] = (0, import_react279.useState)(getDefaultZIndex("modal"));
...
var Drawer = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime196.jsxs)(
    DrawerRoot,
    {
      ...
      ...stackProps,
      children: [
        withOverlay && (0, import_jsx_runtime196.jsx)(
          DrawerOverlay,
          {
        ...
        (0, import_jsx_runtime196.jsxs)(DrawerContent, { __hidden: ctx && stackId && opened ? stackId !== ctx.currentId : false, children: [
          hasHeader && (0, import_jsx_runtime196.jsxs)(DrawerHeader, { children: [
            title && (0, import_jsx_runtime196.jsx)(DrawerTitle, { children: title }),
            withCloseButton && (0, import_jsx_runtime196.jsx)(DrawerCloseButton, { ...closeButtonProps })
          ] }),
          (0, import_jsx_runtime196.jsx)(DrawerBody, { children })
        ] })
      ]
    }
  );
...
var Fieldset = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime197.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        legend && (0, import_jsx_runtime197.jsx)("legend", { ...getStyles2("legend", { variant }), children: legend }),
        children
      ]
    }
  );
...
var FileButton = (0, import_react283.forwardRef)(
  (props, ref) => {
    const {
      onChange,
      children,
    ...
    return (0, import_jsx_runtime198.jsxs)(import_jsx_runtime198.Fragment, { children: [
...
var DefaultValue = ({ value }) => (0, import_jsx_runtime199.jsx)("div", { style: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: Array.isArray(value) ? value.map((file) => file.name).join(", ") : value == null ? void 0 : value.name });
var defaultProps97 = {
...
var _FileInput = factory((_props, ref) => {
  ...
  const resetRef = (0, import_react284.useRef)(null);
  const { resolvedClassNames, resolvedStyles } = useResolvedStylesApi({
    classNames,
    styles,
    props
  ...
  const _rightSection = rightSection || (clearable && hasValue && !readOnly ? (0, import_jsx_runtime199.jsx)(
    CloseButton,
    {
      ...clearButtonProps,
      variant: "subtle",
  ...
  return (0, import_jsx_runtime199.jsx)(
    FileButton,
    {
      ...
      children: (fileButtonProps) => (0, import_jsx_runtime199.jsx)(
        InputBase,
        {
          ...
          classNames,
          styles,
          children: !hasValue ? (0, import_jsx_runtime199.jsx)(
            Input.Placeholder,
            {
              __staticSelector: "FileInput",
              classNames: resolvedClassNames,
          ...
          ) : (0, import_jsx_runtime199.jsx)(ValueComponent, { value: _value })
        }
      )
    }
  );
...
function useDelayedHover({ open, close, openDelay, closeDelay }) {
  const openTimeout = (0, import_react285.useRef)(-1);
  const closeTimeout = (0, import_react285.useRef)(-1);
  const clearTimeouts = () => {
  ...
  (0, import_react285.useEffect)(() => clearTimeouts, []);
...
var GridCol = factory((_props, ref) => {
  ...
  const ctx = useGridContext();
  const responsiveClassName = useRandomClassName();
  return (0, import_jsx_runtime202.jsxs)(import_jsx_runtime202.Fragment, { children: [
...
var Grid = factory((_props, ref) => {
  ...
  if (type === "container" && breakpoints) {
    return (0, import_jsx_runtime204.jsxs)(GridProvider, { value: { getStyles: getStyles2, grow, columns: columns || 12, breakpoints, type }, children: [
      (0, import_jsx_runtime204.jsx)(GridVariables, { selector: `.${responsiveClassName}`, ...props }),
      (0, import_jsx_runtime204.jsx)("div", { ...getStyles2("container"), children: (0, import_jsx_runtime204.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others, children: (0, import_jsx_runtime204.jsx)("div", { ...getStyles2("inner"), children }) }) })
    ] });
  }
  return (0, import_jsx_runtime204.jsxs)(GridProvider, { value: { getStyles: getStyles2, grow, columns: columns || 12, breakpoints, type }, children: [
    (0, import_jsx_runtime204.jsx)(GridVariables, { selector: `.${responsiveClassName}`, ...props }),
    (0, import_jsx_runtime204.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others, children: (0, import_jsx_runtime204.jsx)("div", { ...getStyles2("inner"), children }) })
  ] });
});
...
var Mark = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime206.jsx)(Box, { component: "mark", ref, variant, ...getStyles2("root"), ...others });
});
...
var Highlight = polymorphicFactory((props, ref) => {
  ...
  return (0, import_jsx_runtime207.jsx)(Text, { unstyled, ref, ...others, __staticSelector: "Highlight", children: highlightChunks.map(
    ({ chunk, highlighted }, i2) => highlighted ? (0, import_jsx_runtime207.jsx)(
      Mark,
      {
        unstyled,
        color,
      ...
      i2
    ) : (0, import_jsx_runtime207.jsx)("span", { children: chunk }, i2)
  ) });
});
...
function HoverCardDropdown(props) {
  ...
  return (0, import_jsx_runtime209.jsx)(Popover.Dropdown, { onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, ...others, children });
}
...
var HoverCardTarget = (0, import_react296.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime210.jsx)(Popover.Target, { refProp, ref, ...others, children: (0, import_react296.cloneElement)(
    children,
...
function HoverCard(props) {
  ...
  return (0, import_jsx_runtime211.jsx)(HoverCardContextProvider, { value: { openDropdown, closeDropdown }, children: (0, import_jsx_runtime211.jsx)(Popover, { ...others, opened, __staticSelector: "HoverCard", children }) });
}
...
var Image = polymorphicFactory((_props, ref) => {
  ...
  const [error, setError] = (0, import_react299.useState)(!src);
  (0, import_react299.useEffect)(() => setError(!src), [src]);
  const getStyles2 = useStyles({
    name: "Image",
    classes: classes49,
    props,
...
var Indicator = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime214.jsxs)(Box, { ref, ...getStyles2("root"), mod: [{ inline: inline2 }, mod], ...others, children: [
    !disabled && (0, import_jsx_runtime214.jsx)(
      Box,
      {
...
var index = import_react302.useLayoutEffect;

// node_modules/use-latest/dist/use-latest.esm.js
var useLatest = function useLatest2(value) {
  var ref = import_react303.default.useRef(value);
  index(function() {
    ref.current = value;
  });
  return ref;
...
var useComposedRef = function useComposedRef2(libRef, userRef) {
  var prevUserRef = import_react304.default.useRef();
  return import_react304.default.useCallback(function(instance) {
...
var JsonInput = factory((props, ref) => {
  ...
  const [valid, setValid] = (0, import_react306.useState)(validateJson(_value, deserialize));
...
// node_modules/@mantine/core/esm/components/Kbd/Kbd.mjs
var defaultProps109 = {};
var varsResolver54 = createVarsResolver((_, { size: size2 }) => ({
  root: {
...
var Kbd = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime217.jsx)(Box, { component: "kbd", ref, ...getStyles2("root"), ...others });
});
...
var ListItem = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime219.jsx)(
    Box,
    {
      ...
      ref,
      ...others,
      children: (0, import_jsx_runtime219.jsxs)("div", { ...ctx.getStyles("itemWrapper", stylesApiProps), children: [
        _icon && (0, import_jsx_runtime219.jsx)("span", { ...ctx.getStyles("itemIcon", stylesApiProps), children: _icon }),
        (0, import_jsx_runtime219.jsx)("span", { ...ctx.getStyles("itemLabel", stylesApiProps), children })
      ] })
    }
  );
});
...
var varsResolver55 = createVarsResolver((_, { size: size2, spacing }) => ({
  root: {
...
var List = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime220.jsx)(ListProvider, { value: { center, icon, getStyles: getStyles2 }, children: (0, import_jsx_runtime220.jsx)(
    Box,
    {
...
var LoadingOverlay = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime221.jsx)(Transition, { transition: "fade", ...transitionProps, mounted: !!visible2, children: (transitionStyles) => (0, import_jsx_runtime221.jsxs)(Box, { ...getStyles2("root", { style: transitionStyles }), ref, ...others, children: [
    (0, import_jsx_runtime221.jsx)(Loader, { ...getStyles2("loader"), unstyled, ...loaderProps }),
...
var MenuDropdown = factory((props, ref) => {
  ...
  const wrapperRef = (0, import_react314.useRef)(null);
  const ctx = useMenuContext();
  ...
  return (0, import_jsx_runtime224.jsxs)(
    Popover.Dropdown,
    {
      ...
      onKeyDown: handleKeyDown,
      children: [
        (0, import_jsx_runtime224.jsx)("div", { tabIndex: -1, "data-autofocus": true, "data-mantine-stop-propagation": true, style: { outline: 0 } }),
        children
      ]
    }
  );
...
var MenuItem = polymorphicFactory((props, ref) => {
  ...
  const theme = useMantineTheme();
  const { dir } = useDirection();
  const itemRef = (0, import_react315.useRef)(null);
  ...
  return (0, import_jsx_runtime225.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        leftSection && (0, import_jsx_runtime225.jsx)("div", { ...ctx.getStyles("itemSection", { styles, classNames }), "data-position": "left", children: leftSection }),
        children && (0, import_jsx_runtime225.jsx)("div", { ...ctx.getStyles("itemLabel", { styles, classNames }), children }),
        rightSection && (0, import_jsx_runtime225.jsx)("div", { ...ctx.getStyles("itemSection", { styles, classNames }), "data-position": "right", children: rightSection })
      ]
    }
  );
});
...
var MenuTarget = (0, import_react317.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime227.jsx)(Popover.Target, { refProp, popupType: "menu", ref, ...others, children: (0, import_react317.cloneElement)(children, {
    onClick,
    onMouseEnter,
    onMouseLeave,
...
function Menu(_props) {
  ...
  const [openedViaClick, setOpenedViaClick] = (0, import_react318.useState)(false);
  const close = () => {
    setOpened(false);
  ...
  return (0, import_jsx_runtime228.jsx)(
    MenuContextProvider,
    {
      ...
      children: (0, import_jsx_runtime228.jsx)(
        Popover,
        {
          ...others,
          opened: _opened,
...
var ModalBody = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime230.jsx)(
    ModalBaseBody,
    {
      ref,
      ...ctx.getStyles("body", { classNames, style, styles, className }),
...
var ModalContent = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime232.jsx)(
    ModalBaseContent,
    {
      ...
      ref,
      ...others,
      children: (0, import_jsx_runtime232.jsx)(
        Scroll,
        {
          style: {
...
var ModalRoot = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime235.jsx)(ModalProvider, { value: { yOffset, scrollAreaComponent, getStyles: getStyles2, fullScreen }, children: (0, import_jsx_runtime235.jsx)(
    ModalBase,
    {
      ref,
      ...getStyles2("root"),
...
function ModalStack({ children }) {
  const [stack, setStack] = (0, import_react327.useState)([]);
  const [maxZIndex, setMaxZIndex] = (0, import_react327.useState)(getDefaultZIndex("modal"));
...
var Modal = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime238.jsxs)(
    ModalRoot,
    {
      ref,
      radius,
      ...
      ...stackProps,
      children: [
        withOverlay && (0, import_jsx_runtime238.jsx)(
          ModalOverlay,
          {
            visible: overlayVisible,
            transitionProps: ctx && stackId ? { duration: 0 } : void 0,
        ...
        (0, import_jsx_runtime238.jsxs)(
          ModalContent,
          {
            ...
            children: [
              hasHeader && (0, import_jsx_runtime238.jsxs)(ModalHeader, { children: [
                title && (0, import_jsx_runtime238.jsx)(ModalTitle, { children: title }),
                withCloseButton && (0, import_jsx_runtime238.jsx)(ModalCloseButton, { ...closeButtonProps })
              ] }),
              (0, import_jsx_runtime238.jsx)(ModalBody, { children })
            ]
          }
        )
      ]
...
// node_modules/@mantine/core/esm/components/Pill/PillGroup/PillGroup.mjs
var defaultProps127 = {};
var varsResolver58 = createVarsResolver((_, { gap }, { size: size2 }) => ({
  group: {
...
var PillGroup = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime241.jsx)(PillGroupProvider, { value: { size: _size, disabled }, children: (0, import_jsx_runtime241.jsx)(Box, { ref, size: _size, ...getStyles2("group"), ...others }) });
});
...
var varsResolver59 = createVarsResolver((_, { radius }, { size: size2 }) => ({
  root: {
...
var Pill = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime242.jsxs)(
    Box,
    {
      component: "span",
      ref,
      ...
      ...others,
      children: [
        (0, import_jsx_runtime242.jsx)("span", { ...getStyles2("label"), children }),
        withRemoveButton && (0, import_jsx_runtime242.jsx)(
          CloseButton,
          {
            variant: "transparent",
            radius,
...
var PillsInput = factory((_props, ref) => {
  ...
  const fieldRef = (0, import_react336.useRef)(null);
  return (0, import_jsx_runtime244.jsx)(PillsInputProvider, { value: { fieldRef, size: size2, disabled, hasError: !!error, variant }, children: (0, import_jsx_runtime244.jsx)(
    InputBase,
    {
      size: size2,
      error,
...
var MultiSelect = factory((_props, ref) => {
  ...
  (0, import_react338.useEffect)(() => {
    if (selectFirstOptionOnChange) {
      combobox.selectFirstOption();
    }
  }, [selectFirstOptionOnChange, _value]);
  const clearButton = clearable && _value.length > 0 && !disabled && !readOnly && (0, import_jsx_runtime246.jsx)(
  ...
  return (0, import_jsx_runtime246.jsxs)(import_jsx_runtime246.Fragment, { children: [
    (0, import_jsx_runtime246.jsxs)(
      Combobox,
      {
        store: combobox,
        classNames: resolvedClassNames,
        ...
        ...comboboxProps,
        children: [
          (0, import_jsx_runtime246.jsx)(Combobox.DropdownTarget, { children: (0, import_jsx_runtime246.jsx)(
            PillsInput,
            {
              ...styleProps,
              __staticSelector: "MultiSelect",
              ...
              disabled,
              radius,
              rightSection: rightSection || clearButton || (0, import_jsx_runtime246.jsx)(Combobox.Chevron, { size: size2, error, unstyled }),
              ...
              required,
              mod,
              children: (0, import_jsx_runtime246.jsxs)(Pill.Group, { disabled, unstyled, ...getStyles2("pillsList"), children: [
                values2,
                (0, import_jsx_runtime246.jsx)(Combobox.EventsTarget, { autoComplete, children: (0, import_jsx_runtime246.jsx)(
                  PillsInput.Field,
                  {
                    ...rest,
                    ref,
...
function NativeSelectOption({ data }) {
  if (isGroup(data)) {
    const items = data.items.map((item) => (0, import_jsx_runtime247.jsx)(NativeSelectOption, { data: item }, item.value));
    return (0, import_jsx_runtime247.jsx)("optgroup", { label: data.group, children: items });
  }
  const { value, label, ...others } = data;
  return (0, import_jsx_runtime247.jsx)("option", { value: data.value, ...others, children: data.label }, data.value);
}
...
var NativeSelect = factory((props, ref) => {
  ...
  const options = getParsedComboboxData(data).map((item, index3) => (0, import_jsx_runtime248.jsx)(NativeSelectOption, { data: item }, index3));
  return (0, import_jsx_runtime248.jsx)(
    InputBase,
    {
      ...
      error,
      unstyled,
      rightSection: rightSection || (0, import_jsx_runtime248.jsx)(ComboboxChevron, { size: size2, error, unstyled }),
...
var NavLink = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime249.jsxs)(import_jsx_runtime249.Fragment, { children: [
    (0, import_jsx_runtime249.jsxs)(
      UnstyledButton,
      {
        ...
        ...others,
        children: [
          leftSection && (0, import_jsx_runtime249.jsx)(Box, { component: "span", ...getStyles2("section"), mod: { position: "left" }, children: leftSection }),
          (0, import_jsx_runtime249.jsxs)(Box, { ...getStyles2("body"), mod: { "no-wrap": noWrap }, children: [
            (0, import_jsx_runtime249.jsx)(Box, { component: "span", ...getStyles2("label"), children: label }),
            (0, import_jsx_runtime249.jsx)(Box, { component: "span", mod: { active }, ...getStyles2("description"), children: description })
          ] }),
          (withChildren || rightSection) && (0, import_jsx_runtime249.jsx)(
            Box,
            {
              ...getStyles2("section"),
              component: "span",
              mod: { rotate: _opened && !disableRightSectionRotation, position: "right" },
              children: withChildren ? rightSection || (0, import_jsx_runtime249.jsx)(AccordionChevron, { ...getStyles2("chevron") }) : rightSection
            }
          )
        ]
      }
    ),
    withChildren && (0, import_jsx_runtime249.jsx)(Collapse, { in: _opened, ...getStyles2("collapse"), children: (0, import_jsx_runtime249.jsx)("div", { ...getStyles2("children"), children }) })
  ] });
});
...
var Notification = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime250.jsxs)(
    Box,
    {
      ...getStyles2("root"),
      ...
      role: "alert",
      children: [
        icon && !loading && (0, import_jsx_runtime250.jsx)("div", { ...getStyles2("icon"), children: icon }),
        loading && (0, import_jsx_runtime250.jsx)(Loader, { size: 28, color, ...getStyles2("loader") }),
        (0, import_jsx_runtime250.jsxs)("div", { ...getStyles2("body"), children: [
          title && (0, import_jsx_runtime250.jsx)("div", { ...getStyles2("title"), children: title }),
          (0, import_jsx_runtime250.jsx)(Box, { ...getStyles2("description"), mod: { "data-with-title": !!title }, children })
        ] }),
        withCloseButton && (0, import_jsx_runtime250.jsx)(
          CloseButton,
          {
            iconSize: 16,
            color: "gray",
...
function usePersistentCallback(cb) {
  var callbackRef = (0, import_react342.useRef)(cb);
  callbackRef.current = cb;
  var persistentCbRef = (0, import_react342.useRef)(function() {
    var args = [], len = arguments.length;
    while (len--) args[len] = arguments[len];
...
function useInternalValues(value, defaultValue, valueIsNumericString, format2, removeFormatting2, onValueChange) {
  ...
  var ref = (0, import_react342.useState)(function() {
  ...
  (0, import_react342.useMemo)(function() {
    setValues(newValues);
...
function NumberFormatBase(props) {
  ...
  var caretPositionBeforeChange = (0, import_react342.useRef)();
  var lastUpdatedValue = (0, import_react342.useRef)({ formattedValue, numAsString });
  ...
  var ref$1 = (0, import_react342.useState)(false);
  var mounted = ref$1[0];
  var setMounted = ref$1[1];
  var focusedElm = (0, import_react342.useRef)(null);
  var timeout = (0, import_react342.useRef)({
    setCaretTimeout: null,
    focusTimeout: null
  });
  (0, import_react342.useEffect)(function() {
    setMounted(true);
    return function() {
  ...
  var useIsomorphicLayoutEffect2 = typeof window !== "undefined" ? import_react342.useLayoutEffect : import_react342.useEffect;
  ...
  if (displayType === "text") {
    return renderText ? import_react342.default.createElement(import_react342.default.Fragment, null, renderText(formattedValue, otherProps) || null) : import_react342.default.createElement("span", Object.assign({}, otherProps, { ref: getInputRef }), formattedValue);
  } else if (customInput) {
    var CustomInput = customInput;
    return import_react342.default.createElement(CustomInput, Object.assign({}, inputProps, { ref: getInputRef }));
  }
  return import_react342.default.createElement("input", Object.assign({}, inputProps, { ref: getInputRef }));
}
...
function NumericFormat(props) {
  ...
  return import_react342.default.createElement(NumberFormatBase, Object.assign({}, numericFormatProps));
}
...
function NumberFormatter(_props) {
  ...
  return (0, import_jsx_runtime251.jsx)(NumericFormat, { displayType: "text", value, ...others });
}
...
var varsResolver62 = createVarsResolver((_, { size: size2 }) => ({
  controls: {
...
var NumberInput = factory((_props, ref) => {
  ...
  const inputRef = (0, import_react344.useRef)(null);
  const onStepTimeoutRef = (0, import_react344.useRef)(null);
  const stepCountRef = (0, import_react344.useRef)(0);
  ...
  const incrementRef = (0, import_react344.useRef)(noop);
  ...
  const decrementRef = (0, import_react344.useRef)(noop);
  ...
  const controls = (0, import_jsx_runtime253.jsxs)("div", { ...getStyles2("controls"), children: [
    (0, import_jsx_runtime253.jsx)(
      UnstyledButton,
      {
        ...
        children: (0, import_jsx_runtime253.jsx)(NumberInputChevron, { direction: "up" })
      }
    ),
    (0, import_jsx_runtime253.jsx)(
      UnstyledButton,
      {
        ...
        onPointerUp: onStepDone,
        onPointerLeave: onStepDone,
        children: (0, import_jsx_runtime253.jsx)(NumberInputChevron, { direction: "down" })
      }
    )
  ] });
...
function PaginationIcon({ style, children, path, ...others }) {
  return (0, import_jsx_runtime256.jsx)(
    "svg",
    {
      ...
      ...others,
      children: (0, import_jsx_runtime256.jsx)("path", { d: path, fill: "currentColor" })
    }
  );
}
var PaginationNextIcon = (props) => (0, import_jsx_runtime256.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationPreviousIcon = (props) => (0, import_jsx_runtime256.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationFirstIcon = (props) => (0, import_jsx_runtime256.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationLastIcon = (props) => (0, import_jsx_runtime256.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationDotsIcon = (props) => (0, import_jsx_runtime256.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationDots = factory((_props, ref) => {
  ...
  const ctx = usePaginationContext();
  const Icon = icon;
  return (0, import_jsx_runtime257.jsx)(Box, { ref, ...ctx.getStyles("dots", { className, style, styles, classNames }), ...others, children: (0, import_jsx_runtime257.jsx)(
    Icon,
    {
      style: {
        width: "calc(var(--pagination-control-size) / 1.8)",
...
function createEdgeComponent({ icon, name, action, type }) {
  ...
  const Component = (0, import_react348.forwardRef)((props, ref) => {
...
function PaginationItems({ dotsIcon }) {
  ...
  const items = ctx.range.map((page, index3) => {
    var _a, _b, _c;
    if (page === "dots") {
      return (0, import_jsx_runtime259.jsx)(PaginationDots, { icon: dotsIcon }, index3);
    }
  ...
  return (0, import_jsx_runtime259.jsx)(import_jsx_runtime259.Fragment, { children: items });
}
...
var PaginationRoot = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime260.jsx)(
    PaginationProvider,
    {
      ...
      children: (0, import_jsx_runtime260.jsx)(Box, { ref, ...getStyles2("root"), ...others })
    }
  );
});
...
var Pagination = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime261.jsx)(PaginationRoot, { ref, total, ...others, children: (0, import_jsx_runtime261.jsxs)(Group, { gap, children: [
    withEdges && (0, import_jsx_runtime261.jsx)(PaginationFirst, { icon: firstIcon, ...getControlProps == null ? void 0 : getControlProps("first") }),
    withControls && (0, import_jsx_runtime261.jsx)(PaginationPrevious, { icon: previousIcon, ...getControlProps == null ? void 0 : getControlProps("previous") }),
    (0, import_jsx_runtime261.jsx)(PaginationItems, { dotsIcon }),
    withControls && (0, import_jsx_runtime261.jsx)(PaginationNext, { icon: nextIcon, ...getControlProps == null ? void 0 : getControlProps("next") }),
    withEdges && (0, import_jsx_runtime261.jsx)(PaginationLast, { icon: lastIcon, ...getControlProps == null ? void 0 : getControlProps("last") })
  ] }) });
});
...
var PasswordToggleIcon = ({
  ...
  "svg",
  {
    ...
    children: (0, import_jsx_runtime262.jsx)(
      "path",
      {
...
var varsResolver64 = createVarsResolver((_, { size: size2 }) => ({
  root: {
...
var PasswordInput = factory((_props, ref) => {
  ...
  const visibilityToggleButton = (0, import_jsx_runtime263.jsx)(
    ActionIcon,
    {
      ...
      children: (0, import_jsx_runtime263.jsx)(VisibilityToggleIcon, { reveal: _visible })
    }
  );
...
function createPinArray(length, value) {
  ...
  if (value) {
    ...
    for (let i2 = 0; i2 < Math.min(length, splitted.length); i2 += 1) {
      values2[i2] = splitted[i2] === " " ? "" : splitted[i2];
    }
  }
  return values2;
}
...
var varsResolver65 = createVarsResolver((_, { size: size2 }) => ({
  root: {
    "--pin-input-size": getSize(size2 ?? defaultProps142.size, "pin-input-size")
  }
}));
var PinInput = factory((props, ref) => {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react352.useState)(-1);
  ...
  const inputsRef = (0, import_react352.useRef)([]);
  const validate = (code) => {
  ...
  return (0, import_jsx_runtime264.jsxs)(import_jsx_runtime264.Fragment, { children: [
    (0, import_jsx_runtime264.jsx)(
      Group,
      {
        ...
        __size: size2,
        dir: "ltr",
        children: _value.map((char, index3) => (0, import_react352.createElement)(
          Input,
          {
            component: "input",
            ...getStyles2("pinInput", {
            ...
            "aria-label": ariaLabel,
            readOnly,
            ...getInputProps == null ? void 0 : getInputProps(index3)
          }
        ))
      }
    ),
    (0, import_jsx_runtime264.jsx)("input", { type: "hidden", name, form, value: _valueToString, ...hiddenInputProps })
  ] });
});
...
var ProgressRoot = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime267.jsx)(ProgressProvider, { value: { getStyles: getStyles2, autoContrast }, children: (0, import_jsx_runtime267.jsx)(Box, { ref, ...getStyles2("root"), ...others }) });
});
...
var RadioCard = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime272.jsx)(RadioCardProvider, { value: { checked: _checked }, children: (0, import_jsx_runtime272.jsx)(
    UnstyledButton,
    {
      ref,
...
var RadioGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size2, wrapperProps, children, name, readOnly, ...others } = useProps("RadioGroup", defaultProps148, props);
  ...
  return (0, import_jsx_runtime273.jsx)(RadioGroupProvider, { value: { value: _value, onChange: handleChange, size: size2, name: _name }, children: (0, import_jsx_runtime273.jsx)(
    Input.Wrapper,
    {
      size: size2,
      ref,
      ...
      children: (0, import_jsx_runtime273.jsx)(InputsGroupFieldset, { role: "radiogroup", children })
    }
  ) });
});
...
function RadioIcon({ size: size2, style, ...others }) {
  return (0, import_jsx_runtime274.jsx)(
    "svg",
    {
      ...
      "aria-hidden": true,
      ...others,
      children: (0, import_jsx_runtime274.jsx)("circle", { cx: "2.5", cy: "2.5", r: "2.5", fill: "currentColor" })
    }
  );
}
...
var RadioIndicator = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime275.jsx)(
    Box,
    {
      ...
      mod: [{ checked: _checked, disabled }, mod],
      ...others,
      children: (0, import_jsx_runtime275.jsx)(Icon, { ...getStyles2("icon") })
    }
  );
});
...
var Radio = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime276.jsx)(
    InlineInput,
    {
      ...
      ...styleProps,
      ...wrapperProps,
      children: (0, import_jsx_runtime276.jsxs)(Box, { ...getStyles2("inner"), mod: { "label-position": labelPosition }, children: [
        ...
        (0, import_jsx_runtime276.jsx)(Icon, { ...getStyles2("icon"), "aria-hidden": true })
      ] })
    }
  );
});
...
function StarIcon(props) {
  ...
  return (0, import_jsx_runtime278.jsx)(
    "svg",
    {
      ...
      ...others,
      children: (0, import_jsx_runtime278.jsx)("path", { d: "M12 17.75l-6.172 3.245l1.179 -6.873l-5 -4.867l6.9 -1l3.086 -6.253l3.086 6.253l6.9 1l-5 4.867l1.179 6.873z" })
    }
  );
}
...
function StarSymbol({ type }) {
  ...
  return (0, import_jsx_runtime279.jsx)(StarIcon, { ...ctx.getStyles("starSymbol"), "data-filled": type === "full" || void 0 });
}
...
function RatingItem({
  ...
  const { dir } = useDirection();
  return (0, import_jsx_runtime280.jsxs)(import_jsx_runtime280.Fragment, { children: [
    !readOnly && (0, import_jsx_runtime280.jsx)(
      "input",
      {
        ...ctx.getStyles("input"),
      ...
      Box,
      {
        ...
        children: (0, import_jsx_runtime280.jsx)(
          Box,
          {
            ...
            children: full ? _fullIcon || (0, import_jsx_runtime280.jsx)(StarSymbol, { type: "full" }) : _emptyIcon || (0, import_jsx_runtime280.jsx)(StarSymbol, { type: "empty" })
          }
        )
      }
    )
...
var varsResolver70 = createVarsResolver((theme, { size: size2, color }) => ({
  root: {
...
var Rating = factory((_props, ref) => {
  ...
  const [hovered, setHovered] = (0, import_react367.useState)(-1);
  const [isOutside, setOutside] = (0, import_react367.useState)(true);
  ...
  return (0, import_jsx_runtime281.jsx)(RatingProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime281.jsx)(
    Box,
    {
...
function useFloatingTooltip({
  ...
  const [opened, setOpened] = (0, import_react368.useState)(defaultOpened);
  const boundaryRef = (0, import_react368.useRef)(null);
  ...
  const handleMouseMove = (0, import_react368.useCallback)(
    ({ clientX, clientY }) => {
...
var TooltipFloating = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime282.jsxs)(import_jsx_runtime282.Fragment, { children: [
    (0, import_jsx_runtime282.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: (0, import_jsx_runtime282.jsx)(
      Box,
      {
        ...others,
        ...getStyles2("tooltip", {
    ...
    (0, import_react370.cloneElement)(children, {
      ..._childrenProps,
      [refProp]: targetRef,
      onMouseEnter,
      onMouseLeave
...
var TooltipGroupContext = (0, import_react371.createContext)(false);
var TooltipGroupProvider = TooltipGroupContext.Provider;
var useTooltipGroupContext = () => (0, import_react371.useContext)(TooltipGroupContext);
...
function TooltipGroup(props) {
  ...
  return (0, import_jsx_runtime283.jsx)(TooltipGroupProvider, { value: true, children: (0, import_jsx_runtime283.jsx)(FloatingDelayGroup, { delay: { open: openDelay, close: closeDelay }, children }) });
}
...
function useTooltip(settings) {
  var _a, _b, _c;
  const [uncontrolledOpened, setUncontrolledOpened] = (0, import_react374.useState)(settings.defaultOpened);
  const controlled = typeof settings.opened === "boolean";
  const opened = controlled ? settings.opened : uncontrolledOpened;
  const withinGroup = useTooltipGroupContext();
  const uid = useId();
  const { delay: groupDelay, currentId, setCurrentId } = useDelayGroupContext();
  const onChange = (0, import_react374.useCallback)(
    (_opened) => {
...
var Tooltip = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const arrowRef = (0, import_react376.useRef)(null);
  ...
  return (0, import_jsx_runtime284.jsxs)(import_jsx_runtime284.Fragment, { children: [
    (0, import_jsx_runtime284.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: (0, import_jsx_runtime284.jsx)(
      Transition,
      {
        ...transition,
        keepMounted,
        ...
        children: (transitionStyles) => (0, import_jsx_runtime284.jsxs)(
          Box,
          {
            ...others,
    ...
    (0, import_react376.cloneElement)(
      children,
...
function Curve({
  ...
  const theme = useMantineTheme();
  return (0, import_jsx_runtime285.jsx)(Tooltip.Floating, { disabled: !tooltip, label: tooltip, children: (0, import_jsx_runtime285.jsx)(
    Box,
    {
      component: "circle",
      ...others,
...
function getCurves({
  ...
  for (let i2 = 0; i2 < sections.length; i2 += 1) {
    curves.push({ sum, offset: offset2, data: sections[i2], root: false });
    offset2 -= sections[i2].value / 100 * accumulated;
  }
  ...
  if (curves.length > 2) {
    ...
    for (let i2 = 1; i2 <= curves.length - 3; i2 += 1) {
      curvesInOrder.push({ ...curves[i2], lineRoundCaps: false });
    }
  } else {
    curvesInOrder.push({ ...curves[0], lineRoundCaps: renderRoundedLineCaps });
  }
...
var RingProgress = factory((_props, ref) => {
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset2 }, index3) => (0, import_react379.createElement)(
    Curve,
    {
      ...data,
      key: index3,
  ...
  return (0, import_jsx_runtime286.jsxs)(Box, { ...getStyles2("root"), size: size2, ref, ...others, children: [
    (0, import_jsx_runtime286.jsx)("svg", { ...getStyles2("svg"), children: curves }),
    label && (0, import_jsx_runtime286.jsx)("div", { ...getStyles2("label"), children: label })
  ] });
});
...
var SegmentedControl = factory((_props, ref) => {
  ...
  const [parent, setParent] = (0, import_react380.useState)(null);
  const [refs, setRefs] = (0, import_react380.useState)({});
  ...
  const controls = _data.map((item) => (0, import_react380.createElement)(
    Box,
    {
      ...getStyles2("control"),
    ...
    (0, import_react380.createElement)(
      "input",
      {
        ...getStyles2("input"),
    ...
    (0, import_react380.createElement)(
      ...
      (0, import_jsx_runtime287.jsx)("span", { ...getStyles2("innerLabel"), children: item.label })
    )
  ));
  ...
  return (0, import_jsx_runtime287.jsxs)(
    Box,
    {
      ...getStyles2("root"),
      variant,
      ...
      children: [
        typeof _value === "string" && (0, import_jsx_runtime287.jsx)(
          FloatingIndicator,
          {
            target: refs[_value],
            parent,
...
var Select = factory((_props, ref) => {
  ...
  const parsedData = (0, import_react381.useMemo)(() => getParsedComboboxData(data), [data]);
  const optionsLockup = (0, import_react381.useMemo)(() => getOptionsLockup(parsedData), [parsedData]);
  const _id = useId(id);
  const [_value, setValue, controlled] = useUncontrolled({
    value,
    defaultValue,
  ...
  const clearButton = clearable && !!_value && !disabled && !readOnly && (0, import_jsx_runtime288.jsx)(
    Combobox.ClearButton,
    {
      size: size2,
      ...clearButtonProps,
  ...
  return (0, import_jsx_runtime288.jsxs)(import_jsx_runtime288.Fragment, { children: [
    (0, import_jsx_runtime288.jsxs)(
      Combobox,
      {
        store: combobox,
        ...
        ...comboboxProps,
        children: [
          (0, import_jsx_runtime288.jsx)(Combobox.Target, { targetType: searchable ? "input" : "button", autoComplete, children: (0, import_jsx_runtime288.jsx)(
            InputBase,
            {
              id: _id,
              ref,
              rightSection: rightSection || clearButton || (0, import_jsx_runtime288.jsx)(Combobox.Chevron, { size: size2, error, unstyled }),
              rightSectionPointerEvents: rightSectionPointerEvents || (clearButton ? "all" : "none"),
              ...others,
              size: size2,
              __staticSelector: "Select",
...
var SemiCircleProgress = factory((_props, ref) => {
  ...
  const coordinateForCircle = size2 / 2;
  const radius = (size2 - 2 * thickness) / 2;
  const circumference = Math.PI * radius;
  const semiCirclePercentage = clamp(value, 0, 100) * (circumference / 100);
  return (0, import_jsx_runtime289.jsxs)(Box, { ref, size: size2, ...getStyles2("root"), ...others, children: [
    label && (0, import_jsx_runtime289.jsx)("p", { ...getStyles2("label"), "data-position": labelPosition, "data-orientation": orientation, children: label }),
    (0, import_jsx_runtime289.jsxs)("svg", { width: size2, height: size2 / 2, ...getStyles2("svg"), children: [
...
function SimpleGridMediaVariables({
  ...
  return (0, import_jsx_runtime290.jsx)(InlineStyles, { styles: baseStyles, media, selector });
}
...
function SimpleGridContainerVariables({
  ...
  return (0, import_jsx_runtime290.jsx)(InlineStyles, { styles: baseStyles, container: media, selector });
}
...
var SimpleGrid = factory((_props, ref) => {
  ...
  if (type === "container") {
    return (0, import_jsx_runtime291.jsxs)(import_jsx_runtime291.Fragment, { children: [
      (0, import_jsx_runtime291.jsx)(SimpleGridContainerVariables, { ...props, selector: `.${responsiveClassName}` }),
      (0, import_jsx_runtime291.jsx)("div", { ...getStyles2("container"), children: (0, import_jsx_runtime291.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others }) })
    ] });
  }
  return (0, import_jsx_runtime291.jsxs)(import_jsx_runtime291.Fragment, { children: [
    (0, import_jsx_runtime291.jsx)(SimpleGridMediaVariables, { ...props, selector: `.${responsiveClassName}` }),
    (0, import_jsx_runtime291.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others })
  ] });
});
...
var Skeleton = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime292.jsx)(Box, { ref, ...getStyles2("root"), mod: [{ visible: visible2, animate }, mod], ...others });
});
...
var SliderRoot = (0, import_react387.forwardRef)(
...
var Thumb3 = (0, import_react388.forwardRef)(
  ({
    max,
    min,
    value,
    ...
    const { getStyles: getStyles2 } = useSliderContext();
    const [focused, setFocused] = (0, import_react388.useState)(false);
        ...
        children: [
          ...
          (0, import_jsx_runtime295.jsx)(
            Transition,
            {
              ...
              duration: 0,
              ...labelTransitionProps,
              children: (transitionStyles) => (0, import_jsx_runtime295.jsx)("div", { ...getStyles2("label", { style: transitionStyles }), children: label })
            }
          )
        ]
      }
...
function Marks({ marks, min, max, disabled, value, offset: offset2, inverted }) {
  ...
  const items = marks.map((mark, index3) => (0, import_react389.createElement)(
    Box,
    {
    ...
    mark.label && (0, import_jsx_runtime296.jsx)("div", { ...getStyles2("markLabel"), children: mark.label })
  ));
  return (0, import_jsx_runtime296.jsx)("div", { children: items });
}
...
function Track({
  ...
  const { getStyles: getStyles2 } = useSliderContext();
  return (0, import_jsx_runtime297.jsx)(Box, { ...getStyles2("trackContainer"), mod: { disabled }, ...containerProps, children: (0, import_jsx_runtime297.jsxs)(Box, { ...getStyles2("track"), mod: { inverted, disabled }, children: [
    ...
    children,
    (0, import_jsx_runtime297.jsx)(Marks, { ...others, offset: marksOffset, disabled, inverted })
  ] }) });
}
...
var Slider = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const [hovered, setHovered] = (0, import_react391.useState)(false);
  const [_value, setValue] = useUncontrolled({
  ...
  const valueRef = (0, import_react391.useRef)(_value);
  const root = (0, import_react391.useRef)(null);
  const thumb = (0, import_react391.useRef)(null);
  const position = getPosition({ value: _value, min, max });
  const scaledValue = scale(_value);
  const _label = typeof label === "function" ? label(scaledValue) : label;
  const precision = _precision ?? getPrecision(step);
  const handleChange = (0, import_react391.useCallback)(
    ({ x }) => {
      if (!disabled) {
  ...
  const handleTrackKeydownCapture = (event) => {
    ...
    if (!disabled) {
      switch (event.key) {
        ...
        case "Home": {
          event.preventDefault();
          (_e2 = thumb.current) == null ? void 0 : _e2.focus();
          if (restrictToMarks && marks) {
  ...
  return (0, import_jsx_runtime298.jsx)(SliderProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime298.jsxs)(
    SliderRoot,
    {
      ...others,
      ...
      children: [
        (0, import_jsx_runtime298.jsx)(
          Track,
          {
            ...
            children: (0, import_jsx_runtime298.jsx)(
              Thumb3,
              {
                max,
                min,
        ...
        (0, import_jsx_runtime298.jsx)("input", { type: "hidden", name, value: scaledValue, ...hiddenInputProps })
      ]
    }
  ) });
});
...
var RangeSlider = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const [focused, setFocused] = (0, import_react392.useState)(-1);
  const [hovered, setHovered] = (0, import_react392.useState)(false);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: [min, max],
  ...
  const valueRef = (0, import_react392.useRef)(_value);
  const thumbs = (0, import_react392.useRef)([]);
  const thumbIndex = (0, import_react392.useRef)(void 0);
  const positions = [
  ...
  return (0, import_jsx_runtime299.jsx)(SliderProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime299.jsxs)(SliderRoot, { ...others, size: size2, ref, disabled, children: [
    ...
    (0, import_jsx_runtime299.jsx)("input", { type: "hidden", name: `${name}_from`, value: _value[0], ...hiddenInputProps }),
    (0, import_jsx_runtime299.jsx)("input", { type: "hidden", name: `${name}_to`, value: _value[1], ...hiddenInputProps })
  ] }) });
});
...
var Space = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime300.jsx)(Box, { ref, ...others, w, miw: miw ?? w, h, mih: mih ?? h });
});
...
var Spoiler = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime301.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        spoiler && (0, import_jsx_runtime301.jsx)(
          Anchor,
          {
            component: "button",
            type: "button",
        ...
        (0, import_jsx_runtime301.jsx)(
          "div",
          {
            ...
            role: "region",
            id: regionId,
            children: (0, import_jsx_runtime301.jsx)("div", { ref: contentRef, children })
          }
        )
      ]
    }
...
var Stack = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime302.jsx)(Box, { ref, ...getStyles2("root"), variant, ...others });
});
...
var getStepFragment = (Fragment29, step) => {
  if (typeof Fragment29 === "function") {
    return (0, import_jsx_runtime304.jsx)(Fragment29, { step: step || 0 });
  }
  return Fragment29;
};
var defaultProps166 = {
...
var StepperStep = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime304.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        withIcon && (0, import_jsx_runtime304.jsxs)("span", { ...ctx.getStyles("stepWrapper", stylesApi), children: [
          (0, import_jsx_runtime304.jsxs)("span", { ...ctx.getStyles("stepIcon", stylesApi), ...dataAttributes, children: [
            (0, import_jsx_runtime304.jsx)(Transition, { mounted: state === "stepCompleted", transition: "pop", duration: 200, children: (transitionStyles) => (0, import_jsx_runtime304.jsx)(
              "span",
              {
                ...ctx.getStyles("stepCompletedIcon", { style: transitionStyles, ...stylesApi }),
                children: loading ? (0, import_jsx_runtime304.jsx)(
                  Loader,
                  {
                    color: "var(--mantine-color-white)",
                ...
                ) : getStepFragment(completedIcon, step) || (0, import_jsx_runtime304.jsx)(CheckIcon, { size: "60%" })
              }
            ) }),
            state !== "stepCompleted" ? loading ? (0, import_jsx_runtime304.jsx)(
              Loader,
              {
                ...ctx.getStyles("stepLoader", stylesApi),
                size: "calc(var(--stepper-icon-size) / 2)",
          ...
          orientation === "vertical" && (0, import_jsx_runtime304.jsx)(
            "span",
            {
        ...
        (label || description) && (0, import_jsx_runtime304.jsxs)(
          "span",
          {
            ...
            children: [
              label && (0, import_jsx_runtime304.jsx)("span", { ...ctx.getStyles("stepLabel", stylesApi), children: getStepFragment(label, step) }),
              description && (0, import_jsx_runtime304.jsx)("span", { ...ctx.getStyles("stepDescription", stylesApi), children: getStepFragment(description, step) })
            ]
          }
        )
      ]
...
var Stepper = factory((_props, ref) => {
  ...
  const convertedChildren = import_react398.Children.toArray(children);
  ...
  const items = _children.reduce(
    (acc, item, index3) => {
      ...
      acc.push(
        (0, import_react398.cloneElement)(item, {
      ...
      if (orientation === "horizontal" && index3 !== _children.length - 1) {
        acc.push(
          (0, import_react398.createElement)(
            "div",
            {
  ...
  return (0, import_jsx_runtime305.jsx)(StepperProvider, { value: { getStyles: getStyles2, orientation, iconPosition }, children: (0, import_jsx_runtime305.jsxs)(Box, { ...getStyles2("root"), ref, size: size2, ...others, children: [
    (0, import_jsx_runtime305.jsx)(
      Box,
      {
        ...getStyles2("steps"),
        mod: {
    ...
    content && (0, import_jsx_runtime305.jsx)("div", { ...getStyles2("content"), children: content })
  ] }) });
});
...
var SwitchGroupContext = (0, import_react399.createContext)(null);
var SwitchGroupProvider = SwitchGroupContext.Provider;
var useSwitchGroupContext = () => (0, import_react399.useContext)(SwitchGroupContext);
...
var SwitchGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size2, wrapperProps, children, readOnly, ...others } = useProps("SwitchGroup", defaultProps168, props);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: [],
  ...
  return (0, import_jsx_runtime306.jsx)(SwitchGroupProvider, { value: { value: _value, onChange: handleChange, size: size2 }, children: (0, import_jsx_runtime306.jsx)(
    Input.Wrapper,
    {
      size: size2,
      ref,
      ...
      children: (0, import_jsx_runtime306.jsx)(InputsGroupFieldset, { role: "group", children })
    }
  ) });
});
...
var varsResolver82 = createVarsResolver((theme, { radius, color, size: size2 }) => ({
  root: {
...
var Switch = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime307.jsxs)(
    InlineInput,
    {
      ...getStyles2("root"),
      ...
      children: [
        ...
        (0, import_jsx_runtime307.jsxs)(
          Box,
          {
            ...
            ...getStyles2("track"),
            children: [
              (0, import_jsx_runtime307.jsx)(Box, { component: "span", mod: "reduce-motion", ...getStyles2("thumb"), children: thumbIcon }),
              (0, import_jsx_runtime307.jsx)("span", { ...getStyles2("trackLabel"), children: _checked ? onLabel : offLabel })
            ]
          }
        )
      ]
...
function TableDataRenderer({ data }) {
  return (0, import_jsx_runtime310.jsxs)(import_jsx_runtime310.Fragment, { children: [
    data.caption && (0, import_jsx_runtime310.jsx)(TableCaption, { children: data.caption }),
    data.head && (0, import_jsx_runtime310.jsx)(TableThead, { children: (0, import_jsx_runtime310.jsx)(TableTr, { children: data.head.map((item, index3) => (0, import_jsx_runtime310.jsx)(TableTh, { children: item }, index3)) }) }),
    data.body && (0, import_jsx_runtime310.jsx)(TableTbody, { children: data.body.map((row, rowIndex) => (0, import_jsx_runtime310.jsx)(TableTr, { children: row.map((item, index3) => (0, import_jsx_runtime310.jsx)(TableTd, { children: item }, index3)) }, rowIndex)) }),
    data.foot && (0, import_jsx_runtime310.jsx)(TableTfoot, { children: (0, import_jsx_runtime310.jsx)(TableTr, { children: data.foot.map((item, index3) => (0, import_jsx_runtime310.jsx)(TableTh, { children: item }, index3)) }) })
  ] });
}
...
var TableScrollContainer = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime311.jsx)(
    Box,
    {
      ...
      ...others,
      children: (0, import_jsx_runtime311.jsx)("div", { ...getStyles2("scrollContainerInner"), children })
    }
  );
});
...
var Table = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime312.jsx)(
    TableProvider,
    {
      ...
      children: (0, import_jsx_runtime312.jsx)(
        Box,
        {
          component: "table",
          variant,
          ...
          ...getStyles2("table"),
          ...others,
          children: children || !!data && (0, import_jsx_runtime312.jsx)(TableDataRenderer, { data })
        }
      )
    }
  );
...
var TabsTab = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime316.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        leftSection && (0, import_jsx_runtime316.jsx)("span", { ...ctx.getStyles("tabSection", stylesApiProps), "data-position": "left", children: leftSection }),
        children && (0, import_jsx_runtime316.jsx)("span", { ...ctx.getStyles("tabLabel", stylesApiProps), children }),
        rightSection && (0, import_jsx_runtime316.jsx)("span", { ...ctx.getStyles("tabSection", stylesApiProps), "data-position": "right", children: rightSection })
      ]
    }
  );
});
...
var Tabs = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime317.jsx)(
    TabsProvider,
    {
      ...
      children: (0, import_jsx_runtime317.jsx)(
        Box,
        {
          ref,
          id: uid,
...
var TagsInput = factory((_props, ref) => {
  ...
  const parsedData = getParsedComboboxData(data);
  const optionsLockup = getOptionsLockup(parsedData);
  const inputRef = (0, import_react412.useRef)(null);
  ...
  const values2 = _value.map((item, index3) => (0, import_jsx_runtime319.jsx)(
    Pill,
    {
  ...
  (0, import_react412.useEffect)(() => {
    if (selectFirstOptionOnChange) {
      combobox.selectFirstOption();
    }
  }, [selectFirstOptionOnChange, _value, _searchValue]);
  const clearButton = clearable && _value.length > 0 && !disabled && !readOnly && (0, import_jsx_runtime319.jsx)(
    Combobox.ClearButton,
    {
      size: size2,
      ...clearButtonProps,
  ...
  return (0, import_jsx_runtime319.jsxs)(import_jsx_runtime319.Fragment, { children: [
    (0, import_jsx_runtime319.jsxs)(
      Combobox,
      {
        store: combobox,
        classNames: resolvedClassNames,
        ...
        ...comboboxProps,
        children: [
          (0, import_jsx_runtime319.jsx)(Combobox.DropdownTarget, { children: (0, import_jsx_runtime319.jsx)(
            PillsInput,
            {
              ...styleProps,
              __staticSelector: "TagsInput",
              ...
              id: _id,
              mod,
              children: (0, import_jsx_runtime319.jsxs)(Pill.Group, { disabled, unstyled, ...getStyles2("pillsList"), children: [
                values2,
                (0, import_jsx_runtime319.jsx)(Combobox.EventsTarget, { autoComplete, children: (0, import_jsx_runtime319.jsx)(
                  PillsInput.Field,
                  {
                    ...rest,
                    ref: _ref,
...
var TextInput = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime320.jsx)(InputBase, { component: "input", ref, ..._props, __staticSelector: "TextInput" });
});
...
var ThemeIcon = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime321.jsx)(Box, { ref, ...getStyles2("root"), ...others });
});
...
var TimelineItem = factory((_props, ref) => {
  ...
  const theme = useMantineTheme();
  const stylesApiProps = { classNames, styles };
  return (0, import_jsx_runtime323.jsxs)(
    Box,
    {
      ...ctx.getStyles("item", { ...stylesApiProps, className, style }),
      ...
      children: [
        ...
        (0, import_jsx_runtime323.jsxs)("div", { ...ctx.getStyles("itemBody", stylesApiProps), children: [
          title && (0, import_jsx_runtime323.jsx)("div", { ...ctx.getStyles("itemTitle", stylesApiProps), children: title }),
          (0, import_jsx_runtime323.jsx)("div", { ...ctx.getStyles("itemContent", stylesApiProps), children })
        ] })
      ]
    }
  );
...
var Timeline = factory((_props, ref) => {
  ...
  const _children = import_react417.Children.toArray(children);
  const items = _children.map(
    (item, index3) => {
      var _a, _b;
      return (0, import_react417.cloneElement)(item, {
        unstyled,
        __align: align,
  ...
  return (0, import_jsx_runtime324.jsx)(TimelineProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime324.jsx)(Box, { ...getStyles2("root"), mod: [{ align }, mod], ref, ...others, children: items }) });
});
...
var varsResolver88 = createVarsResolver((_, { order, size: size2, lineClamp, textWrap }) => {
...
function TreeNode({
  ...
  const ref = (0, import_react420.useRef)(null);
  const nested = (node.children || []).map((child) => (0, import_jsx_runtime327.jsx)(
    TreeNode,
    {
      node: child,
      flatValues,
  ...
  return (0, import_jsx_runtime327.jsxs)(
    "li",
    {
      ...getStyles2("node", {
      ...
      children: [
        typeof renderNode === "function" ? renderNode({
          ...
          elementProps
        }) : (0, import_jsx_runtime327.jsx)("div", { ...elementProps, children: node.label }),
        controller.expandedState[node.value] && nested.length > 0 && (0, import_jsx_runtime327.jsx)("ul", { role: "group", ...getStyles2("subtree"), "data-level": level, children: nested })
      ]
    }
  );
}
...
function useTree({
  ...
  const [data, setData] = (0, import_react423.useState)([]);
  const [expandedState, setExpandedState] = (0, import_react423.useState)(initialExpandedState);
  const [selectedState, setSelectedState] = (0, import_react423.useState)(initialSelectedState);
  const [checkedState, setCheckedState] = (0, import_react423.useState)(initialCheckedState);
  const [anchorNode, setAnchorNode] = (0, import_react423.useState)(null);
  const [hoveredNode, setHoveredNode] = (0, import_react423.useState)(null);
  const initialize = (0, import_react423.useCallback)(
    (_data) => {
  ...
  const toggleExpanded = (0, import_react423.useCallback)(
    (value) => {
  ...
  const collapse = (0, import_react423.useCallback)(
    (value) => {
      setExpandedState((current) => {
  ...
  const expand = (0, import_react423.useCallback)(
    (value) => {
      setExpandedState((current) => {
  ...
  const expandAllNodes = (0, import_react423.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
  ...
  const collapseAllNodes = (0, import_react423.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
      Object.keys(next).forEach((key) => {
        next[key] = false;
  ...
  const toggleSelected = (0, import_react423.useCallback)(
  ...
  const select = (0, import_react423.useCallback)((value) => {
    setAnchorNode(value);
    setSelectedState(
      (current) => multiple ? current.includes(value) ? current : [...current, value] : [value]
    );
  }, []);
  const deselect = (0, import_react423.useCallback)((value) => {
    anchorNode === value && setAnchorNode(null);
    setSelectedState((current) => current.filter((item) => item !== value));
  }, []);
  const clearSelected = (0, import_react423.useCallback)(() => {
    setSelectedState([]);
    setAnchorNode(null);
  }, []);
  const checkNode = (0, import_react423.useCallback)(
    (value) => {
  ...
  const uncheckNode = (0, import_react423.useCallback)(
    (value) => {
      const checkedNodes = getChildrenNodesValues(value, data);
  ...
  const checkAllNodes = (0, import_react423.useCallback)(() => {
    setCheckedState(() => getAllChildrenNodes(data));
  }, [data]);
  const uncheckAllNodes = (0, import_react423.useCallback)(() => {
    setCheckedState([]);
  }, []);
...
var Tree = factory((_props, ref) => {
  ...
  const flatValues = (0, import_react424.useMemo)(() => getFlatValues(data), [data]);
  (0, import_react424.useEffect)(() => {
    controller.initialize(data);
  }, [data]);
  const nodes = data.map((node, index3) => (0, import_jsx_runtime330.jsx)(
    TreeNode,
    {
      node,
      getStyles: getStyles2,
  ...
  return (0, import_jsx_runtime330.jsx)(
    Box,
    {
      component: "ul",
      ref: mergedRef,
...
var TypographyStylesProvider = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime331.jsx)(Box, { ref, ...getStyles2("root"), ...others });
});
...
var be = (e) => G2(fe, e, true);
var pe = (0, import_react427.forwardRef)((e, n) => {
  const {
    className: t,
    name: o,
    label: r,
  ...
  return qa(h), (0, import_jsx_runtime332.jsx)(
    TextInput,
    {
      size: "xs",
      className: t,
...
var R = import_react427.default.createContext && import_react427.default.createContext(H);
var ve = ["attr", "size", "title"];
function he(e, n) {
  if (e == null) return {};
  var t = ye(e, n), o, r;
...
function P(e) {
  for (var n = 1; n < arguments.length; n++) {
    ...
    n % 2 ? I(Object(t), true).forEach(function(o) {
      Se(e, o, t[o]);
...
function Se(e, n, t) {
  return n = xe(n), n in e ? Object.defineProperty(e, n, { value: t, enumerable: true, configurable: true, writable: true }) : e[n] = t, e;
}
function xe(e) {
  var n = we(e, "string");
...
function K(e) {
  return e && e.map((n, t) => import_react427.default.createElement(n.tag, P({
    key: t
  }, n.attr), K(n.child)));
}
function U(e) {
  return (n) => import_react427.default.createElement(Ne, k({
    attr: P({}, e.attr)
  }, n), K(e.child));
}
function Ne(e) {
  var n = (t) => {
    ...
    return t.className && (c = t.className), e.className && (c = (c ? c + " " : "") + e.className), import_react427.default.createElement("svg", k({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, t.attr, o, l, {
      ...
      width: a,
      xmlns: "http://www.w3.org/2000/svg"
    }), s && import_react427.default.createElement("title", null, s), e.children);
  };
  return R !== void 0 ? import_react427.default.createElement(R.Consumer, null, (t) => n(t)) : n(H);
}
function Ce(e) {
...
var W = (0, import_react427.createContext)(void 0);
var Pe = (0, import_react427.forwardRef)((e, n) => {
  const {
    children: t,
    onOpenChange: o,
  ...
  qa(l);
  const [a, c] = (0, import_react427.useState)(false), u = (0, import_react427.useRef)(null), f = (0, import_react427.useRef)(), v = (0, import_react427.useCallback)(() => {
    f.current && clearTimeout(f.current), f.current = setTimeout(() => {
      c(false);
    }, 250);
  }, []), h = (0, import_react427.useCallback)(() => {
    f.current && clearTimeout(f.current), c(true);
  }, []);
  return (0, import_jsx_runtime332.jsx)(
    W.Provider,
    {
      ...
      children: (0, import_jsx_runtime332.jsx)(
        Menu.Item,
        {
...
var Te = (e) => {
  ...
  return qa(s), r ? (0, import_jsx_runtime332.jsx)(Pe, { ...e }) : (0, import_jsx_runtime332.jsx)(
    Menu,
    {
      withinPortal: false,
      middlewares: { flip: true, shift: true, inline: false, size: true },
...
var Me = (0, import_react427.forwardRef)((e, n) => {
  const { className: t, children: o, icon: r, checked: s, subTrigger: l, onClick: a, ...c } = e;
  return qa(c, false), l ? (0, import_jsx_runtime332.jsxs)(
    "div",
    {
      onClick: (u) => {
      ...
      children: [
        o,
        (0, import_jsx_runtime332.jsx)(ke, { size: 15 })
      ]
    }
  ) : (0, import_jsx_runtime332.jsx)(
    Menu.Item,
    {
      className: t,
      ref: n,
      leftSection: r,
      rightSection: s ? (0, import_jsx_runtime332.jsx)(CheckIcon, { size: 10 }) : s === false ? (0, import_jsx_runtime332.jsx)("div", { className: "bn-tick-space" }) : null,
      onClick: a,
      ...c,
      children: o
    }
...
var Fe = (e) => {
  ...
  return qa(o), (0, import_jsx_runtime332.jsx)(Menu.Target, { children: n });
};
var Oe = (0, import_react427.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    sub: r,
  ...
  qa(s);
  const l = (0, import_react427.useContext)(W);
  return (0, import_jsx_runtime332.jsx)(
    Menu.Dropdown,
    {
      className: t,
...
var De = (0, import_react427.forwardRef)((e, n) => {
  const { className: t, ...o } = e;
  return qa(o), (0, import_jsx_runtime332.jsx)(Menu.Divider, { className: t, ref: n });
});
var Re = (0, import_react427.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return qa(r), (0, import_jsx_runtime332.jsx)(Menu.Label, { className: t, ref: n, children: o });
});
var Ie = (0, import_react427.forwardRef)((e, n) => {
  const {
    className: t,
    tabs: o,
    defaultOpenTab: r,
  ...
  return qa(c), (0, import_jsx_runtime332.jsx)(Group, { className: t, ref: n, children: (0, import_jsx_runtime332.jsxs)(
    Tabs,
    {
      value: s,
      defaultValue: r,
      onChange: l,
      children: [
        a && (0, import_jsx_runtime332.jsx)(LoadingOverlay, { visible: a }),
        (0, import_jsx_runtime332.jsx)(Tabs.List, { children: o.map((u) => (0, import_jsx_runtime332.jsx)(
          Tabs.Tab,
          {
        ...
        o.map((u) => (0, import_jsx_runtime332.jsx)(Tabs.Panel, { value: u.name, children: u.tabPanel }, u.name))
      ]
    }
  ) });
});
var Le = (0, import_react427.forwardRef)((e, n) => {
  const { className: t, children: o, onClick: r, label: s, ...l } = e;
  return qa(l), (0, import_jsx_runtime332.jsx)(
    Button,
    {
      size: "xs",
      "aria-label": s,
...
var Ee = (0, import_react427.forwardRef)((e, n) => {
  const { className: t, accept: o, value: r, placeholder: s, onChange: l, ...a } = e;
  return qa(a), (0, import_jsx_runtime332.jsx)(
    FileInput,
    {
      size: "xs",
      className: t,
...
var je = (0, import_react427.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return qa(r), (0, import_jsx_runtime332.jsx)("div", { className: t, ref: n, children: o });
});
var ze = (0, import_react427.forwardRef)((e, n) => {
...
var Be = (e) => {
  ...
  return qa(r), (0, import_jsx_runtime332.jsx)(Popover, { withinPortal: false, opened: t, position: o, children: n });
};
var _e = (e) => {
  const { children: n, ...t } = e;
  return qa(t), (0, import_jsx_runtime332.jsx)(PopoverTarget, { children: n });
};
var $e = (0, import_react427.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    variant: r,
  ...
  return qa(s), (0, import_jsx_runtime332.jsx)(PopoverDropdown, { className: t, ref: n, children: o });
});
var Ve = (0, import_react427.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return qa(r, false), (0, import_jsx_runtime332.jsx)(
    Group,
    {
      align: "center",
      gap: 0,
...
var Ae = (0, import_react427.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    icon: r,
  ...
  return qa(f, false), r ? (0, import_jsx_runtime332.jsx)(
    ActionIcon,
    {
      size: 24,
      className: t,
...
var Ge = (0, import_react427.forwardRef)((e, n) => {
...
var He = (0, import_react427.forwardRef)((e, n) => {
  const { className: t, children: o, columns: r, ...s } = e;
  return qa(s), (0, import_jsx_runtime332.jsx)(
    Group,
    {
      className: t,
      style: { gridColumn: `1 / ${r + 1}` },
      ref: n,
      children: (0, import_jsx_runtime332.jsx)(Group, { className: "bn-mt-suggestion-menu-item-title", children: o })
    }
  );
});
var Ke = (0, import_react427.forwardRef)((e, n) => {
  const { className: t, isSelected: o, onClick: r, item: s, id: l, ...a } = e;
  qa(a);
  const c = (0, import_react427.useRef)(null);
  return (0, import_react427.useEffect)(() => {
    if (!c.current || !o)
      return;
    const u = Sr(
      c.current,
    ...
    u === "top" ? c.current.scrollIntoView(true) : u === "bottom" && c.current.scrollIntoView(false);
  }, [o]), (0, import_jsx_runtime332.jsx)(
    "div",
    {
      className: t,
      ref: mergeRefs2(n, c),
...
var Ue = (0, import_react427.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
...
var We = (0, import_react427.forwardRef)((e, n) => {
...
var qe = (0, import_react427.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return qa(r), (0, import_jsx_runtime332.jsx)(Group, { className: t, ref: n, children: (0, import_jsx_runtime332.jsx)(Group, { className: "bn-mt-suggestion-menu-item-title", children: o }) });
});
var Ze = (0, import_react427.forwardRef)((e, n) => {
  const { className: t, isSelected: o, onClick: r, item: s, id: l, ...a } = e;
  qa(a);
  ...
  return (0, import_react427.useEffect)(() => {
    ...
    u === "top" ? c.current.scrollIntoView(true) : u === "bottom" && c.current.scrollIntoView(false);
  }, [o]), (0, import_jsx_runtime332.jsxs)(
    Group,
    {
      gap: 0,
      className: t,
      ...
      "aria-selected": o || void 0,
      children: [
        s.icon && (0, import_jsx_runtime332.jsx)(
          Group,
          {
        ...
        (0, import_jsx_runtime332.jsxs)(Stack, { gap: 0, className: "bn-mt-suggestion-menu-item-body", children: [
          (0, import_jsx_runtime332.jsx)(Text, { className: "bn-mt-suggestion-menu-item-title", children: s.title }),
          (0, import_jsx_runtime332.jsx)(Text, { className: "bn-mt-suggestion-menu-item-subtitle", children: s.subtext })
        ] }),
        s.badge && (0, import_jsx_runtime332.jsx)(
          Group,
          {
            "data-position": "right",
            className: "bn-mt-suggestion-menu-item-section",
            children: (0, import_jsx_runtime332.jsx)(Badge, { size: "xs", children: s.badge })
          }
        )
      ]
    }
...
var Je = (0, import_react427.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return qa(r), (0, import_jsx_runtime332.jsx)(Group, { className: t, ref: n, children: o });
});
var Qe = (0, import_react427.forwardRef)((e, n) => {
  const {
    className: t,
  ...
  return qa(r), (0, import_jsx_runtime332.jsx)(Loader, { className: t, type: "dots", ref: n });
});
var Xe = (0, import_react427.forwardRef)((e, n) => {
  const { children: t, className: o, onMouseDown: r, onClick: s, ...l } = e;
  return qa(l, false), (0, import_jsx_runtime332.jsx)(
    Button,
    {
      className: o,
      ref: n,
...
var Ye = (0, import_react427.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    draggable: r,
  ...
  return qa(u, false), (0, import_jsx_runtime332.jsx)(
    Button,
    {
      className: t,
      ref: n,
...
var L = (0, import_react427.forwardRef)(
  (e, n) => {
    const { className: t, children: o, onMouseEnter: r, onMouseLeave: s, ...l } = e;
    qa(l);
    const { ref: a, focused: c } = useFocusWithin(), u = useFocusTrap(c), f = mergeRefs2(n, a, u);
    return (0, import_jsx_runtime332.jsx)(
      Group,
      {
        className: t,
...
var et = (e) => (0, import_jsx_runtime332.jsxs)(Stack, { gap: 0, className: "bn-tooltip", children: [
  (0, import_jsx_runtime332.jsx)(Text, { size: "sm", children: e.mainTooltip }),
  e.secondaryTooltip && (0, import_jsx_runtime332.jsx)(Text, { size: "xs", children: e.secondaryTooltip })
] });
var E2 = (0, import_react427.forwardRef)(
  (e, n) => {
    const {
      className: t,
      children: o,
    ...
    return qa(v, false), (0, import_jsx_runtime332.jsx)(
      Tooltip,
      {
        withinPortal: false,
        label: (0, import_jsx_runtime332.jsx)(
          et,
          {
            mainTooltip: r,
            secondaryTooltip: s
        ...
        children: o ? (0, import_jsx_runtime332.jsx)(
          Button,
          {
            "aria-label": f,
            className: t,
            onMouseDown: (h) => {
              Xa() && h.currentTarget.focus();
            },
            onClick: u,
            "aria-pressed": a,
...
var tt = (0, import_react427.forwardRef)((e, n) => {
  const { className: t, items: o, isDisabled: r, ...s } = e;
  qa(s);
  const l = o.filter((a) => a.isSelected)[0];
  return l ? (0, import_jsx_runtime332.jsxs)(
    Menu,
    {
      withinPortal: false,
      transitionProps: {
      ...
      middlewares: { flip: true, shift: true, inline: false, size: true },
      children: [
        (0, import_jsx_runtime332.jsx)(Menu.Target, { children: (0, import_jsx_runtime332.jsx)(
          Button,
          {
            onMouseDown: (a) => {
              Xa() && a.currentTarget.focus();
            },
            leftSection: l.icon,
            rightSection: (0, import_jsx_runtime332.jsx)(Ce, {}),
            size: "xs",
            variant: "subtle",
            disabled: r,
            children: l.text
        ...
        (0, import_jsx_runtime332.jsx)(Menu.Dropdown, { className: t, ref: n, children: o.map((a) => (0, import_jsx_runtime332.jsx)(
          Menu.Item,
          {
            onClick: a.onClick,
            leftSection: a.icon,
            rightSection: a.isSelected ? (0, import_jsx_runtime332.jsx)(CheckIcon, { size: 10, className: "bn-tick-icon" }) : (
              // Ensures space for tick even if item isn't currently selected.
              (0, import_jsx_runtime332.jsx)("div", { className: "bn-tick-space" })
            ),
...
var nt = {
  ...
  Generic: {
    Form: {
      Root: (e) => (0, import_jsx_runtime332.jsx)("div", { children: e.children }),
      TextInput: pe
    },
    Menu: {
      Root: Te,
...
var dt = (e) => {
  const { className: n, theme: t, ...o } = e, r = E(), s = Uo(), l = (r == null ? void 0 : r.colorSchemePreference) || s, a = (0, import_react427.useCallback)(
    (c) => {
  ...
  return (0, import_jsx_runtime332.jsx)(tn.Provider, { value: nt, children: (0, import_jsx_runtime332.jsx)(
    MantineProvider,
    {
      theme: ot,
