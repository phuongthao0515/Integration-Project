...
function useTransition({
  ...
  const shouldReduceMotion = useReducedMotion();
  const reduceMotion = theme.respectReducedMotion ? shouldReduceMotion : false;
  const [transitionDuration, setTransitionDuration] = (0, import_react134.useState)(reduceMotion ? 0 : duration);
  const [transitionStatus, setStatus] = (0, import_react134.useState)(mounted ? "entered" : "exited");
  const transitionTimeoutRef = (0, import_react134.useRef)(-1);
  const delayTimeoutRef = (0, import_react134.useRef)(-1);
  const rafRef = (0, import_react134.useRef)(-1);
...
var PopoverTarget = factory((props, ref) => {
  ...
  return (0, import_react137.cloneElement)(children, {
    ...forwardedProps,
    ...accessibleProps,
    ...ctx.targetProps,
...
function useFloatingAutoUpdate({
  ...
  const [delayedUpdate, setDelayedUpdate] = (0, import_react138.useState)(0);
...
function usePopover(options) {
  ...
  const previouslyOpened = (0, import_react140.useRef)(_opened);
  const onClose = () => {
    if (_opened) {
      setOpened(false);
    }
...
function Popover(_props) {
  ...
  const [targetNode, setTargetNode] = (0, import_react142.useState)(null);
  const [dropdownNode, setDropdownNode] = (0, import_react142.useState)(null);
  const { dir } = useDirection();
  const uid = useId(id);
  ...
  const reference = (0, import_react142.useCallback)(
    (node) => {
      setTargetNode(node);
  ...
  const floating = (0, import_react142.useCallback)(
    (node) => {
  ...
  const onEntered = (0, import_react142.useCallback)(() => {
    var _a2;
...
// node_modules/@mantine/core/esm/components/Loader/loaders/Bars.mjs
var Bars = (0, import_react144.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime65.jsxs)(Box, { component: "span", className: clsx_default(classes6.barsLoader, className), ...others, ref, children: [
...
var Dots = (0, import_react145.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime66.jsxs)(Box, { component: "span", className: clsx_default(classes6.dotsLoader, className), ...others, ref, children: [
...
var Oval = (0, import_react146.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime67.jsx)(Box, { component: "span", className: clsx_default(classes6.ovalLoader, className), ...others, ref }));
...
var ActionIconGroupSection = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime70.jsx)(Box, { ...getStyles2("groupSection"), ref, variant, ...others });
});
...
var ActionIcon = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime71.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        (0, import_jsx_runtime71.jsx)(Transition, { mounted: !!loading, transition: "slide-down", duration: 150, children: (transitionStyles) => (0, import_jsx_runtime71.jsx)(Box, { component: "span", ...getStyles2("loader", { style: transitionStyles }), "aria-hidden": true, children: (0, import_jsx_runtime71.jsx)(Loader, { color: "var(--ai-color)", size: "calc(var(--ai-size) * 0.55)", ...loaderProps }) }) }),
        (0, import_jsx_runtime71.jsx)(Box, { component: "span", mod: { loading }, ...getStyles2("icon"), children })
      ]
    }
  );
});
...
var CloseIcon = (0, import_react151.forwardRef)(
  ({ size: size2 = "var(--cb-icon-size, 70%)", style, ...others }, ref) => (0, import_jsx_runtime72.jsx)(
    "svg",
    {
      viewBox: "0 0 15 15",
      fill: "none",
...
var CloseButton = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime73.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        icon || (0, import_jsx_runtime73.jsx)(CloseIcon, {}),
        children
      ]
    }
  );
...
var Overlay = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime75.jsx)(Box, { ref, ...getStyles2("root"), mod: [{ center, fixed }, mod], ...others, children });
});
...
function useLockScroll({ opened, transitionDuration }) {
  ...
  const timeout = (0, import_react157.useRef)(-1);
...
var InputLabel = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime88.jsxs)(
    Box,
    {
      ...
      children: [
        children,
        required && (0, import_jsx_runtime88.jsx)("span", { ...getStyles2("required"), "aria-hidden": true, children: " *" })
      ]
    }
  );
});
...
var InputWrapper = factory((_props, ref) => {
  ...
  const _label = label && (0, import_jsx_runtime90.jsx)(
    InputLabel,
    {
      labelElement,
      id: labelId,
  ...
  const _description = hasDescription && (0, import_jsx_runtime90.jsx)(
    InputDescription,
    {
      ...descriptionProps,
      ...sharedProps,
  ...
  const _input = (0, import_jsx_runtime90.jsx)(import_react173.Fragment, { children: inputContainer(children) }, "input");
...
var Input = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime91.jsxs)(
    Box,
    {
      ...
      size: size2,
      children: [
        leftSection && (0, import_jsx_runtime91.jsx)(
          "div",
          {
            ...leftSectionProps,
            "data-position": "left",
        ...
        rightSection && (0, import_jsx_runtime91.jsx)(
          "div",
          {
            ...rightSectionProps,
            "data-position": "right",
...
var InputBase = polymorphicFactory((props, ref) => {
  ...
  return (0, import_jsx_runtime93.jsx)(Input.Wrapper, { ...wrapperProps, children: (0, import_jsx_runtime93.jsx)(Input, { ...inputProps, ...others, ref }) });
});
...
var Flex = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime94.jsxs)(import_jsx_runtime94.Fragment, { children: [
    parsedStyleProps.hasResponsiveStyles && (0, import_jsx_runtime94.jsx)(
      InlineStyles,
      {
        selector: `.${responsiveClassName}`,
        styles: parsedStyleProps.styles,
...
function useFloatingIndicator({
  ...
  const transitionTimeout = (0, import_react178.useRef)(-1);
  ...
  const targetResizeObserver = (0, import_react178.useRef)(null);
  const parentResizeObserver = (0, import_react178.useRef)(null);
...
var FloatingIndicator = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime96.jsx)(Box, { ref: mergedRef, mod: [{ initialized, hidden: hidden2 }, mod], ...getStyles2("root"), ...others });
});
...
var AccordionControl = factory((props, ref) => {
  ...
  const content = (0, import_jsx_runtime100.jsxs)(
    UnstyledButton,
    {
      ...others,
      ...
      children: [
        ...
        (0, import_jsx_runtime100.jsx)("span", { ...ctx.getStyles("label", { classNames, styles }), children }),
        icon && (0, import_jsx_runtime100.jsx)(
          Box,
          {
            component: "span",
  ...
  return shouldWrapWithHeading ? (0, import_jsx_runtime100.jsx)(Heading, { ...ctx.getStyles("itemTitle", { classNames, styles }), children: content }) : content;
});
...
var AccordionItem = factory((props, ref) => {
  ...
  const ctx = useAccordionContext();
  return (0, import_jsx_runtime101.jsx)(AccordionItemProvider, { value: { value }, children: (0, import_jsx_runtime101.jsx)(
    Box,
    {
      ref,
...
var AccordionPanel = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime102.jsx)(
    Collapse,
    {
      ...
      children: (0, import_jsx_runtime102.jsx)("div", { ...ctx.getStyles("content", { classNames, styles }), children })
    }
  );
});
...
var defaultProps30 = {
  ...
  variant: "default",
  chevron: (0, import_jsx_runtime103.jsx)(AccordionChevron, {})
};
...
function Accordion(_props) {
  ...
  return (0, import_jsx_runtime103.jsx)(
    AccordionProvider,
    {
      ...
      children: (0, import_jsx_runtime103.jsx)(Box, { ...getStyles2("root"), id: uid, ...others, variant, "data-accordion": true, children })
    }
  );
}
...
var Affix = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime104.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: (0, import_jsx_runtime104.jsx)(Box, { ref, ...getStyles2("root"), ...others }) });
});
...
var Alert = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime105.jsx)(
    Box,
    {
      ...
      children: (0, import_jsx_runtime105.jsxs)("div", { ...getStyles2("wrapper"), children: [
        icon && (0, import_jsx_runtime105.jsx)("div", { ...getStyles2("icon"), children: icon }),
        (0, import_jsx_runtime105.jsxs)("div", { ...getStyles2("body"), children: [
          title && (0, import_jsx_runtime105.jsx)("div", { ...getStyles2("title"), "data-with-close-button": withCloseButton || void 0, children: (0, import_jsx_runtime105.jsx)("span", { id: titleId, ...getStyles2("label"), children: title }) }),
          children && (0, import_jsx_runtime105.jsx)("div", { id: bodyId, ...getStyles2("message"), "data-variant": variant, children })
        ] }),
        withCloseButton && (0, import_jsx_runtime105.jsx)(
          CloseButton,
          {
...
var AngleSlider = factory((_props, ref) => {
  ...
  const marksItems = marks == null ? void 0 : marks.map((mark, index3) => (0, import_react191.createElement)(
    "div",
    {
  ...
  return (0, import_jsx_runtime108.jsxs)(Box, { ref: useMergedRef(ref, rootRef), ...getStyles2("root", { focusable: true }), ...others, children: [
    marksItems && marksItems.length > 0 && (0, import_jsx_runtime108.jsx)("div", { ...getStyles2("marks"), children: marksItems }),
    withLabel && (0, import_jsx_runtime108.jsx)("div", { ...getStyles2("label"), children: typeof formatLabel === "function" ? formatLabel(_value) : _value }),
    ...
    (0, import_jsx_runtime108.jsx)("input", { type: "hidden", name, value: _value, ...hiddenInputProps })
  ] });
});
...
function AppShellMediaStyles({
  ...
  return (0, import_jsx_runtime121.jsx)(InlineStyles, { media, styles: baseStyles, selector: ctx.cssVariablesSelector });
}
...
function useResizing({ transitionDuration, disabled }) {
  const [resizing, setResizing] = (0, import_react207.useState)(true);
  const resizingTimeout = (0, import_react207.useRef)(-1);
  const disabledTimeout = (0, import_react207.useRef)(-1);
  useWindowEvent("resize", () => {
    setResizing(true);
    clearTimeout(resizingTimeout.current);
    resizingTimeout.current = window.setTimeout(
      () => (0, import_react207.startTransition)(() => {
        setResizing(false);
      }),
      200
    );
...
var AppShell = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime124.jsxs)(AppShellProvider, { value: { getStyles: getStyles2, withBorder, zIndex, disabled, offsetScrollbars }, children: [
...
var AspectRatio = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime125.jsx)(Box, { ref, ...getStyles2("root"), ...others });
});
...
var ComboboxClearButton = (0, import_react212.forwardRef)(
  ({ size: size2, onMouseDown, onClick, onClear, ...others }, ref) => (0, import_jsx_runtime128.jsx)(
    CloseButton,
    {
      ref,
      size: size2 || "sm",
...
var ComboboxDropdownTarget = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime130.jsx)(Popover.Target, { ref, refProp, children });
});
...
function useComboboxTargetProps({
  ...
  const ctx = useComboboxContext();
  const [selectedOptionId, setSelectedOptionId] = (0, import_react216.useState)(null);
  const handleKeyDown = (event) => {
    onKeyDown == null ? void 0 : onKeyDown(event);
    if (ctx.readOnly) {
      return;
...
var ComboboxEventsTarget = factory((props, ref) => {
  ...
  return (0, import_react217.cloneElement)(children, {
    ...targetProps,
    ...others,
...
var ComboboxGroup = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime134.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        label && (0, import_jsx_runtime134.jsx)("div", { ...ctx.getStyles("groupLabel", { classNames, styles }), children: label }),
        children
      ]
    }
  );
...
var ComboboxOption = factory((_props, ref) => {
  ...
  const ctx = useComboboxContext();
  const uuid = (0, import_react221.useId)();
  const _id = id || uuid;
...
var ComboboxTarget = factory((props, ref) => {
  ...
  const clonedElement = (0, import_react224.cloneElement)(children, {
    ...targetProps,
    ...others
  });
  return (0, import_jsx_runtime140.jsx)(Popover.Target, { ref: useMergedRef(ref, ctx.store.targetRef), children: clonedElement });
});
...
function useCombobox({
  ...
  const listId = (0, import_react225.useRef)(null);
  const selectedOptionIndex = (0, import_react225.useRef)(-1);
  const searchRef = (0, import_react225.useRef)(null);
  const targetRef = (0, import_react225.useRef)(null);
  const focusSearchTimeout = (0, import_react225.useRef)(-1);
  const focusTargetTimeout = (0, import_react225.useRef)(-1);
  const selectedIndexUpdateTimeout = (0, import_react225.useRef)(-1);
  const openDropdown = (0, import_react225.useCallback)(
    (eventSource = "unknown") => {
      if (!dropdownOpened) {
  ...
  const closeDropdown = (0, import_react225.useCallback)(
    (eventSource = "unknown") => {
      if (dropdownOpened) {
  ...
  const toggleDropdown = (0, import_react225.useCallback)(
    (eventSource = "unknown") => {
      if (dropdownOpened) {
  ...
  const clearSelectedItem = (0, import_react225.useCallback)(() => {
  ...
  const selectOption = (0, import_react225.useCallback)(
    (index3) => {
  ...
  const selectActiveOption = (0, import_react225.useCallback)(() => {
  ...
  const selectNextOption = (0, import_react225.useCallback)(
    () => selectOption(
      getNextIndex2(
  ...
  const selectPreviousOption = (0, import_react225.useCallback)(
    () => selectOption(
      getPreviousIndex2(
        selectedOptionIndex.current,
        document.querySelectorAll(`#${listId.current} [data-combobox-option]`),
  ...
  const selectFirstOption = (0, import_react225.useCallback)(
    () => selectOption(
      getFirstIndex(
        document.querySelectorAll(`#${listId.current} [data-combobox-option]`)
      )
  ...
  const updateSelectedOptionIndex = (0, import_react225.useCallback)(
  ...
  const resetSelectedOption = (0, import_react225.useCallback)(() => {
    selectedOptionIndex.current = -1;
    clearSelectedItem();
  }, [clearSelectedItem]);
  const clickSelectedOption = (0, import_react225.useCallback)(() => {
    const items = document.querySelectorAll(
      `#${listId.current} [data-combobox-option]`
    );
  ...
  const setListId = (0, import_react225.useCallback)((id) => {
    listId.current = id;
  }, []);
  const focusSearchInput = (0, import_react225.useCallback)(() => {
    focusSearchTimeout.current = window.setTimeout(() => searchRef.current.focus(), 0);
  }, []);
  const focusTarget = (0, import_react225.useCallback)(() => {
    focusTargetTimeout.current = window.setTimeout(() => targetRef.current.focus(), 0);
  }, []);
  const getSelectedOptionIndex = (0, import_react225.useCallback)(() => selectedOptionIndex.current, []);
...
var InlineInput = (0, import_react227.forwardRef)(
  ({
    __staticSelector,
    __stylesApiProps,
    className,
      ...
      Box,
      {
        ...
        children: (0, import_jsx_runtime142.jsxs)(
          Box,
          {
            ...
            children: [
              children,
              (0, import_jsx_runtime142.jsxs)("div", { ...getStyles2("labelWrapper"), "data-disabled": disabled || void 0, children: [
                label && (0, import_jsx_runtime142.jsx)(
                  Box,
                  {
                    component: labelElement,
                ...
                description && (0, import_jsx_runtime142.jsx)(Input.Description, { size: size2, __inheritStyles: false, ...getStyles2("description"), children: description }),
                error && typeof error !== "boolean" && (0, import_jsx_runtime142.jsx)(Input.Error, { size: size2, __inheritStyles: false, ...getStyles2("error"), children: error })
              ] })
            ]
          }
        )
...
var CheckboxGroupContext = (0, import_react228.createContext)(null);
var CheckboxGroupProvider = CheckboxGroupContext.Provider;
var useCheckboxGroupContext = () => (0, import_react228.useContext)(CheckboxGroupContext);
...
var CheckboxCard = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime144.jsx)(CheckboxCardProvider, { value: { checked: _value }, children: (0, import_jsx_runtime144.jsx)(
    UnstyledButton,
    {
      ref,
...
function InputsGroupFieldset({ children, role }) {
  const ctx = useInputWrapperContext();
  if (!ctx) {
    return (0, import_jsx_runtime145.jsx)(import_jsx_runtime145.Fragment, { children });
  }
  return (0, import_jsx_runtime145.jsx)("div", { role, "aria-labelledby": ctx.labelId, "aria-describedby": ctx.describedBy, children });
}
...
var CheckboxGroup = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime146.jsx)(CheckboxGroupProvider, { value: { value: _value, onChange: handleChange, size: size2 }, children: (0, import_jsx_runtime146.jsx)(
    Input.Wrapper,
    {
      size: size2,
      ref,
      ...
      children: (0, import_jsx_runtime146.jsx)(InputsGroupFieldset, { role: "group", children })
    }
  ) });
});
  ...
  if (indeterminate) {
    return (0, import_jsx_runtime147.jsx)(
      "svg",
      {
        ...
        "aria-hidden": true,
        ...others,
        children: (0, import_jsx_runtime147.jsx)("rect", { width: "32", height: "6", fill: "currentColor", rx: "3" })
      }
    );
  }
  return (0, import_jsx_runtime147.jsx)(CheckIcon, { ...others });
}
...
var CheckboxIndicator = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime148.jsx)(
    Box,
    {
      ...
      ...others,
      children: (0, import_jsx_runtime148.jsx)(Icon, { indeterminate, ...getStyles2("icon") })
    }
  );
});
...
var Checkbox = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime149.jsx)(
    InlineInput,
    {
      ...
      ...styleProps,
      ...wrapperProps,
      children: (0, import_jsx_runtime149.jsxs)(Box, { ...getStyles2("inner"), mod: { "data-label-position": labelPosition }, children: [
        ...
        (0, import_jsx_runtime149.jsx)(Icon, { indeterminate, ...getStyles2("icon") })
      ] })
    }
  );
});
...
function Option({
  ...
  if (!isOptionsGroup(data)) {
    ...
    const check = withCheckIcon && checked && (0, import_jsx_runtime150.jsx)(CheckIcon, { className: classes23.optionsDropdownCheckIcon });
    const defaultContent = (0, import_jsx_runtime150.jsxs)(import_jsx_runtime150.Fragment, { children: [
      checkIconPosition === "left" && check,
      (0, import_jsx_runtime150.jsx)("span", { children: data.label }),
  ...
  const options = data.items.map((item) => (0, import_jsx_runtime150.jsx)(
    Option,
    {
      data: item,
      value,
  ...
  return (0, import_jsx_runtime150.jsx)(Combobox.Group, { label: data.group, children: options });
}
function OptionsDropdown({
  ...
  const options = filteredData.map((item) => (0, import_jsx_runtime150.jsx)(
    Option,
    {
      data: item,
      withCheckIcon,
  ...
  return (0, import_jsx_runtime150.jsx)(Combobox.Dropdown, { hidden: hidden2 || hiddenWhenEmpty && isEmpty, children: (0, import_jsx_runtime150.jsxs)(Combobox.Options, { labelledBy: labelId, "aria-label": ariaLabel, children: [
    withScrollArea ? (0, import_jsx_runtime150.jsx)(
      ScrollArea.Autosize,
      {
    ...
    isEmpty && nothingFoundMessage && (0, import_jsx_runtime150.jsx)(Combobox.Empty, { children: nothingFoundMessage })
  ] }) });
}
...
var Autocomplete = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime151.jsxs)(
    Combobox,
    {
      ...
      ...comboboxProps,
      children: [
        (0, import_jsx_runtime151.jsx)(Combobox.Target, { autoComplete, children: (0, import_jsx_runtime151.jsx)(
          InputBase,
          {
            ref,
            ...others,
...
var AvatarGroupContext = (0, import_react237.createContext)(null);
var AvatarGroupProvider = AvatarGroupContext.Provider;
function useAvatarGroupContext() {
  const ctx = (0, import_react237.useContext)(AvatarGroupContext);
...
var AvatarGroup = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime152.jsx)(AvatarGroupProvider, { value: true, children: (0, import_jsx_runtime152.jsx)(Box, { ref, ...getStyles2("group"), ...others }) });
});
...
var Avatar = polymorphicFactory((_props, ref) => {
  ...
  const [error, setError] = (0, import_react239.useState)(!src);
  const getStyles2 = useStyles({
    name: "Avatar",
    props,
    classes: classes28,
  ...
  (0, import_react239.useEffect)(() => setError(!src), [src]);
  return (0, import_jsx_runtime154.jsx)(
    Box,
    {
      ...
      ref,
      ...others,
      children: error ? (0, import_jsx_runtime154.jsx)("span", { ...getStyles2("placeholder"), title: alt, children: children || typeof name === "string" && getInitials(name) || (0, import_jsx_runtime154.jsx)(AvatarPlaceholderIcon, {}) }) : (0, import_jsx_runtime154.jsx)(
        "img",
        {
          ...imageProps,
          ...getStyles2("image"),
...
var Badge = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime156.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        leftSection && (0, import_jsx_runtime156.jsx)("span", { ...getStyles2("section"), "data-position": "left", children: leftSection }),
        (0, import_jsx_runtime156.jsx)("span", { ...getStyles2("label"), children }),
        rightSection && (0, import_jsx_runtime156.jsx)("span", { ...getStyles2("section"), "data-position": "right", children: rightSection })
      ]
    }
  );
});
...
var Blockquote = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime157.jsxs)(Box, { component: "blockquote", ref, ...getStyles2("root"), ...others, children: [
    icon && (0, import_jsx_runtime157.jsx)("span", { ...getStyles2("icon"), children: icon }),
    children,
    cite && (0, import_jsx_runtime157.jsx)("cite", { ...getStyles2("cite"), children: cite })
  ] });
});
...
var Breadcrumbs = factory((_props, ref) => {
  ...
  const items = import_react243.Children.toArray(children).reduce((acc, child, index3, array) => {
    var _a;
    const item = isElement(child) ? (0, import_react243.cloneElement)(child, {
      ...getStyles2("breadcrumb", { className: (_a = child.props) == null ? void 0 : _a.className }),
      key: index3
    }) : (0, import_react243.createElement)("div", { ...getStyles2("breadcrumb"), key: index3 }, child);
    acc.push(item);
    if (index3 !== array.length - 1) {
      acc.push(
        (0, import_react243.createElement)(Box, { ...getStyles2("separator"), key: `separator-${index3}` }, separator)
      );
    }
    return acc;
  }, []);
  return (0, import_jsx_runtime158.jsx)(Box, { ref, ...getStyles2("root"), ...others, children: items });
});
...
var Burger = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime159.jsxs)(UnstyledButton, { ...getStyles2("root"), ref, ...others, children: [
    (0, import_jsx_runtime159.jsx)(Box, { mod: ["reduce-motion", { opened }], ...getStyles2("burger") }),
    children
  ] });
});
...
var ButtonGroupSection = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime161.jsx)(Box, { ...getStyles2("groupSection"), ref, variant, ...others });
});
...
var Button = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime162.jsxs)(
    UnstyledButton,
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime162.jsx)(Transition, { mounted: !!loading, transition: loaderTransition, duration: 150, children: (transitionStyles) => (0, import_jsx_runtime162.jsx)(Box, { component: "span", ...getStyles2("loader", { style: transitionStyles }), "aria-hidden": true, children: (0, import_jsx_runtime162.jsx)(
          Loader,
          {
        ...
        (0, import_jsx_runtime162.jsxs)("span", { ...getStyles2("inner"), children: [
          leftSection && (0, import_jsx_runtime162.jsx)(Box, { component: "span", ...getStyles2("section"), mod: { position: "left" }, children: leftSection }),
          (0, import_jsx_runtime162.jsx)(Box, { component: "span", mod: { loading }, ...getStyles2("label"), children }),
          rightSection && (0, import_jsx_runtime162.jsx)(Box, { component: "span", ...getStyles2("section"), mod: { position: "right" }, children: rightSection })
        ] })
      ]
    }
  );
...
var Card = polymorphicFactory((_props, ref) => {
  ...
  const _children = import_react250.Children.toArray(children);
  const content = _children.map((child, index3) => {
    if (typeof child === "object" && child && "type" in child && child.type === CardSection) {
      return (0, import_react250.cloneElement)(child, {
  ...
  return (0, import_jsx_runtime165.jsx)(CardProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime165.jsx)(Paper, { ref, unstyled, ...getStyles2("root"), ...others, children: content }) });
});
...
var Center = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime166.jsx)(Box, { ref, mod: [{ inline: inline2 }, mod], ...getStyles2("root"), ...others });
});
...
function ChipGroup(props) {
  ...
  return (0, import_jsx_runtime168.jsx)(ChipGroupProvider, { value: { isChipSelected, onChange: handleChange, multiple }, children });
}
      ...
      children: [
        ...
        (0, import_jsx_runtime169.jsxs)(
          "label",
          {
            ...
            children: [
              _checked && (0, import_jsx_runtime169.jsx)("span", { ...getStyles2("iconWrapper"), children: icon || (0, import_jsx_runtime169.jsx)(CheckIcon, { ...getStyles2("checkIcon") }) }),
              (0, import_jsx_runtime169.jsx)("span", { children })
            ]
          }
        )
      ]
...
var ColorSwatch = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime171.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime171.jsx)("span", { ...getStyles2("alphaOverlay") }),
        withShadow && (0, import_jsx_runtime171.jsx)("span", { ...getStyles2("shadowOverlay") }),
        (0, import_jsx_runtime171.jsx)("span", { ...getStyles2("colorOverlay", { style: { backgroundColor: color } }) }),
        (0, import_jsx_runtime171.jsx)("span", { ...getStyles2("childrenOverlay"), children })
      ]
    }
  );
});
...
var Thumb2 = (0, import_react258.forwardRef)(({ position, ...others }, ref) => (0, import_jsx_runtime173.jsx)(
  Box,
  {
    ref,
    __vars: {
...
var ColorSlider = factory((_props, ref) => {
  ...
  const theme = useMantineTheme();
  const [position, setPosition] = (0, import_react259.useState)({ y: 0, x: value / maxValue });
  const positionRef = (0, import_react259.useRef)(position);
  ...
  const layers = overlays.map((overlay, index3) => (0, import_react259.createElement)("div", { ...getStyles2("sliderOverlay"), style: overlay, key: index3 }));
...
// node_modules/@mantine/core/esm/components/ColorPicker/AlphaSlider/AlphaSlider.mjs
var defaultProps80 = {};
var AlphaSlider = (0, import_react260.forwardRef)((props, ref) => {
...
var HueSlider = (0, import_react261.forwardRef)((props, ref) => {
...
function Saturation({
  ...
  const [position, setPosition] = (0, import_react262.useState)({ x: value.s / 100, y: 1 - value.v / 100 });
  const positionRef = (0, import_react262.useRef)(position);
  const { ref } = useMove(
    ({ x, y: y2 }) => {
      positionRef.current = { x, y: y2 };
  ...
  return (0, import_jsx_runtime177.jsxs)(
    Box,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime177.jsx)(Thumb2, { position, ...getStyles2("thumb", { style: { backgroundColor: color } }) })
      ]
    }
  );
}
...
var Swatches = (0, import_react263.forwardRef)(
  ({
    className,
    datatype,
    setValue,
    ...
    const colors = data.map((color, index3) => (0, import_react263.createElement)(
      ColorSwatch,
      {
    ...
    return (0, import_jsx_runtime178.jsx)(Box, { ...ctx.getStyles("swatches"), ref, ...others, children: colors });
  }
);
...
var ColorPicker = factory((_props, ref) => {
  ...
  const formatRef = (0, import_react264.useRef)(format2);
  const valueRef = (0, import_react264.useRef)("");
  const scrubTimeoutRef = (0, import_react264.useRef)(-1);
  const isScrubbingRef = (0, import_react264.useRef)(false);
  ...
  const [parsed, setParsed] = (0, import_react264.useState)(parseColor(_value));
  const startScrubbing = () => {
  ...
  return (0, import_jsx_runtime179.jsx)(ColorPickerProvider, { value: { getStyles: getStyles2, unstyled }, children: (0, import_jsx_runtime179.jsxs)(
    Box,
    {
      ref,
      ...getStyles2("wrapper"),
      ...
      ...others,
      children: [
        withPicker && (0, import_jsx_runtime179.jsxs)(import_jsx_runtime179.Fragment, { children: [
          ...
          (0, import_jsx_runtime179.jsxs)("div", { ...getStyles2("body"), children: [
            (0, import_jsx_runtime179.jsxs)("div", { ...getStyles2("sliders"), children: [
              (0, import_jsx_runtime179.jsx)(
                HueSlider,
                {
                  value: parsed.h,
              ...
              withAlpha && (0, import_jsx_runtime179.jsx)(
                AlphaSlider,
                {
                  value: parsed.a,
        ...
        Array.isArray(swatches) && (0, import_jsx_runtime179.jsx)(
          Swatches,
          {
            data: swatches,
            swatchesPerRow,
...
function EyeDropperIcon({ style, ...others }) {
  return (0, import_jsx_runtime180.jsxs)(
    "svg",
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime180.jsx)("path", { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
        (0, import_jsx_runtime180.jsx)("path", { d: "M11 7l6 6" }),
        (0, import_jsx_runtime180.jsx)("path", { d: "M4 16l11.7 -11.7a1 1 0 0 1 1.4 0l2.6 2.6a1 1 0 0 1 0 1.4l-11.7 11.7h-4v-4z" })
      ]
    }
  );
}
...
var ColorInput = factory((_props, ref) => {
  ...
  const [dropdownOpened, setDropdownOpened] = (0, import_react265.useState)(false);
  const [lastValidValue, setLastValidValue] = (0, import_react265.useState)("");
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: "",
  ...
  const eyeDropper = (0, import_jsx_runtime181.jsx)(
    ActionIcon,
    {
      ...eyeDropperButtonProps,
      ...
      children: eyeDropperIcon || (0, import_jsx_runtime181.jsx)(EyeDropperIcon, { ...getStyles2("eyeDropperIcon") })
    }
  );
    ...
    Input.Wrapper,
    {
      ...
      children: (0, import_jsx_runtime181.jsxs)(
        Popover,
        {
          ...
          children: [
            (0, import_jsx_runtime181.jsx)(Popover.Target, { children: (0, import_jsx_runtime181.jsx)(
              Input,
              {
                autoComplete: "off",
                ...others,
                ...
                leftSection: leftSection || (withPreview ? (0, import_jsx_runtime181.jsx)(
                  ColorSwatch,
                  {
...
var Container = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime182.jsx)(Box, { ref, mod: [{ fluid }, mod], ...getStyles2("root"), ...others });
});
...
function CopyButton(props) {
  ...
  return (0, import_jsx_runtime183.jsx)(import_jsx_runtime183.Fragment, { children: children({ copy, copied: clipboard.copied, ...others }) });
}
...
var Dialog = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime184.jsx)(
    Affix,
    {
      ...
      portalProps,
      unstyled,
      children: (0, import_jsx_runtime184.jsx)(Transition, { keepMounted, mounted: opened, ...transitionProps, children: (transitionStyles) => (0, import_jsx_runtime184.jsxs)(
        Paper,
        {
          unstyled,
          ...
          ...others,
          children: [
            withCloseButton && (0, import_jsx_runtime184.jsx)(CloseButton, { onClick: onClose, unstyled, ...getStyles2("closeButton") }),
            children
          ]
        }
      ) })
...
var Divider = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime185.jsx)(
    Box,
    {
      ...
      ...others,
      role: "separator",
      children: label && (0, import_jsx_runtime185.jsx)(Box, { component: "span", mod: { position: labelPosition }, ...getStyles2("label"), children: label })
    }
  );
});
...
var DrawerContent = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime189.jsx)(
    ModalBaseContent,
    {
      ...
      children: (0, import_jsx_runtime189.jsx)(Scroll, { style: { height: "calc(100vh - var(--drawer-offset) * 2)" }, children })
    }
  );
});
...
var DrawerRoot = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime192.jsx)(DrawerProvider, { value: { scrollAreaComponent, getStyles: getStyles2, radius }, children: (0, import_jsx_runtime192.jsx)(
    ModalBase,
    {
      ref,
      ...getStyles2("root"),
...
function DrawerStack({ children }) {
  const [stack, setStack] = (0, import_react278.useState)([]);
  const [maxZIndex, setMaxZIndex] = (0, import_react278.useState)(getDefaultZIndex("modal"));
...
var Drawer = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime195.jsxs)(
    DrawerRoot,
    {
      ...
      ...stackProps,
      children: [
        withOverlay && (0, import_jsx_runtime195.jsx)(
          DrawerOverlay,
          {
        ...
        (0, import_jsx_runtime195.jsxs)(DrawerContent, { __hidden: ctx && stackId && opened ? stackId !== ctx.currentId : false, children: [
          hasHeader && (0, import_jsx_runtime195.jsxs)(DrawerHeader, { children: [
            title && (0, import_jsx_runtime195.jsx)(DrawerTitle, { children: title }),
            withCloseButton && (0, import_jsx_runtime195.jsx)(DrawerCloseButton, { ...closeButtonProps })
          ] }),
          (0, import_jsx_runtime195.jsx)(DrawerBody, { children })
        ] })
      ]
    }
  );
...
var Fieldset = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime196.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        legend && (0, import_jsx_runtime196.jsx)("legend", { ...getStyles2("legend", { variant }), children: legend }),
        children
      ]
    }
  );
...
var FileButton = (0, import_react282.forwardRef)(
  (props, ref) => {
    const {
      onChange,
      children,
    ...
    const inputRef = (0, import_react282.useRef)(null);
    const onClick = () => {
      var _a;
...
var DefaultValue = ({ value }) => (0, import_jsx_runtime198.jsx)("div", { style: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: Array.isArray(value) ? value.map((file) => file.name).join(", ") : value == null ? void 0 : value.name });
var defaultProps97 = {
...
var _FileInput = factory((_props, ref) => {
  ...
  const resetRef = (0, import_react283.useRef)(null);
  const { resolvedClassNames, resolvedStyles } = useResolvedStylesApi({
    classNames,
    styles,
    props
  ...
  const _rightSection = rightSection || (clearable && hasValue && !readOnly ? (0, import_jsx_runtime198.jsx)(
    CloseButton,
    {
      ...clearButtonProps,
      variant: "subtle",
  ...
  return (0, import_jsx_runtime198.jsx)(
    FileButton,
    {
      ...
      children: (fileButtonProps) => (0, import_jsx_runtime198.jsx)(
        InputBase,
        {
          ...
          classNames,
          styles,
          children: !hasValue ? (0, import_jsx_runtime198.jsx)(
            Input.Placeholder,
            {
              __staticSelector: "FileInput",
              classNames: resolvedClassNames,
          ...
          ) : (0, import_jsx_runtime198.jsx)(ValueComponent, { value: _value })
        }
      )
    }
  );
...
function useDelayedHover({ open, close, openDelay, closeDelay }) {
  const openTimeout = (0, import_react284.useRef)(-1);
  const closeTimeout = (0, import_react284.useRef)(-1);
  const clearTimeouts = () => {
  ...
  (0, import_react284.useEffect)(() => clearTimeouts, []);
...
var GridCol = factory((_props, ref) => {
  ...
  const ctx = useGridContext();
  const responsiveClassName = useRandomClassName();
  return (0, import_jsx_runtime201.jsxs)(import_jsx_runtime201.Fragment, { children: [
    (0, import_jsx_runtime201.jsx)(
      GridColVariables,
      {
        selector: `.${responsiveClassName}`,
        span,
...
var Grid = factory((_props, ref) => {
  ...
  if (type === "container" && breakpoints) {
    return (0, import_jsx_runtime203.jsxs)(GridProvider, { value: { getStyles: getStyles2, grow, columns: columns || 12, breakpoints, type }, children: [
      (0, import_jsx_runtime203.jsx)(GridVariables, { selector: `.${responsiveClassName}`, ...props }),
      (0, import_jsx_runtime203.jsx)("div", { ...getStyles2("container"), children: (0, import_jsx_runtime203.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others, children: (0, import_jsx_runtime203.jsx)("div", { ...getStyles2("inner"), children }) }) })
    ] });
  }
  return (0, import_jsx_runtime203.jsxs)(GridProvider, { value: { getStyles: getStyles2, grow, columns: columns || 12, breakpoints, type }, children: [
    (0, import_jsx_runtime203.jsx)(GridVariables, { selector: `.${responsiveClassName}`, ...props }),
    (0, import_jsx_runtime203.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others, children: (0, import_jsx_runtime203.jsx)("div", { ...getStyles2("inner"), children }) })
  ] });
});
...
var Mark = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime205.jsx)(Box, { component: "mark", ref, variant, ...getStyles2("root"), ...others });
});
...
var Highlight = polymorphicFactory((props, ref) => {
  ...
  return (0, import_jsx_runtime206.jsx)(Text, { unstyled, ref, ...others, __staticSelector: "Highlight", children: highlightChunks.map(
    ({ chunk, highlighted }, i2) => highlighted ? (0, import_jsx_runtime206.jsx)(
      Mark,
      {
        unstyled,
        color,
      ...
      i2
    ) : (0, import_jsx_runtime206.jsx)("span", { children: chunk }, i2)
  ) });
});
...
function HoverCardDropdown(props) {
  ...
  return (0, import_jsx_runtime208.jsx)(Popover.Dropdown, { onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, ...others, children });
}
...
var HoverCardTarget = (0, import_react295.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime209.jsx)(Popover.Target, { refProp, ref, ...others, children: (0, import_react295.cloneElement)(
    children,
...
function HoverCard(props) {
  ...
  return (0, import_jsx_runtime210.jsx)(HoverCardContextProvider, { value: { openDropdown, closeDropdown }, children: (0, import_jsx_runtime210.jsx)(Popover, { ...others, opened, __staticSelector: "HoverCard", children }) });
}
...
var Image = polymorphicFactory((_props, ref) => {
  ...
  const [error, setError] = (0, import_react298.useState)(!src);
  (0, import_react298.useEffect)(() => setError(!src), [src]);
  const getStyles2 = useStyles({
    name: "Image",
    classes: classes49,
    props,
...
var Indicator = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime213.jsxs)(Box, { ref, ...getStyles2("root"), mod: [{ inline: inline2 }, mod], ...others, children: [
    !disabled && (0, import_jsx_runtime213.jsx)(
      Box,
      {
...
var index = import_react301.useLayoutEffect;

// node_modules/use-latest/dist/use-latest.esm.js
var useLatest = function useLatest2(value) {
  var ref = import_react302.default.useRef(value);
  index(function() {
    ref.current = value;
  });
  return ref;
...
var useComposedRef = function useComposedRef2(libRef, userRef) {
  var prevUserRef = import_react303.default.useRef();
  return import_react303.default.useCallback(function(instance) {
...
var JsonInput = factory((props, ref) => {
  ...
  const [valid, setValid] = (0, import_react305.useState)(validateJson(_value, deserialize));
...
var Kbd = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime216.jsx)(Box, { component: "kbd", ref, ...getStyles2("root"), ...others });
});
...
var ListItem = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime218.jsx)(
    Box,
    {
      ...
      ref,
      ...others,
      children: (0, import_jsx_runtime218.jsxs)("div", { ...ctx.getStyles("itemWrapper", stylesApiProps), children: [
        _icon && (0, import_jsx_runtime218.jsx)("span", { ...ctx.getStyles("itemIcon", stylesApiProps), children: _icon }),
        (0, import_jsx_runtime218.jsx)("span", { ...ctx.getStyles("itemLabel", stylesApiProps), children })
      ] })
    }
  );
});
...
var List = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime219.jsx)(ListProvider, { value: { center, icon, getStyles: getStyles2 }, children: (0, import_jsx_runtime219.jsx)(
    Box,
    {
...
var LoadingOverlay = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime220.jsx)(Transition, { transition: "fade", ...transitionProps, mounted: !!visible2, children: (transitionStyles) => (0, import_jsx_runtime220.jsxs)(Box, { ...getStyles2("root", { style: transitionStyles }), ref, ...others, children: [
    (0, import_jsx_runtime220.jsx)(Loader, { ...getStyles2("loader"), unstyled, ...loaderProps }),
...
var MenuDropdown = factory((props, ref) => {
  ...
  const wrapperRef = (0, import_react313.useRef)(null);
  const ctx = useMenuContext();
  ...
  return (0, import_jsx_runtime223.jsxs)(
    Popover.Dropdown,
    {
      ...
      onKeyDown: handleKeyDown,
      children: [
        (0, import_jsx_runtime223.jsx)("div", { tabIndex: -1, "data-autofocus": true, "data-mantine-stop-propagation": true, style: { outline: 0 } }),
        children
      ]
    }
  );
...
var MenuItem = polymorphicFactory((props, ref) => {
  ...
  const theme = useMantineTheme();
  const { dir } = useDirection();
  const itemRef = (0, import_react314.useRef)(null);
  ...
  return (0, import_jsx_runtime224.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        leftSection && (0, import_jsx_runtime224.jsx)("div", { ...ctx.getStyles("itemSection", { styles, classNames }), "data-position": "left", children: leftSection }),
        children && (0, import_jsx_runtime224.jsx)("div", { ...ctx.getStyles("itemLabel", { styles, classNames }), children }),
        rightSection && (0, import_jsx_runtime224.jsx)("div", { ...ctx.getStyles("itemSection", { styles, classNames }), "data-position": "right", children: rightSection })
      ]
    }
  );
});
...
var MenuTarget = (0, import_react316.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime226.jsx)(Popover.Target, { refProp, popupType: "menu", ref, ...others, children: (0, import_react316.cloneElement)(children, {
    onClick,
    onMouseEnter,
    onMouseLeave,
...
function Menu(_props) {
  ...
  const [openedViaClick, setOpenedViaClick] = (0, import_react317.useState)(false);
  const close = () => {
    setOpened(false);
...
var ModalRoot = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime234.jsx)(ModalProvider, { value: { yOffset, scrollAreaComponent, getStyles: getStyles2, fullScreen }, children: (0, import_jsx_runtime234.jsx)(
    ModalBase,
    {
      ref,
      ...getStyles2("root"),
...
function ModalStack({ children }) {
  const [stack, setStack] = (0, import_react326.useState)([]);
  const [maxZIndex, setMaxZIndex] = (0, import_react326.useState)(getDefaultZIndex("modal"));
...
var Modal = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime237.jsxs)(
    ModalRoot,
    {
      ref,
      radius,
      ...
      ...stackProps,
      children: [
        withOverlay && (0, import_jsx_runtime237.jsx)(
          ModalOverlay,
          {
            visible: overlayVisible,
            transitionProps: ctx && stackId ? { duration: 0 } : void 0,
        ...
        (0, import_jsx_runtime237.jsxs)(
          ModalContent,
          {
            radius,
            __hidden: ctx && stackId && opened ? stackId !== ctx.currentId : false,
            children: [
              hasHeader && (0, import_jsx_runtime237.jsxs)(ModalHeader, { children: [
                title && (0, import_jsx_runtime237.jsx)(ModalTitle, { children: title }),
                withCloseButton && (0, import_jsx_runtime237.jsx)(ModalCloseButton, { ...closeButtonProps })
              ] }),
              (0, import_jsx_runtime237.jsx)(ModalBody, { children })
            ]
          }
        )
      ]
...
var PillGroup = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime240.jsx)(PillGroupProvider, { value: { size: _size, disabled }, children: (0, import_jsx_runtime240.jsx)(Box, { ref, size: _size, ...getStyles2("group"), ...others }) });
});
...
var Pill = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime241.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime241.jsx)("span", { ...getStyles2("label"), children }),
        withRemoveButton && (0, import_jsx_runtime241.jsx)(
          CloseButton,
          {
            variant: "transparent",
            radius,
...
var PillsInput = factory((_props, ref) => {
  ...
  const fieldRef = (0, import_react335.useRef)(null);
  return (0, import_jsx_runtime243.jsx)(PillsInputProvider, { value: { fieldRef, size: size2, disabled, hasError: !!error, variant }, children: (0, import_jsx_runtime243.jsx)(
    InputBase,
    {
      size: size2,
      error,
...
var MultiSelect = factory((_props, ref) => {
  ...
  const clearButton = clearable && _value.length > 0 && !disabled && !readOnly && (0, import_jsx_runtime245.jsx)(
  ...
  return (0, import_jsx_runtime245.jsxs)(import_jsx_runtime245.Fragment, { children: [
    (0, import_jsx_runtime245.jsxs)(
      Combobox,
      {
        store: combobox,
        classNames: resolvedClassNames,
        ...
        ...comboboxProps,
        children: [
          (0, import_jsx_runtime245.jsx)(Combobox.DropdownTarget, { children: (0, import_jsx_runtime245.jsx)(
            PillsInput,
            {
              ...styleProps,
              __staticSelector: "MultiSelect",
              ...
              disabled,
              radius,
              rightSection: rightSection || clearButton || (0, import_jsx_runtime245.jsx)(Combobox.Chevron, { size: size2, error, unstyled }),
              ...
              required,
              mod,
              children: (0, import_jsx_runtime245.jsxs)(Pill.Group, { disabled, unstyled, ...getStyles2("pillsList"), children: [
                values2,
                (0, import_jsx_runtime245.jsx)(Combobox.EventsTarget, { autoComplete, children: (0, import_jsx_runtime245.jsx)(
                  PillsInput.Field,
                  {
                    ...rest,
                    ref,
...
function NativeSelectOption({ data }) {
  if (isGroup(data)) {
    const items = data.items.map((item) => (0, import_jsx_runtime246.jsx)(NativeSelectOption, { data: item }, item.value));
    return (0, import_jsx_runtime246.jsx)("optgroup", { label: data.group, children: items });
  }
  const { value, label, ...others } = data;
  return (0, import_jsx_runtime246.jsx)("option", { value: data.value, ...others, children: data.label }, data.value);
}
...
var NativeSelect = factory((props, ref) => {
  ...
  const options = getParsedComboboxData(data).map((item, index3) => (0, import_jsx_runtime247.jsx)(NativeSelectOption, { data: item }, index3));
  return (0, import_jsx_runtime247.jsx)(
    InputBase,
    {
      ...
      error,
      unstyled,
      rightSection: rightSection || (0, import_jsx_runtime247.jsx)(ComboboxChevron, { size: size2, error, unstyled }),
...
var NavLink = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime248.jsxs)(import_jsx_runtime248.Fragment, { children: [
    (0, import_jsx_runtime248.jsxs)(
      UnstyledButton,
      {
        ...getStyles2("root"),
        component: "a",
        ...
        ...others,
        children: [
          leftSection && (0, import_jsx_runtime248.jsx)(Box, { component: "span", ...getStyles2("section"), mod: { position: "left" }, children: leftSection }),
          (0, import_jsx_runtime248.jsxs)(Box, { ...getStyles2("body"), mod: { "no-wrap": noWrap }, children: [
            (0, import_jsx_runtime248.jsx)(Box, { component: "span", ...getStyles2("label"), children: label }),
            (0, import_jsx_runtime248.jsx)(Box, { component: "span", mod: { active }, ...getStyles2("description"), children: description })
          ] }),
          (withChildren || rightSection) && (0, import_jsx_runtime248.jsx)(
            Box,
            {
              ...getStyles2("section"),
              component: "span",
              mod: { rotate: _opened && !disableRightSectionRotation, position: "right" },
              children: withChildren ? rightSection || (0, import_jsx_runtime248.jsx)(AccordionChevron, { ...getStyles2("chevron") }) : rightSection
            }
          )
        ]
      }
    ),
    withChildren && (0, import_jsx_runtime248.jsx)(Collapse, { in: _opened, ...getStyles2("collapse"), children: (0, import_jsx_runtime248.jsx)("div", { ...getStyles2("children"), children }) })
  ] });
});
...
var Notification = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime249.jsxs)(
    Box,
    {
      ...
      role: "alert",
      children: [
        icon && !loading && (0, import_jsx_runtime249.jsx)("div", { ...getStyles2("icon"), children: icon }),
        loading && (0, import_jsx_runtime249.jsx)(Loader, { size: 28, color, ...getStyles2("loader") }),
        (0, import_jsx_runtime249.jsxs)("div", { ...getStyles2("body"), children: [
          title && (0, import_jsx_runtime249.jsx)("div", { ...getStyles2("title"), children: title }),
          (0, import_jsx_runtime249.jsx)(Box, { ...getStyles2("description"), mod: { "data-with-title": !!title }, children })
        ] }),
        withCloseButton && (0, import_jsx_runtime249.jsx)(
          CloseButton,
          {
            iconSize: 16,
            color: "gray",
...
function usePersistentCallback(cb) {
  var callbackRef = (0, import_react341.useRef)(cb);
  callbackRef.current = cb;
  var persistentCbRef = (0, import_react341.useRef)(function() {
    var args = [], len = arguments.length;
    while (len--) args[len] = arguments[len];
...
function useInternalValues(value, defaultValue, valueIsNumericString, format2, removeFormatting2, onValueChange) {
  if (onValueChange === void 0) onValueChange = noop5;
  ...
  var ref = (0, import_react341.useState)(function() {
  ...
  (0, import_react341.useMemo)(function() {
    setValues(newValues);
...
function NumberFormatBase(props) {
  ...
  if (onChange === void 0) onChange = noop5;
  var onKeyDown = props.onKeyDown;
  if (onKeyDown === void 0) onKeyDown = noop5;
  var onMouseUp = props.onMouseUp;
  if (onMouseUp === void 0) onMouseUp = noop5;
  var onFocus = props.onFocus;
  if (onFocus === void 0) onFocus = noop5;
  var onBlur = props.onBlur;
  if (onBlur === void 0) onBlur = noop5;
  ...
  var caretPositionBeforeChange = (0, import_react341.useRef)();
  var lastUpdatedValue = (0, import_react341.useRef)({ formattedValue, numAsString });
  ...
  var ref$1 = (0, import_react341.useState)(false);
  var mounted = ref$1[0];
  var setMounted = ref$1[1];
  var focusedElm = (0, import_react341.useRef)(null);
  var timeout = (0, import_react341.useRef)({
    setCaretTimeout: null,
    focusTimeout: null
  });
  (0, import_react341.useEffect)(function() {
    setMounted(true);
    return function() {
  ...
  var useIsomorphicLayoutEffect2 = typeof window !== "undefined" ? import_react341.useLayoutEffect : import_react341.useEffect;
  ...
  if (displayType === "text") {
    return renderText ? import_react341.default.createElement(import_react341.default.Fragment, null, renderText(formattedValue, otherProps) || null) : import_react341.default.createElement("span", Object.assign({}, otherProps, { ref: getInputRef }), formattedValue);
  } else if (customInput) {
    var CustomInput = customInput;
    return import_react341.default.createElement(CustomInput, Object.assign({}, inputProps, { ref: getInputRef }));
  }
  return import_react341.default.createElement("input", Object.assign({}, inputProps, { ref: getInputRef }));
}
...
function NumericFormat(props) {
  ...
  return import_react341.default.createElement(NumberFormatBase, Object.assign({}, numericFormatProps));
}
...
function NumberFormatter(_props) {
  ...
  return (0, import_jsx_runtime250.jsx)(NumericFormat, { displayType: "text", value, ...others });
}
...
var NumberInput = factory((_props, ref) => {
  ...
  const inputRef = (0, import_react343.useRef)(null);
  const onStepTimeoutRef = (0, import_react343.useRef)(null);
  const stepCountRef = (0, import_react343.useRef)(0);
  ...
  const incrementRef = (0, import_react343.useRef)(noop);
  ...
  const decrementRef = (0, import_react343.useRef)(noop);
  ...
  const controls = (0, import_jsx_runtime252.jsxs)("div", { ...getStyles2("controls"), children: [
    (0, import_jsx_runtime252.jsx)(
      UnstyledButton,
      {
        ...getStyles2("control"),
        tabIndex: -1,
        ...
        children: (0, import_jsx_runtime252.jsx)(NumberInputChevron, { direction: "up" })
      }
    ),
    (0, import_jsx_runtime252.jsx)(
      UnstyledButton,
      {
        ...
        onPointerUp: onStepDone,
        onPointerLeave: onStepDone,
        children: (0, import_jsx_runtime252.jsx)(NumberInputChevron, { direction: "down" })
      }
    )
  ] });
...
function PaginationIcon({ style, children, path, ...others }) {
  return (0, import_jsx_runtime255.jsx)(
    "svg",
    {
      ...
      ...others,
      children: (0, import_jsx_runtime255.jsx)("path", { d: path, fill: "currentColor" })
    }
  );
}
var PaginationNextIcon = (props) => (0, import_jsx_runtime255.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationPreviousIcon = (props) => (0, import_jsx_runtime255.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationFirstIcon = (props) => (0, import_jsx_runtime255.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationLastIcon = (props) => (0, import_jsx_runtime255.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationDotsIcon = (props) => (0, import_jsx_runtime255.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationDots = factory((_props, ref) => {
  ...
  const ctx = usePaginationContext();
  const Icon = icon;
  return (0, import_jsx_runtime256.jsx)(Box, { ref, ...ctx.getStyles("dots", { className, style, styles, classNames }), ...others, children: (0, import_jsx_runtime256.jsx)(
    Icon,
    {
      style: {
        width: "calc(var(--pagination-control-size) / 1.8)",
...
function createEdgeComponent({ icon, name, action, type }) {
  ...
  const Component = (0, import_react347.forwardRef)((props, ref) => {
...
function PaginationItems({ dotsIcon }) {
  ...
  const items = ctx.range.map((page, index3) => {
    var _a, _b, _c;
    if (page === "dots") {
      return (0, import_jsx_runtime258.jsx)(PaginationDots, { icon: dotsIcon }, index3);
    }
  ...
  return (0, import_jsx_runtime258.jsx)(import_jsx_runtime258.Fragment, { children: items });
}
...
var PaginationRoot = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime259.jsx)(
    PaginationProvider,
    {
      ...
      children: (0, import_jsx_runtime259.jsx)(Box, { ref, ...getStyles2("root"), ...others })
    }
  );
});
...
var Pagination = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime260.jsx)(PaginationRoot, { ref, total, ...others, children: (0, import_jsx_runtime260.jsxs)(Group, { gap, children: [
    withEdges && (0, import_jsx_runtime260.jsx)(PaginationFirst, { icon: firstIcon, ...getControlProps == null ? void 0 : getControlProps("first") }),
    withControls && (0, import_jsx_runtime260.jsx)(PaginationPrevious, { icon: previousIcon, ...getControlProps == null ? void 0 : getControlProps("previous") }),
    (0, import_jsx_runtime260.jsx)(PaginationItems, { dotsIcon }),
    withControls && (0, import_jsx_runtime260.jsx)(PaginationNext, { icon: nextIcon, ...getControlProps == null ? void 0 : getControlProps("next") }),
    withEdges && (0, import_jsx_runtime260.jsx)(PaginationLast, { icon: lastIcon, ...getControlProps == null ? void 0 : getControlProps("last") })
  ] }) });
});
...
var PasswordToggleIcon = ({
  ...
  "svg",
  {
    ...
    children: (0, import_jsx_runtime261.jsx)(
      "path",
      {
...
var PasswordInput = factory((_props, ref) => {
  ...
  const visibilityToggleButton = (0, import_jsx_runtime262.jsx)(
    ActionIcon,
    {
      ...
      children: (0, import_jsx_runtime262.jsx)(VisibilityToggleIcon, { reveal: _visible })
    }
  );
...
var PinInput = factory((props, ref) => {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react351.useState)(-1);
  ...
  const inputsRef = (0, import_react351.useRef)([]);
  const validate = (code) => {
  ...
  return (0, import_jsx_runtime263.jsxs)(import_jsx_runtime263.Fragment, { children: [
    (0, import_jsx_runtime263.jsx)(
      Group,
      {
        ...
        __size: size2,
        dir: "ltr",
        children: _value.map((char, index3) => (0, import_react351.createElement)(
          Input,
          {
            component: "input",
            ...getStyles2("pinInput", {
    ...
    (0, import_jsx_runtime263.jsx)("input", { type: "hidden", name, form, value: _valueToString, ...hiddenInputProps })
  ] });
});
...
var ProgressLabel = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime265.jsx)(
    Box,
    {
      ref,
...
var ProgressRoot = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime266.jsx)(ProgressProvider, { value: { getStyles: getStyles2, autoContrast }, children: (0, import_jsx_runtime266.jsx)(Box, { ref, ...getStyles2("root"), ...others }) });
});
...
var Progress = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime268.jsx)(
    ProgressRoot,
    {
      ...
      vars,
      ...others,
      children: (0, import_jsx_runtime268.jsx)(
        ProgressSection,
        {
          value,
          color,
...
var RadioCard = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime271.jsx)(RadioCardProvider, { value: { checked: _checked }, children: (0, import_jsx_runtime271.jsx)(
    UnstyledButton,
    {
      ref,
...
var RadioGroup = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime272.jsx)(RadioGroupProvider, { value: { value: _value, onChange: handleChange, size: size2, name: _name }, children: (0, import_jsx_runtime272.jsx)(
    Input.Wrapper,
    {
      size: size2,
      ref,
      ...
      children: (0, import_jsx_runtime272.jsx)(InputsGroupFieldset, { role: "radiogroup", children })
    }
  ) });
});
...
function RadioIcon({ size: size2, style, ...others }) {
  return (0, import_jsx_runtime273.jsx)(
    "svg",
    {
      ...
      "aria-hidden": true,
      ...others,
      children: (0, import_jsx_runtime273.jsx)("circle", { cx: "2.5", cy: "2.5", r: "2.5", fill: "currentColor" })
    }
  );
}
...
var RadioIndicator = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime274.jsx)(
    Box,
    {
      ...
      mod: [{ checked: _checked, disabled }, mod],
      ...others,
      children: (0, import_jsx_runtime274.jsx)(Icon, { ...getStyles2("icon") })
    }
  );
});
...
var Radio = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime275.jsx)(
    InlineInput,
    {
      ...
      ...styleProps,
      ...wrapperProps,
      children: (0, import_jsx_runtime275.jsxs)(Box, { ...getStyles2("inner"), mod: { "label-position": labelPosition }, children: [
        ...
        (0, import_jsx_runtime275.jsx)(Icon, { ...getStyles2("icon"), "aria-hidden": true })
      ] })
    }
  );
});
...
function StarIcon(props) {
  ...
  return (0, import_jsx_runtime277.jsx)(
    "svg",
    {
      ...
      ...others,
      children: (0, import_jsx_runtime277.jsx)("path", { d: "M12 17.75l-6.172 3.245l1.179 -6.873l-5 -4.867l6.9 -1l3.086 -6.253l3.086 6.253l6.9 1l-5 4.867l1.179 6.873z" })
    }
  );
}
...
function StarSymbol({ type }) {
  ...
  return (0, import_jsx_runtime278.jsx)(StarIcon, { ...ctx.getStyles("starSymbol"), "data-filled": type === "full" || void 0 });
}
...
function RatingItem({
  ...
  const { dir } = useDirection();
  return (0, import_jsx_runtime279.jsxs)(import_jsx_runtime279.Fragment, { children: [
    !readOnly && (0, import_jsx_runtime279.jsx)(
      "input",
      {
        ...ctx.getStyles("input"),
    ...
    (0, import_jsx_runtime279.jsx)(
      Box,
      {
        ...
        children: (0, import_jsx_runtime279.jsx)(
          Box,
          {
            ...
            children: full ? _fullIcon || (0, import_jsx_runtime279.jsx)(StarSymbol, { type: "full" }) : _emptyIcon || (0, import_jsx_runtime279.jsx)(StarSymbol, { type: "empty" })
          }
        )
      }
    )
...
var Rating = factory((_props, ref) => {
  ...
  const [hovered, setHovered] = (0, import_react366.useState)(-1);
  const [isOutside, setOutside] = (0, import_react366.useState)(true);
  ...
  return (0, import_jsx_runtime280.jsx)(RatingProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime280.jsx)(
    Box,
    {
...
function useFloatingTooltip({
  ...
  const [opened, setOpened] = (0, import_react367.useState)(defaultOpened);
  const boundaryRef = (0, import_react367.useRef)(null);
  ...
  const handleMouseMove = (0, import_react367.useCallback)(
    ({ clientX, clientY }) => {
...
var TooltipFloating = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime281.jsxs)(import_jsx_runtime281.Fragment, { children: [
    (0, import_jsx_runtime281.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: (0, import_jsx_runtime281.jsx)(
      Box,
      {
        ...others,
        ...getStyles2("tooltip", {
    ...
    (0, import_react369.cloneElement)(children, {
      ..._childrenProps,
      [refProp]: targetRef,
      onMouseEnter,
      onMouseLeave
...
var TooltipGroupContext = (0, import_react370.createContext)(false);
var TooltipGroupProvider = TooltipGroupContext.Provider;
var useTooltipGroupContext = () => (0, import_react370.useContext)(TooltipGroupContext);
...
function TooltipGroup(props) {
  ...
  return (0, import_jsx_runtime282.jsx)(TooltipGroupProvider, { value: true, children: (0, import_jsx_runtime282.jsx)(FloatingDelayGroup, { delay: { open: openDelay, close: closeDelay }, children }) });
}
...
function useTooltip(settings) {
  var _a, _b, _c;
  const [uncontrolledOpened, setUncontrolledOpened] = (0, import_react373.useState)(settings.defaultOpened);
  const controlled = typeof settings.opened === "boolean";
  const opened = controlled ? settings.opened : uncontrolledOpened;
  const withinGroup = useTooltipGroupContext();
  const uid = useId();
  const { delay: groupDelay, currentId, setCurrentId } = useDelayGroupContext();
  const onChange = (0, import_react373.useCallback)(
    (_opened) => {
...
var Tooltip = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const arrowRef = (0, import_react375.useRef)(null);
  ...
  return (0, import_jsx_runtime283.jsxs)(import_jsx_runtime283.Fragment, { children: [
    (0, import_jsx_runtime283.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: (0, import_jsx_runtime283.jsx)(
      Transition,
      {
        ...
        children: (transitionStyles) => (0, import_jsx_runtime283.jsxs)(
          Box,
          {
            ...others,
    ...
    (0, import_react375.cloneElement)(
      children,
...
function Curve({
  ...
  const theme = useMantineTheme();
  return (0, import_jsx_runtime284.jsx)(Tooltip.Floating, { disabled: !tooltip, label: tooltip, children: (0, import_jsx_runtime284.jsx)(
    Box,
    {
      component: "circle",
      ...others,
...
var RingProgress = factory((_props, ref) => {
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset2 }, index3) => (0, import_react378.createElement)(
    Curve,
    {
      ...data,
      key: index3,
  ...
  return (0, import_jsx_runtime285.jsxs)(Box, { ...getStyles2("root"), size: size2, ref, ...others, children: [
    (0, import_jsx_runtime285.jsx)("svg", { ...getStyles2("svg"), children: curves }),
    label && (0, import_jsx_runtime285.jsx)("div", { ...getStyles2("label"), children: label })
  ] });
});
...
var SegmentedControl = factory((_props, ref) => {
  ...
  const [parent, setParent] = (0, import_react379.useState)(null);
  const [refs, setRefs] = (0, import_react379.useState)({});
  ...
  const controls = _data.map((item) => (0, import_react379.createElement)(
    Box,
    {
      ...getStyles2("control"),
    ...
    (0, import_react379.createElement)(
      "input",
      {
        ...getStyles2("input"),
    ...
    (0, import_react379.createElement)(
      ...
      (0, import_jsx_runtime286.jsx)("span", { ...getStyles2("innerLabel"), children: item.label })
    )
  ));
  ...
  return (0, import_jsx_runtime286.jsxs)(
    Box,
    {
      ...
      children: [
        typeof _value === "string" && (0, import_jsx_runtime286.jsx)(
          FloatingIndicator,
          {
            target: refs[_value],
            parent,
...
var Select = factory((_props, ref) => {
  ...
  const parsedData = (0, import_react380.useMemo)(() => getParsedComboboxData(data), [data]);
  const optionsLockup = (0, import_react380.useMemo)(() => getOptionsLockup(parsedData), [parsedData]);
  const _id = useId(id);
  const [_value, setValue, controlled] = useUncontrolled({
    value,
    defaultValue,
  ...
  const clearButton = clearable && !!_value && !disabled && !readOnly && (0, import_jsx_runtime287.jsx)(
    Combobox.ClearButton,
    {
      size: size2,
      ...clearButtonProps,
  ...
  return (0, import_jsx_runtime287.jsxs)(import_jsx_runtime287.Fragment, { children: [
    (0, import_jsx_runtime287.jsxs)(
      Combobox,
      {
        store: combobox,
        ...
        ...comboboxProps,
        children: [
          (0, import_jsx_runtime287.jsx)(Combobox.Target, { targetType: searchable ? "input" : "button", autoComplete, children: (0, import_jsx_runtime287.jsx)(
            InputBase,
            {
              id: _id,
              ref,
              rightSection: rightSection || clearButton || (0, import_jsx_runtime287.jsx)(Combobox.Chevron, { size: size2, error, unstyled }),
              rightSectionPointerEvents: rightSectionPointerEvents || (clearButton ? "all" : "none"),
              ...others,
              size: size2,
              __staticSelector: "Select",
...
var SemiCircleProgress = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime288.jsxs)(Box, { ref, size: size2, ...getStyles2("root"), ...others, children: [
    label && (0, import_jsx_runtime288.jsx)("p", { ...getStyles2("label"), "data-position": labelPosition, "data-orientation": orientation, children: label }),
    (0, import_jsx_runtime288.jsxs)("svg", { width: size2, height: size2 / 2, ...getStyles2("svg"), children: [
...
function SimpleGridMediaVariables({
  ...
  return (0, import_jsx_runtime289.jsx)(InlineStyles, { styles: baseStyles, media, selector });
}
...
function SimpleGridContainerVariables({
  ...
  return (0, import_jsx_runtime289.jsx)(InlineStyles, { styles: baseStyles, container: media, selector });
}
...
var SimpleGrid = factory((_props, ref) => {
  ...
  const responsiveClassName = useRandomClassName();
  if (type === "container") {
    return (0, import_jsx_runtime290.jsxs)(import_jsx_runtime290.Fragment, { children: [
      (0, import_jsx_runtime290.jsx)(SimpleGridContainerVariables, { ...props, selector: `.${responsiveClassName}` }),
      (0, import_jsx_runtime290.jsx)("div", { ...getStyles2("container"), children: (0, import_jsx_runtime290.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others }) })
    ] });
  }
  return (0, import_jsx_runtime290.jsxs)(import_jsx_runtime290.Fragment, { children: [
    (0, import_jsx_runtime290.jsx)(SimpleGridMediaVariables, { ...props, selector: `.${responsiveClassName}` }),
    (0, import_jsx_runtime290.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others })
  ] });
});
...
var Skeleton = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime291.jsx)(Box, { ref, ...getStyles2("root"), mod: [{ visible: visible2, animate }, mod], ...others });
});
...
var SliderRoot = (0, import_react386.forwardRef)(
...
var Thumb3 = (0, import_react387.forwardRef)(
  ({
    max,
    min,
    value,
    ...
    const { getStyles: getStyles2 } = useSliderContext();
    const [focused, setFocused] = (0, import_react387.useState)(false);
        ...
        children: [
          ...
          (0, import_jsx_runtime294.jsx)(
            Transition,
            {
              ...
              duration: 0,
              ...labelTransitionProps,
              children: (transitionStyles) => (0, import_jsx_runtime294.jsx)("div", { ...getStyles2("label", { style: transitionStyles }), children: label })
            }
          )
        ]
      }
...
function Marks({ marks, min, max, disabled, value, offset: offset2, inverted }) {
  ...
  const items = marks.map((mark, index3) => (0, import_react388.createElement)(
    Box,
    {
    ...
    mark.label && (0, import_jsx_runtime295.jsx)("div", { ...getStyles2("markLabel"), children: mark.label })
  ));
  return (0, import_jsx_runtime295.jsx)("div", { children: items });
}
...
function Track({
  ...
  const { getStyles: getStyles2 } = useSliderContext();
  return (0, import_jsx_runtime296.jsx)(Box, { ...getStyles2("trackContainer"), mod: { disabled }, ...containerProps, children: (0, import_jsx_runtime296.jsxs)(Box, { ...getStyles2("track"), mod: { inverted, disabled }, children: [
    ...
    children,
    (0, import_jsx_runtime296.jsx)(Marks, { ...others, offset: marksOffset, disabled, inverted })
  ] }) });
}
...
var Slider = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const [hovered, setHovered] = (0, import_react390.useState)(false);
  const [_value, setValue] = useUncontrolled({
  ...
  const valueRef = (0, import_react390.useRef)(_value);
  const root = (0, import_react390.useRef)(null);
  const thumb = (0, import_react390.useRef)(null);
  const position = getPosition({ value: _value, min, max });
  const scaledValue = scale(_value);
  const _label = typeof label === "function" ? label(scaledValue) : label;
  const precision = _precision ?? getPrecision(step);
  const handleChange = (0, import_react390.useCallback)(
    ({ x }) => {
      if (!disabled) {
  ...
  return (0, import_jsx_runtime297.jsx)(SliderProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime297.jsxs)(
    SliderRoot,
    {
      ...others,
      ...
      children: [
        ...
        (0, import_jsx_runtime297.jsx)("input", { type: "hidden", name, value: scaledValue, ...hiddenInputProps })
      ]
    }
  ) });
});
...
var RangeSlider = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const [focused, setFocused] = (0, import_react391.useState)(-1);
  ...
  const thumbs = (0, import_react391.useRef)([]);
  const thumbIndex = (0, import_react391.useRef)(void 0);
  const positions = [
  ...
  return (0, import_jsx_runtime298.jsx)(SliderProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime298.jsxs)(SliderRoot, { ...others, size: size2, ref, disabled, children: [
    (0, import_jsx_runtime298.jsxs)(
      Track,
      {
        offset: positions[0],
    ...
    (0, import_jsx_runtime298.jsx)("input", { type: "hidden", name: `${name}_from`, value: _value[0], ...hiddenInputProps }),
    (0, import_jsx_runtime298.jsx)("input", { type: "hidden", name: `${name}_to`, value: _value[1], ...hiddenInputProps })
  ] }) });
});
...
var Space = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime299.jsx)(Box, { ref, ...others, w, miw: miw ?? w, h, mih: mih ?? h });
});
...
var Spoiler = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime300.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        spoiler && (0, import_jsx_runtime300.jsx)(
          Anchor,
          {
            component: "button",
            type: "button",
        ...
        (0, import_jsx_runtime300.jsx)(
          "div",
          {
            ...
            role: "region",
            id: regionId,
            children: (0, import_jsx_runtime300.jsx)("div", { ref: contentRef, children })
          }
        )
      ]
    }
...
var Stack = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime301.jsx)(Box, { ref, ...getStyles2("root"), variant, ...others });
});
...
var getStepFragment = (Fragment29, step) => {
  if (typeof Fragment29 === "function") {
    return (0, import_jsx_runtime303.jsx)(Fragment29, { step: step || 0 });
  }
  return Fragment29;
};
var defaultProps166 = {
...
var StepperStep = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime303.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        withIcon && (0, import_jsx_runtime303.jsxs)("span", { ...ctx.getStyles("stepWrapper", stylesApi), children: [
          (0, import_jsx_runtime303.jsxs)("span", { ...ctx.getStyles("stepIcon", stylesApi), ...dataAttributes, children: [
            (0, import_jsx_runtime303.jsx)(Transition, { mounted: state === "stepCompleted", transition: "pop", duration: 200, children: (transitionStyles) => (0, import_jsx_runtime303.jsx)(
              "span",
              {
                ...ctx.getStyles("stepCompletedIcon", { style: transitionStyles, ...stylesApi }),
                children: loading ? (0, import_jsx_runtime303.jsx)(
                  Loader,
                  {
                    color: "var(--mantine-color-white)",
                ...
                ) : getStepFragment(completedIcon, step) || (0, import_jsx_runtime303.jsx)(CheckIcon, { size: "60%" })
              }
            ) }),
            state !== "stepCompleted" ? loading ? (0, import_jsx_runtime303.jsx)(
              Loader,
              {
                ...ctx.getStyles("stepLoader", stylesApi),
                size: "calc(var(--stepper-icon-size) / 2)",
          ...
          orientation === "vertical" && (0, import_jsx_runtime303.jsx)(
            "span",
            {
        ...
        (label || description) && (0, import_jsx_runtime303.jsxs)(
          "span",
          {
            ...
            children: [
              label && (0, import_jsx_runtime303.jsx)("span", { ...ctx.getStyles("stepLabel", stylesApi), children: getStepFragment(label, step) }),
              description && (0, import_jsx_runtime303.jsx)("span", { ...ctx.getStyles("stepDescription", stylesApi), children: getStepFragment(description, step) })
            ]
          }
        )
      ]
...
var Stepper = factory((_props, ref) => {
  ...
  const convertedChildren = import_react397.Children.toArray(children);
  ...
  const items = _children.reduce(
    (acc, item, index3) => {
      ...
      acc.push(
        (0, import_react397.cloneElement)(item, {
      ...
      if (orientation === "horizontal" && index3 !== _children.length - 1) {
        acc.push(
          (0, import_react397.createElement)(
            "div",
            {
  ...
  return (0, import_jsx_runtime304.jsx)(StepperProvider, { value: { getStyles: getStyles2, orientation, iconPosition }, children: (0, import_jsx_runtime304.jsxs)(Box, { ...getStyles2("root"), ref, size: size2, ...others, children: [
    ...
    content && (0, import_jsx_runtime304.jsx)("div", { ...getStyles2("content"), children: content })
  ] }) });
});
...
var SwitchGroupContext = (0, import_react398.createContext)(null);
var SwitchGroupProvider = SwitchGroupContext.Provider;
var useSwitchGroupContext = () => (0, import_react398.useContext)(SwitchGroupContext);
...
var SwitchGroup = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime305.jsx)(SwitchGroupProvider, { value: { value: _value, onChange: handleChange, size: size2 }, children: (0, import_jsx_runtime305.jsx)(
    Input.Wrapper,
    {
      size: size2,
      ref,
      ...
      children: (0, import_jsx_runtime305.jsx)(InputsGroupFieldset, { role: "group", children })
    }
  ) });
});
      ...
      children: [
        ...
        (0, import_jsx_runtime306.jsxs)(
          Box,
          {
            ...
            ...getStyles2("track"),
            children: [
              (0, import_jsx_runtime306.jsx)(Box, { component: "span", mod: "reduce-motion", ...getStyles2("thumb"), children: thumbIcon }),
              (0, import_jsx_runtime306.jsx)("span", { ...getStyles2("trackLabel"), children: _checked ? onLabel : offLabel })
            ]
          }
        )
      ]
...
function TableDataRenderer({ data }) {
  return (0, import_jsx_runtime309.jsxs)(import_jsx_runtime309.Fragment, { children: [
    data.caption && (0, import_jsx_runtime309.jsx)(TableCaption, { children: data.caption }),
    data.head && (0, import_jsx_runtime309.jsx)(TableThead, { children: (0, import_jsx_runtime309.jsx)(TableTr, { children: data.head.map((item, index3) => (0, import_jsx_runtime309.jsx)(TableTh, { children: item }, index3)) }) }),
    data.body && (0, import_jsx_runtime309.jsx)(TableTbody, { children: data.body.map((row, rowIndex) => (0, import_jsx_runtime309.jsx)(TableTr, { children: row.map((item, index3) => (0, import_jsx_runtime309.jsx)(TableTd, { children: item }, index3)) }, rowIndex)) }),
    data.foot && (0, import_jsx_runtime309.jsx)(TableTfoot, { children: (0, import_jsx_runtime309.jsx)(TableTr, { children: data.foot.map((item, index3) => (0, import_jsx_runtime309.jsx)(TableTh, { children: item }, index3)) }) })
  ] });
}
...
var TableScrollContainer = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime310.jsx)(
    Box,
    {
      ...
      ...others,
      children: (0, import_jsx_runtime310.jsx)("div", { ...getStyles2("scrollContainerInner"), children })
    }
  );
});
    ...
    TableProvider,
    {
      ...
      children: (0, import_jsx_runtime311.jsx)(
        Box,
        {
          ...
          ...getStyles2("table"),
          ...others,
          children: children || !!data && (0, import_jsx_runtime311.jsx)(TableDataRenderer, { data })
        }
      )
    }
  );
...
var TabsTab = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime315.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        leftSection && (0, import_jsx_runtime315.jsx)("span", { ...ctx.getStyles("tabSection", stylesApiProps), "data-position": "left", children: leftSection }),
        children && (0, import_jsx_runtime315.jsx)("span", { ...ctx.getStyles("tabLabel", stylesApiProps), children }),
        rightSection && (0, import_jsx_runtime315.jsx)("span", { ...ctx.getStyles("tabSection", stylesApiProps), "data-position": "right", children: rightSection })
      ]
    }
  );
});
...
var Tabs = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime316.jsx)(
    TabsProvider,
    {
      ...
      children: (0, import_jsx_runtime316.jsx)(
        Box,
        {
          ref,
          id: uid,
...
var TagsInput = factory((_props, ref) => {
  ...
  const parsedData = getParsedComboboxData(data);
  const optionsLockup = getOptionsLockup(parsedData);
  const inputRef = (0, import_react411.useRef)(null);
  ...
  const values2 = _value.map((item, index3) => (0, import_jsx_runtime318.jsx)(
    Pill,
    {
  ...
  const clearButton = clearable && _value.length > 0 && !disabled && !readOnly && (0, import_jsx_runtime318.jsx)(
    Combobox.ClearButton,
    {
      size: size2,
      ...clearButtonProps,
  ...
  return (0, import_jsx_runtime318.jsxs)(import_jsx_runtime318.Fragment, { children: [
    (0, import_jsx_runtime318.jsxs)(
      Combobox,
      {
        ...
        ...comboboxProps,
        children: [
          (0, import_jsx_runtime318.jsx)(Combobox.DropdownTarget, { children: (0, import_jsx_runtime318.jsx)(
            PillsInput,
            {
              ...styleProps,
              __staticSelector: "TagsInput",
              ...
              id: _id,
              mod,
              children: (0, import_jsx_runtime318.jsxs)(Pill.Group, { disabled, unstyled, ...getStyles2("pillsList"), children: [
                values2,
                (0, import_jsx_runtime318.jsx)(Combobox.EventsTarget, { autoComplete, children: (0, import_jsx_runtime318.jsx)(
                  PillsInput.Field,
                  {
                    ...rest,
                    ref: _ref,
...
var TextInput = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime319.jsx)(InputBase, { component: "input", ref, ..._props, __staticSelector: "TextInput" });
});
...
var ThemeIcon = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime320.jsx)(Box, { ref, ...getStyles2("root"), ...others });
});
  ...
  return (0, import_jsx_runtime322.jsxs)(
    Box,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime322.jsxs)("div", { ...ctx.getStyles("itemBody", stylesApiProps), children: [
          title && (0, import_jsx_runtime322.jsx)("div", { ...ctx.getStyles("itemTitle", stylesApiProps), children: title }),
          (0, import_jsx_runtime322.jsx)("div", { ...ctx.getStyles("itemContent", stylesApiProps), children })
        ] })
      ]
    }
  );
...
var Timeline = factory((_props, ref) => {
  ...
  const _children = import_react416.Children.toArray(children);
  const items = _children.map(
    (item, index3) => {
      var _a, _b;
      return (0, import_react416.cloneElement)(item, {
        unstyled,
        __align: align,
  ...
  return (0, import_jsx_runtime323.jsx)(TimelineProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime323.jsx)(Box, { ...getStyles2("root"), mod: [{ align }, mod], ref, ...others, children: items }) });
});
...
function TreeNode({
  ...
  const ref = (0, import_react419.useRef)(null);
  const nested = (node.children || []).map((child) => (0, import_jsx_runtime326.jsx)(
    TreeNode,
    {
      node: child,
      flatValues,
  ...
  return (0, import_jsx_runtime326.jsxs)(
    "li",
    {
      ...getStyles2("node", {
      ...
      children: [
        typeof renderNode === "function" ? renderNode({
          ...
          elementProps
        }) : (0, import_jsx_runtime326.jsx)("div", { ...elementProps, children: node.label }),
        controller.expandedState[node.value] && nested.length > 0 && (0, import_jsx_runtime326.jsx)("ul", { role: "group", ...getStyles2("subtree"), "data-level": level, children: nested })
      ]
    }
  );
}
...
function useTree({
  ...
  const [data, setData] = (0, import_react422.useState)([]);
  const [expandedState, setExpandedState] = (0, import_react422.useState)(initialExpandedState);
  const [selectedState, setSelectedState] = (0, import_react422.useState)(initialSelectedState);
  const [checkedState, setCheckedState] = (0, import_react422.useState)(initialCheckedState);
  const [anchorNode, setAnchorNode] = (0, import_react422.useState)(null);
  const [hoveredNode, setHoveredNode] = (0, import_react422.useState)(null);
  const initialize = (0, import_react422.useCallback)(
    (_data) => {
  ...
  const toggleExpanded = (0, import_react422.useCallback)(
    (value) => {
  ...
  const collapse = (0, import_react422.useCallback)(
    (value) => {
      setExpandedState((current) => {
  ...
  const expand = (0, import_react422.useCallback)(
    (value) => {
      setExpandedState((current) => {
  ...
  const expandAllNodes = (0, import_react422.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
  ...
  const collapseAllNodes = (0, import_react422.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
      Object.keys(next).forEach((key) => {
        next[key] = false;
  ...
  const toggleSelected = (0, import_react422.useCallback)(
  ...
  const select = (0, import_react422.useCallback)((value) => {
    setAnchorNode(value);
    setSelectedState(
      (current) => multiple ? current.includes(value) ? current : [...current, value] : [value]
    );
  }, []);
  const deselect = (0, import_react422.useCallback)((value) => {
    anchorNode === value && setAnchorNode(null);
    setSelectedState((current) => current.filter((item) => item !== value));
  }, []);
  const clearSelected = (0, import_react422.useCallback)(() => {
    setSelectedState([]);
    setAnchorNode(null);
  }, []);
  const checkNode = (0, import_react422.useCallback)(
    (value) => {
  ...
  const uncheckNode = (0, import_react422.useCallback)(
    (value) => {
      const checkedNodes = getChildrenNodesValues(value, data);
  ...
  const checkAllNodes = (0, import_react422.useCallback)(() => {
    setCheckedState(() => getAllChildrenNodes(data));
  }, [data]);
  const uncheckAllNodes = (0, import_react422.useCallback)(() => {
    setCheckedState([]);
  }, []);
...
var Tree = factory((_props, ref) => {
  ...
  const flatValues = (0, import_react423.useMemo)(() => getFlatValues(data), [data]);
  (0, import_react423.useEffect)(() => {
    controller.initialize(data);
  }, [data]);
  const nodes = data.map((node, index3) => (0, import_jsx_runtime329.jsx)(
    TreeNode,
    {
      node,
      getStyles: getStyles2,
...
var TypographyStylesProvider = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime330.jsx)(Box, { ref, ...getStyles2("root"), ...others });
});
...
var pe = (0, import_react426.forwardRef)((e, n) => {
  const {
    className: t,
    name: o,
    label: r,
  ...
  return qa(h), (0, import_jsx_runtime331.jsx)(
    TextInput,
    {
      size: "xs",
      className: t,
...
var R = import_react426.default.createContext && import_react426.default.createContext(H);
...
function K(e) {
  return e && e.map((n, t) => import_react426.default.createElement(n.tag, P({
    key: t
  }, n.attr), K(n.child)));
}
function U(e) {
  return (n) => import_react426.default.createElement(Ne, k({
    attr: P({}, e.attr)
  }, n), K(e.child));
}
function Ne(e) {
  var n = (t) => {
    ...
    return t.className && (c = t.className), e.className && (c = (c ? c + " " : "") + e.className), import_react426.default.createElement("svg", k({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, t.attr, o, l, {
      ...
      width: a,
      xmlns: "http://www.w3.org/2000/svg"
    }), s && import_react426.default.createElement("title", null, s), e.children);
  };
  return R !== void 0 ? import_react426.default.createElement(R.Consumer, null, (t) => n(t)) : n(H);
}
function Ce(e) {
...
var W = (0, import_react426.createContext)(void 0);
var Pe = (0, import_react426.forwardRef)((e, n) => {
  const {
    children: t,
    onOpenChange: o,
  ...
  qa(l);
  const [a, c] = (0, import_react426.useState)(false), u = (0, import_react426.useRef)(null), f = (0, import_react426.useRef)(), v = (0, import_react426.useCallback)(() => {
    f.current && clearTimeout(f.current), f.current = setTimeout(() => {
      c(false);
    }, 250);
  }, []), h = (0, import_react426.useCallback)(() => {
    f.current && clearTimeout(f.current), c(true);
  }, []);
  return (0, import_jsx_runtime331.jsx)(
    W.Provider,
    {
      value: {
        onMenuMouseOver: h,
      ...
      children: (0, import_jsx_runtime331.jsx)(
        Menu.Item,
        {
...
var Te = (e) => {
  ...
  return qa(s), r ? (0, import_jsx_runtime331.jsx)(Pe, { ...e }) : (0, import_jsx_runtime331.jsx)(
    Menu,
    {
      withinPortal: false,
      middlewares: { flip: true, shift: true, inline: false, size: true },
...
var Me = (0, import_react426.forwardRef)((e, n) => {
  const { className: t, children: o, icon: r, checked: s, subTrigger: l, onClick: a, ...c } = e;
  return qa(c, false), l ? (0, import_jsx_runtime331.jsxs)(
    "div",
    {
      onClick: (u) => {
      ...
      children: [
        o,
        (0, import_jsx_runtime331.jsx)(ke, { size: 15 })
      ]
    }
    ...
    Menu.Item,
    {
      ...
      ref: n,
      leftSection: r,
      rightSection: s ? (0, import_jsx_runtime331.jsx)(CheckIcon, { size: 10 }) : s === false ? (0, import_jsx_runtime331.jsx)("div", { className: "bn-tick-space" }) : null,
      onClick: a,
      ...c,
      children: o
    }
...
var Fe = (e) => {
  ...
  return qa(o), (0, import_jsx_runtime331.jsx)(Menu.Target, { children: n });
};
var Oe = (0, import_react426.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    sub: r,
  ...
  qa(s);
  const l = (0, import_react426.useContext)(W);
  return (0, import_jsx_runtime331.jsx)(
    Menu.Dropdown,
    {
      className: t,
...
var De = (0, import_react426.forwardRef)((e, n) => {
  const { className: t, ...o } = e;
  return qa(o), (0, import_jsx_runtime331.jsx)(Menu.Divider, { className: t, ref: n });
});
var Re = (0, import_react426.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return qa(r), (0, import_jsx_runtime331.jsx)(Menu.Label, { className: t, ref: n, children: o });
});
var Ie = (0, import_react426.forwardRef)((e, n) => {
  const {
    className: t,
    tabs: o,
    defaultOpenTab: r,
  ...
  return qa(c), (0, import_jsx_runtime331.jsx)(Group, { className: t, ref: n, children: (0, import_jsx_runtime331.jsxs)(
    Tabs,
    {
      value: s,
      defaultValue: r,
      onChange: l,
      children: [
        a && (0, import_jsx_runtime331.jsx)(LoadingOverlay, { visible: a }),
        (0, import_jsx_runtime331.jsx)(Tabs.List, { children: o.map((u) => (0, import_jsx_runtime331.jsx)(
          Tabs.Tab,
          {
        ...
        o.map((u) => (0, import_jsx_runtime331.jsx)(Tabs.Panel, { value: u.name, children: u.tabPanel }, u.name))
      ]
    }
  ) });
});
var Le = (0, import_react426.forwardRef)((e, n) => {
  const { className: t, children: o, onClick: r, label: s, ...l } = e;
  return qa(l), (0, import_jsx_runtime331.jsx)(
    Button,
    {
      size: "xs",
      "aria-label": s,
...
var Ee = (0, import_react426.forwardRef)((e, n) => {
  const { className: t, accept: o, value: r, placeholder: s, onChange: l, ...a } = e;
  return qa(a), (0, import_jsx_runtime331.jsx)(
    FileInput,
    {
      size: "xs",
      className: t,
...
var je = (0, import_react426.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return qa(r), (0, import_jsx_runtime331.jsx)("div", { className: t, ref: n, children: o });
});
var ze = (0, import_react426.forwardRef)((e, n) => {
...
var Be = (e) => {
  ...
  return qa(r), (0, import_jsx_runtime331.jsx)(Popover, { withinPortal: false, opened: t, position: o, children: n });
};
var _e = (e) => {
  const { children: n, ...t } = e;
  return qa(t), (0, import_jsx_runtime331.jsx)(PopoverTarget, { children: n });
};
var $e = (0, import_react426.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    variant: r,
  ...
  return qa(s), (0, import_jsx_runtime331.jsx)(PopoverDropdown, { className: t, ref: n, children: o });
});
var Ve = (0, import_react426.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return qa(r, false), (0, import_jsx_runtime331.jsx)(
    Group,
    {
      align: "center",
      gap: 0,
...
var Ae = (0, import_react426.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    icon: r,
  ...
  return qa(f, false), r ? (0, import_jsx_runtime331.jsx)(
    ActionIcon,
    {
      size: 24,
      className: t,
...
var Ge = (0, import_react426.forwardRef)((e, n) => {
...
var He = (0, import_react426.forwardRef)((e, n) => {
  const { className: t, children: o, columns: r, ...s } = e;
  return qa(s), (0, import_jsx_runtime331.jsx)(
    Group,
    {
      className: t,
      style: { gridColumn: `1 / ${r + 1}` },
      ref: n,
      children: (0, import_jsx_runtime331.jsx)(Group, { className: "bn-mt-suggestion-menu-item-title", children: o })
    }
  );
});
var Ke = (0, import_react426.forwardRef)((e, n) => {
  const { className: t, isSelected: o, onClick: r, item: s, id: l, ...a } = e;
  qa(a);
  const c = (0, import_react426.useRef)(null);
  return (0, import_react426.useEffect)(() => {
    if (!c.current || !o)
      return;
    const u = Sr(
      c.current,
...
var Ue = (0, import_react426.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
...
var We = (0, import_react426.forwardRef)((e, n) => {
...
var qe = (0, import_react426.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return qa(r), (0, import_jsx_runtime331.jsx)(Group, { className: t, ref: n, children: (0, import_jsx_runtime331.jsx)(Group, { className: "bn-mt-suggestion-menu-item-title", children: o }) });
});
var Ze = (0, import_react426.forwardRef)((e, n) => {
  const { className: t, isSelected: o, onClick: r, item: s, id: l, ...a } = e;
  qa(a);
  ...
  return (0, import_react426.useEffect)(() => {
    ...
    u === "top" ? c.current.scrollIntoView(true) : u === "bottom" && c.current.scrollIntoView(false);
  }, [o]), (0, import_jsx_runtime331.jsxs)(
    Group,
    {
      gap: 0,
      className: t,
      ...
      "aria-selected": o || void 0,
      children: [
        s.icon && (0, import_jsx_runtime331.jsx)(
          Group,
          {
        ...
        (0, import_jsx_runtime331.jsxs)(Stack, { gap: 0, className: "bn-mt-suggestion-menu-item-body", children: [
          (0, import_jsx_runtime331.jsx)(Text, { className: "bn-mt-suggestion-menu-item-title", children: s.title }),
          (0, import_jsx_runtime331.jsx)(Text, { className: "bn-mt-suggestion-menu-item-subtitle", children: s.subtext })
        ] }),
        s.badge && (0, import_jsx_runtime331.jsx)(
          Group,
          {
            "data-position": "right",
            className: "bn-mt-suggestion-menu-item-section",
            children: (0, import_jsx_runtime331.jsx)(Badge, { size: "xs", children: s.badge })
          }
        )
      ]
    }
...
var Je = (0, import_react426.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return qa(r), (0, import_jsx_runtime331.jsx)(Group, { className: t, ref: n, children: o });
});
var Qe = (0, import_react426.forwardRef)((e, n) => {
  const {
    className: t,
  ...
  return qa(r), (0, import_jsx_runtime331.jsx)(Loader, { className: t, type: "dots", ref: n });
});
var Xe = (0, import_react426.forwardRef)((e, n) => {
  const { children: t, className: o, onMouseDown: r, onClick: s, ...l } = e;
  return qa(l, false), (0, import_jsx_runtime331.jsx)(
    Button,
    {
      className: o,
      ref: n,
...
var Ye = (0, import_react426.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    draggable: r,
  ...
  return qa(u, false), (0, import_jsx_runtime331.jsx)(
    Button,
    {
      className: t,
      ref: n,
...
var L = (0, import_react426.forwardRef)(
  (e, n) => {
...
var et = (e) => (0, import_jsx_runtime331.jsxs)(Stack, { gap: 0, className: "bn-tooltip", children: [
  (0, import_jsx_runtime331.jsx)(Text, { size: "sm", children: e.mainTooltip }),
  e.secondaryTooltip && (0, import_jsx_runtime331.jsx)(Text, { size: "xs", children: e.secondaryTooltip })
] });
var E2 = (0, import_react426.forwardRef)(
  (e, n) => {
    const {
      className: t,
      children: o,
    ...
    return qa(v, false), (0, import_jsx_runtime331.jsx)(
      Tooltip,
      {
        withinPortal: false,
        label: (0, import_jsx_runtime331.jsx)(
          et,
          {
            mainTooltip: r,
            secondaryTooltip: s
        ...
        children: o ? (0, import_jsx_runtime331.jsx)(
          Button,
          {
            "aria-label": f,
            className: t,
...
var tt = (0, import_react426.forwardRef)((e, n) => {
  const { className: t, items: o, isDisabled: r, ...s } = e;
  qa(s);
  const l = o.filter((a) => a.isSelected)[0];
  return l ? (0, import_jsx_runtime331.jsxs)(
    Menu,
    {
      withinPortal: false,
      transitionProps: {
      ...
      middlewares: { flip: true, shift: true, inline: false, size: true },
      children: [
        (0, import_jsx_runtime331.jsx)(Menu.Target, { children: (0, import_jsx_runtime331.jsx)(
          Button,
          {
            onMouseDown: (a) => {
            ...
            leftSection: l.icon,
            rightSection: (0, import_jsx_runtime331.jsx)(Ce, {}),
            size: "xs",
            variant: "subtle",
            disabled: r,
            children: l.text
        ...
        (0, import_jsx_runtime331.jsx)(Menu.Dropdown, { className: t, ref: n, children: o.map((a) => (0, import_jsx_runtime331.jsx)(
          Menu.Item,
          {
            onClick: a.onClick,
            leftSection: a.icon,
            rightSection: a.isSelected ? (0, import_jsx_runtime331.jsx)(CheckIcon, { size: 10, className: "bn-tick-icon" }) : (
              // Ensures space for tick even if item isn't currently selected.
              (0, import_jsx_runtime331.jsx)("div", { className: "bn-tick-space" })
            ),
...
var nt = {
  ...
  Generic: {
    Form: {
      Root: (e) => (0, import_jsx_runtime331.jsx)("div", { children: e.children }),
      TextInput: pe
    },
    Menu: {
      Root: Te,
...
var dt = (e) => {
  const { className: n, theme: t, ...o } = e, r = E(), s = Uo(), l = (r == null ? void 0 : r.colorSchemePreference) || s, a = (0, import_react426.useCallback)(
    (c) => {
  ...
  return (0, import_jsx_runtime331.jsx)(tn.Provider, { value: nt, children: (0, import_jsx_runtime331.jsx)(
    MantineProvider,
    {
      theme: ot,
